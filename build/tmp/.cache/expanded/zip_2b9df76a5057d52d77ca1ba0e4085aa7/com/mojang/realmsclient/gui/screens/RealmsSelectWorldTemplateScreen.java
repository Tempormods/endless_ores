...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
    ...
    RealmsSelectWorldTemplateScreen.WorldTemplateList f_302619_;
    ...
    public RealmsSelectWorldTemplateScreen(
        ...
        if (pWorldTemplatePaginatedList == null) {
            ...
            this.f_302619_ = new RealmsSelectWorldTemplateScreen.WorldTemplateList(Lists.newArrayList(pWorldTemplatePaginatedList.templates));
    ...
    public void init() {
        ...
        this.f_302619_ = this.layout.addToContents(new RealmsSelectWorldTemplateScreen.WorldTemplateList(this.f_302619_.getTemplates()));
    ...
    protected void repositionElements() {
        this.f_302619_.m_305310_(this.width, this.height - this.layout.getFooterHeight() - this.getHeaderHeight());
                            ...
                            .submit(
                                () -> {
                                    if (either.right().isPresent()) {
                                        ...
                                        if (RealmsSelectWorldTemplateScreen.this.f_302619_.isEmpty()) {
                                        ...
                                        for (WorldTemplate worldtemplate : worldtemplatepaginatedlist1.templates) {
                                            RealmsSelectWorldTemplateScreen.this.f_302619_.addEntry(worldtemplate);
                                        }
