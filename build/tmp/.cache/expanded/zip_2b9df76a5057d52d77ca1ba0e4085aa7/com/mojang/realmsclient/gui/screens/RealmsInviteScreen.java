...
public class RealmsInviteScreen extends RealmsScreen {
    ...
    private static final Component f_316275_ = Component.translatable("mco.configure.world.buttons.invite");
    private static final Component NAME_LABEL = Component.translatable("mco.configure.world.invite.profile.name").m_306658_(-6250336);
    private static final Component INVITING_PLAYER_TEXT = Component.translatable("mco.configure.world.players.inviting").m_306658_(-6250336);
    private static final Component NO_SUCH_PLAYER_ERROR_TEXT = Component.translatable("mco.configure.world.players.error").m_306658_(-65536);
    private final HeaderAndFooterLayout f_314227_ = new HeaderAndFooterLayout(this);
    ...
    @Override
    public void init() {
        this.f_314227_.m_324480_(f_316275_, this.font);
        LinearLayout linearlayout = this.f_314227_.addToContents(LinearLayout.vertical().spacing(8));
        ...
        this.inviteButton = linearlayout.addChild(Button.builder(f_316275_, p_88721_ -> this.onInvite()).width(200).build());
        this.f_314227_.addToFooter(Button.builder(CommonComponents.GUI_BACK, p_325127_ -> this.onClose()).width(200).build());
        this.f_314227_.visitWidgets(p_325129_ -> {
    ...
    protected void repositionElements() {
        this.f_314227_.arrangeElements();
    }
    ...
    private void onInvite() {
        if (StringUtil.m_320314_(this.profileName.getValue())) {
