...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
    ...
    private final Set<String> f_302343_ = new HashSet<>();
    ...
    private void m_307974_(LinearLayout p_310633_) {
    ...
    private WorldGenerationInfo createWorldGenerationInfo() {
        return new WorldGenerationInfo(this.seedEdit.getValue(), this.levelType, this.generateStructures, this.f_302343_);
    }
