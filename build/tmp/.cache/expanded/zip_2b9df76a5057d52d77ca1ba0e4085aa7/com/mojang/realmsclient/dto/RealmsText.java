...
public class RealmsText {
    ...
    private RealmsText(String pTranslationKey, @Nullable String[] p_311738_) {
        this.translationKey = pTranslationKey;
        this.args = p_311738_;
    }

    public Component createComponent(Component pDefaultValue) {
        return Objects.requireNonNullElse(this.m_307258_(), pDefaultValue);
    }

    @Nullable
    public Component m_307258_() {
