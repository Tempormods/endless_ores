...
public class RealmsDataFetcher {
    ...
    private final List<DataFetcher.Task<?>> f_303701_;
    ...
    public RealmsDataFetcher(RealmsClient pRealmsClient) {
        this.serverListUpdateTask = this.dataFetcher
            .createTask(
                ...
                () -> {
                    ...
                    return RealmsMainScreen.m_307170_()
                        ? new RealmsDataFetcher.ServerListData(realmsserverlist.servers, pRealmsClient.m_307306_())
        ...
        this.f_303701_ = List.of(this.notificationsTask, this.serverListUpdateTask, this.pendingInvitesTask, this.trialAvailabilityTask, this.newsTask);
    }

    public List<DataFetcher.Task<?>> m_307413_() {
        return this.f_303701_;
    }

    @OnlyIn(Dist.CLIENT)
    public static record ServerListData(List<RealmsServer> f_302550_, List<RealmsServer> f_303266_) {
    }
}