...
public class RealmsUploadScreen extends RealmsScreen {
    ...
    @Nullable
    private final RealmCreationTask f_316060_;
    private final long f_316868_;
    ...
    private final HeaderAndFooterLayout f_316346_ = new HeaderAndFooterLayout(this);

    public RealmsUploadScreen(@Nullable RealmCreationTask p_332847_, long pWorldId, int pSlotId, RealmsResetWorldScreen pLastScreen, LevelSummary pSelectedLevel) {
        super(GameNarrator.NO_TITLE);
        this.f_316060_ = p_332847_;
        this.f_316868_ = pWorldId;
        this.slotId = pSlotId;
    ...
    @Override
    public void init() {
        this.backButton = this.f_316346_.addToFooter(Button.builder(CommonComponents.GUI_BACK, p_90118_ -> this.onBack()).build());
        this.backButton.visible = false;
        this.cancelButton = this.f_316346_.addToFooter(Button.builder(CommonComponents.GUI_CANCEL, p_90104_ -> this.onCancel()).build());
        if (!this.uploadStarted) {
            if (this.lastScreen.slot == -1) {
                ...
                if (this.f_316060_ != null) {
                    list.add(this.f_316060_);
                }

                list.add(new SwitchSlotTask(this.f_316868_, this.lastScreen.slot, () -> {
                    if (!this.uploadStarted) {
                        this.uploadStarted = true;
        ...
        this.f_316346_.visitWidgets(p_325163_ -> {
    ...
    protected void repositionElements() {
        this.f_316346_.arrangeElements();
    }

    private void onBack() {
        this.minecraft.setScreen(new RealmsConfigureWorldScreen(new RealmsMainScreen(new TitleScreen()), this.f_316868_));
    }
                        ...
                        if (!UPLOAD_LOCK.tryLock(1L, TimeUnit.SECONDS)) {
                            ...
                            for (int i = 0; i < 20; i++) {
                                try {
                                    ...
                                    uploadinfo = realmsclient.requestUploadInfo(this.f_316868_, UploadTokenCache.get(this.f_316868_));
                                    if (uploadinfo != null) {
                                        break;
                                    }
                            ...
                            if (uploadinfo == null) {
                                ...
                                UploadTokenCache.put(this.f_316868_, uploadinfo.getToken());
                                    ...
                                    if (this.cancelled) {
                                        ...
                                        fileupload.upload(p_325164_ -> {
                                            if (p_325164_.statusCode >= 200 && p_325164_.statusCode < 300) {
                                                ...
                                                UploadTokenCache.invalidate(this.f_316868_);
