...
public class RealmsLongRunningMcoTaskScreen extends RealmsScreen {
    ...
    private final List<LongRunningTask> f_302752_;
    ...
    public RealmsLongRunningMcoTaskScreen(Screen pLastScreen, LongRunningTask... p_309789_) {
        super(GameNarrator.NO_TITLE);
        this.lastScreen = pLastScreen;
        this.f_302752_ = List.of(p_309789_);
        if (this.f_302752_.isEmpty()) {
            throw new IllegalArgumentException("No tasks added");
        } else {
            this.title = this.f_302752_.get(0).getTitle();
            Runnable runnable = () -> {
    ...
    protected void cancel() {
        for (LongRunningTask longrunningtask : this.f_302752_) {
