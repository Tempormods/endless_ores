...
public class BufferBuilder extends DefaultedVertexConsumer implements BufferVertexConsumer {
    private static final int f_303148_ = 2097152;
    private static final Logger LOGGER = LogUtils.getLogger();
    private ByteBuffer buffer;
    private boolean f_303442_;
    ...
    public void m_306688_() {
        ...
        } else if (!this.f_303442_) {
            this.f_303442_ = true;
            MemoryTracker.m_307993_(this.buffer);
        }
    }
