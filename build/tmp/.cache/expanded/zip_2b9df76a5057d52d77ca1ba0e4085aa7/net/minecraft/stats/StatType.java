...
public class StatType<T> implements Iterable<Stat<T>> {
    ...
    private final StreamCodec<RegistryFriendlyByteBuf, Stat<T>> f_316701_;

    public StatType(Registry<T> pRegistry, Component pDisplayName) {
        this.registry = pRegistry;
        this.displayName = pDisplayName;
        this.f_316701_ = ByteBufCodecs.m_320159_(pRegistry.key()).m_323038_(this::get, Stat::getValue);
    }

    public StreamCodec<RegistryFriendlyByteBuf, Stat<T>> m_323437_() {
        return this.f_316701_;
    }
