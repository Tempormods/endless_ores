...
public record SculkChargeParticleOptions(float roll) implements ParticleOptions {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, SculkChargeParticleOptions> f_314611_ = StreamCodec.m_322204_(
        ByteBufCodecs.f_314734_, p_325813_ -> p_325813_.roll, SculkChargeParticleOptions::new
    );
