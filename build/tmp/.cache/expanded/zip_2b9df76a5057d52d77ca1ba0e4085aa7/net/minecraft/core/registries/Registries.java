...
public class Registries {
    public static final ResourceLocation f_303875_ = new ResourceLocation("root");
    ...
    public static final ResourceKey<Registry<MapCodec<? extends Block>>> f_302727_ = createRegistryKey("block_type");
    ...
    public static final ResourceKey<Registry<WolfVariant>> f_317086_ = createRegistryKey("wolf_variant");
    ...
    public static final ResourceKey<Registry<MapCodec<? extends PoolAliasBinding>>> f_302337_ = createRegistryKey("worldgen/pool_alias_binding");
    ...
    public static final ResourceKey<Registry<NumberFormatType<?>>> f_302869_ = createRegistryKey("number_format_type");
    public static final ResourceKey<Registry<ArmorMaterial>> f_315643_ = createRegistryKey("armor_material");
    public static final ResourceKey<Registry<DataComponentType<?>>> f_316190_ = createRegistryKey("data_component_type");
    public static final ResourceKey<Registry<MapCodec<? extends EntitySubPredicate>>> f_316012_ = createRegistryKey("entity_sub_predicate_type");
    public static final ResourceKey<Registry<ItemSubPredicate.Type<?>>> f_316222_ = createRegistryKey("item_sub_predicate_type");
    public static final ResourceKey<Registry<MapDecorationType>> f_313969_ = createRegistryKey("map_decoration_type");
    ...
    public static final ResourceKey<Registry<CriterionTrigger<?>>> f_302828_ = createRegistryKey("trigger_type");
    ...
    public static final ResourceKey<Registry<LootTable>> f_314309_ = createRegistryKey("loot_table");
    public static final ResourceKey<Registry<LootItemFunction>> f_316898_ = createRegistryKey("item_modifier");
    public static final ResourceKey<Registry<LootItemCondition>> f_315752_ = createRegistryKey("predicate");
