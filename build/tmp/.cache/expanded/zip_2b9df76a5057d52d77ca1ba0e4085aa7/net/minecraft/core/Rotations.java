...
public class Rotations {
    public static final StreamCodec<ByteBuf, Rotations> f_316585_ = new StreamCodec<ByteBuf, Rotations>() {
        public Rotations m_318688_(ByteBuf p_335565_) {
            return new Rotations(p_335565_.readFloat(), p_335565_.readFloat(), p_335565_.readFloat());
        }

        public void m_318638_(ByteBuf p_328300_, Rotations p_335839_) {
