...
public class BuiltInRegistries {
    ...
    private static final WritableRegistry<WritableRegistry<?>> WRITABLE_REGISTRY = new MappedRegistry<>(ResourceKey.createRegistryKey(Registries.f_303875_), Lifecycle.stable());
    public static final DefaultedRegistry<GameEvent> GAME_EVENT = registerDefaulted(Registries.GAME_EVENT, "step", GameEvent::m_322753_);
    ...
    public static final Registry<MobEffect> MOB_EFFECT = registerSimple(Registries.MOB_EFFECT, MobEffects::m_321241_);
    ...
    public static final Registry<Enchantment> ENCHANTMENT = registerSimpleWithIntrusiveHolders(Registries.ENCHANTMENT, p_325817_ -> Enchantments.f_316753_);
    ...
    public static final Registry<Potion> POTION = registerSimple(Registries.POTION, Potions::m_324006_);
    ...
    public static final DefaultedRegistry<ChunkStatus> CHUNK_STATUS = registerDefaulted(Registries.CHUNK_STATUS, "empty", p_325818_ -> ChunkStatus.f_314297_);
    ...
    public static final Registry<Attribute> ATTRIBUTE = registerSimple(Registries.ATTRIBUTE, Attributes::m_321043_);
    ...
    public static final Registry<MapCodec<? extends Block>> f_303045_ = registerSimple(Registries.f_302727_, (RegistryBootstrap)BlockTypes::m_305064_);
    ...
    public static final Registry<MapCodec<? extends PoolAliasBinding>> f_302795_ = registerSimple(Registries.f_302337_, (RegistryBootstrap)PoolAliasBindings::m_306375_);
    public static final Registry<CatVariant> CAT_VARIANT = registerSimple(Registries.CAT_VARIANT, CatVariant::bootstrap);
    public static final Registry<FrogVariant> FROG_VARIANT = registerSimple(Registries.FROG_VARIANT, FrogVariant::m_322724_);
    ...
    public static final Registry<CriterionTrigger<?>> f_302882_ = registerSimple(Registries.f_302828_, (RegistryBootstrap)CriteriaTriggers::m_305022_);
    public static final Registry<NumberFormatType<?>> f_303198_ = registerSimple(Registries.f_302869_, (RegistryBootstrap)NumberFormatTypes::m_305447_);
    public static final Registry<ArmorMaterial> f_315942_ = registerSimple(Registries.f_315643_, ArmorMaterials::m_324135_);
    public static final Registry<DataComponentType<?>> f_315333_ = registerSimple(Registries.f_316190_, (RegistryBootstrap)DataComponents::m_318674_);
    public static final Registry<MapCodec<? extends EntitySubPredicate>> f_313902_ = registerSimple(Registries.f_316012_, (RegistryBootstrap)EntitySubPredicates::m_322489_);
    public static final Registry<ItemSubPredicate.Type<?>> f_315468_ = registerSimple(Registries.f_316222_, (RegistryBootstrap)ItemSubPredicates::m_318816_);
    public static final Registry<MapDecorationType> f_315353_ = registerSimple(Registries.f_313969_, MapDecorationTypes::m_324454_);
    ...
    private static <T, R extends WritableRegistry<T>> R internalRegister(
        ...
        WRITABLE_REGISTRY.register((ResourceKey)pKey, pRegistry, RegistrationInfo.f_316022_);
        return pRegistry;
    }
