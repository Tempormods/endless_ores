...
public abstract class AbstractWidget implements Renderable, GuiEventListener, LayoutElement, NarratableEntry {
    ...
    public final void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        if (this.visible) {
            this.isHovered = pGuiGraphics.m_322958_(pMouseX, pMouseY)
                && pMouseX >= this.getX()
                && pMouseY >= this.getY()
                && pMouseX < this.getX() + this.width
                && pMouseY < this.getY() + this.height;
            this.renderWidget(pGuiGraphics, pMouseX, pMouseY, pPartialTick);
            this.tooltip.m_323585_(this.isHovered(), this.isFocused(), this.getRectangle());
        }
    }

    public void setTooltip(@Nullable Tooltip pTooltip) {
        this.tooltip.m_321872_(pTooltip);
    }

    @Nullable
    public Tooltip getTooltip() {
        return this.tooltip.m_323637_();
    }

    public void setTooltipDelay(Duration p_334848_) {
        this.tooltip.m_320201_(p_334848_);
    }
    ...
    protected static void renderScrollingString(
        GuiGraphics pGuiGraphics, Font pFont, Component pText, int p_300294_, int pMinX, int pMinY, int pMaxX, int pMaxY, int pColor
    ) {
    ...
    public final void updateNarration(NarrationElementOutput pNarrationElementOutput) {
        ...
        this.tooltip.m_322101_(pNarrationElementOutput);
    }
    ...
    public void m_305310_(int p_312975_, int p_312301_) {
    ...
    public void m_306878_(int p_309908_, int p_310169_, int p_312247_, int p_310380_) {
        this.m_305310_(p_309908_, p_310169_);
