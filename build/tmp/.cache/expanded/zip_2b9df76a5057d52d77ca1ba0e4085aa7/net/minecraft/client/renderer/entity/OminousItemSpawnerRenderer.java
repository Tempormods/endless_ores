...
public class OminousItemSpawnerRenderer extends EntityRenderer<OminousItemSpawner> {
    private static final float f_314148_ = 40.0F;
    private static final int f_315484_ = 50;
    private final ItemRenderer f_314406_;

    protected OminousItemSpawnerRenderer(EntityRendererProvider.Context p_332134_) {
        super(p_332134_);
        this.f_314406_ = p_332134_.getItemRenderer();
    }
    ...
    public void render(OminousItemSpawner p_333343_, float p_334770_, float p_333761_, PoseStack p_330642_, MultiBufferSource p_333628_, int p_334934_) {
        ItemStack itemstack = p_333343_.m_318820_();
        if (!itemstack.isEmpty()) {
            ...
            ItemEntityRenderer.m_318704_(this.f_314406_, p_330642_, p_333628_, 15728880, itemstack, level.random, level);
            p_330642_.popPose();
        }
    }
}