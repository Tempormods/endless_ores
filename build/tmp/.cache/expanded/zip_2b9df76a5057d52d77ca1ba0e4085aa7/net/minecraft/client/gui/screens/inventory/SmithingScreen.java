    ...
    private void updateArmorStandPreview(ItemStack pStack) {
        if (this.armorStandPreview != null) {
            for (EquipmentSlot equipmentslot : EquipmentSlot.values()) {
                this.armorStandPreview.m_21035_(equipmentslot, ItemStack.EMPTY);
            }

            if (!pStack.isEmpty()) {
                ItemStack itemstack = pStack.copy();
                if (pStack.getItem() instanceof ArmorItem armoritem) {
                    this.armorStandPreview.m_21035_(armoritem.getEquipmentSlot(), itemstack);
                } else {
                    this.armorStandPreview.m_21035_(EquipmentSlot.OFFHAND, itemstack);
                }
            }
        }
    }
