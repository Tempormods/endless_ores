...
public class FoxRenderer extends MobRenderer<Fox, FoxModel<Fox>> {
    ...
    protected void setupRotations(Fox pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float p_328871_) {
        super.setupRotations(pEntityLiving, pPoseStack, pAgeInTicks, pRotationYaw, pPartialTicks, p_328871_);
