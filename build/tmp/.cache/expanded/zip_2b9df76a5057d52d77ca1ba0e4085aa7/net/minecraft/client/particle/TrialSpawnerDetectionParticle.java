...
public class TrialSpawnerDetectionParticle extends TextureSheetParticle {
    private final SpriteSet f_303507_;
    private static final int f_302947_ = 8;
    ...
    public SingleQuadParticle.FacingCameraMode m_306793_() {
        return SingleQuadParticle.FacingCameraMode.f_302392_;
    }

    @Override
    public void tick() {
        super.tick();
        this.setSpriteFromAge(this.f_303507_);
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet f_303782_;

        public Provider(SpriteSet p_311649_) {
            this.f_303782_ = p_311649_;
        }
        ...
        public Particle createParticle(
            ...
            return new TrialSpawnerDetectionParticle(p_310081_, p_312198_, p_312389_, p_310385_, p_312116_, p_312285_, p_312651_, 1.5F, this.f_303782_);
        }
    }
}