...
public class AdvancementsScreen extends Screen implements ClientAdvancements.Listener {
    ...
    private final HeaderAndFooterLayout f_314567_ = new HeaderAndFooterLayout(this);
    @Nullable
    private final Screen f_314594_;
    ...
    protected void init() {
        if (this.tabs.size() > AdvancementTabType.MAX_TABS) {
            ...
            this.f_314567_.addToHeader(pageLayout);
        }
        this.f_314567_.m_324480_(TITLE, this.font);
        this.tabs.clear();
        ...
        this.f_314567_.addToFooter(Button.builder(CommonComponents.GUI_DONE, p_329618_ -> this.onClose()).width(200).build());
        this.f_314567_.visitWidgets(p_335563_ -> {
    ...
    protected void repositionElements() {
        this.f_314567_.arrangeElements();
    }

    @Override
    public void onClose() {
        this.minecraft.setScreen(this.f_314594_);
    }
