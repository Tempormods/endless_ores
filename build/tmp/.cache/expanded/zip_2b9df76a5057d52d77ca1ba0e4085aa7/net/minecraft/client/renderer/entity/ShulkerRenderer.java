...
public class ShulkerRenderer extends MobRenderer<Shulker, ShulkerModel<Shulker>> {
    ...
    protected void setupRotations(Shulker pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float p_332117_) {
        super.setupRotations(pEntityLiving, pPoseStack, pAgeInTicks, pRotationYaw + 180.0F, pPartialTicks, p_332117_);
        pPoseStack.rotateAround(pEntityLiving.getAttachFace().getOpposite().getRotation(), 0.0F, 0.5F, 0.0F);
    }
}