...
public class DragonFireballRenderer extends EntityRenderer<DragonFireball> {
    ...
    private static void vertex(
        VertexConsumer pConsumer, PoseStack.Pose p_336223_, int pLightmapUV, float pX, int pY, int pU, int pV
    ) {
        pConsumer.m_320578_(p_336223_, pX - 0.5F, (float)pY - 0.25F, 0.0F)
