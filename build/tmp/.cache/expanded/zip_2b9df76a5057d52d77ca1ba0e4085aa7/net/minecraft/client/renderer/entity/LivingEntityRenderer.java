...
public abstract class LivingEntityRenderer<T extends LivingEntity, M extends EntityModel<T>> extends EntityRenderer<T> implements RenderLayerParent<T, M> {
    ...
    protected void setupRotations(T pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float p_334101_) {
        ...
        if (pEntityLiving.deathTime > 0) {
            ...
            pPoseStack.translate(0.0F, (pEntityLiving.getBbHeight() + 0.1F) / p_334101_, 0.0F);
    ...
    protected float m_318622_(T p_334594_) {
        return super.m_318622_(p_334594_) * p_334594_.getScale();
    }
}
