...
public abstract class SingleQuadParticle extends Particle {
    ...
    private final Quaternionf f_303665_ = new Quaternionf();
    ...
    public SingleQuadParticle.FacingCameraMode m_306793_() {
        return SingleQuadParticle.FacingCameraMode.f_303194_;
    }
    ...
    public void render(VertexConsumer pBuffer, Camera pRenderInfo, float pPartialTicks) {
        ...
        this.m_306793_().m_307166_(this.f_303665_, pRenderInfo, pPartialTicks);
        if (this.roll != 0.0F) {
            this.f_303665_.rotateZ(Mth.lerp(pPartialTicks, this.oRoll, this.roll));
        }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            vector3f.rotate(this.f_303665_);
            vector3f.mul(f3);
    ...
    public interface FacingCameraMode {
        SingleQuadParticle.FacingCameraMode f_303194_ = (p_312026_, p_311956_, p_310043_) -> p_312026_.set(p_311956_.rotation());
        SingleQuadParticle.FacingCameraMode f_302392_ = (p_310770_, p_309904_, p_311153_) -> p_310770_.set(
                0.0F, p_309904_.rotation().y, 0.0F, p_309904_.rotation().w
            );

        void m_307166_(Quaternionf p_309893_, Camera p_309691_, float p_312801_);
    }
}