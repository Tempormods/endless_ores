...
public class PhantomRenderer extends MobRenderer<Phantom, PhantomModel<Phantom>> {
    ...
    protected void setupRotations(Phantom pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float p_328426_) {
        super.setupRotations(pEntityLiving, pPoseStack, pAgeInTicks, pRotationYaw, pPartialTicks, p_328426_);
