...
public class ModelLayers {
    ...
    public static final ModelLayerLocation f_316495_ = register("armadillo");
    ...
    public static final ModelLayerLocation f_316706_ = register("bogged");
    public static final ModelLayerLocation f_316561_ = registerInnerArmor("bogged");
    public static final ModelLayerLocation f_316376_ = registerOuterArmor("bogged");
    public static final ModelLayerLocation f_316513_ = register("bogged", "outer");
    public static final ModelLayerLocation BOOK = register("book");
    public static final ModelLayerLocation f_303100_ = register("breeze");
    ...
    public static final ModelLayerLocation f_303259_ = register("wind_charge");
    ...
    public static final ModelLayerLocation f_315853_ = register("wolf_armor");
