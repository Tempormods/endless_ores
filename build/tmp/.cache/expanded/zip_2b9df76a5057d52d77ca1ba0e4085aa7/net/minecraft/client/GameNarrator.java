    ...
    public void updateNarratorStatus(NarratorStatus pStatus) {
        ...
        if (this.narrator.active()) {
            if (pStatus == NarratorStatus.OFF) {
                SystemToast.addOrUpdate(toastcomponent, SystemToast.SystemToastId.f_303336_, Component.translatable("narrator.toast.disabled"), null);
            } else {
                SystemToast.addOrUpdate(toastcomponent, SystemToast.SystemToastId.f_303336_, Component.translatable("narrator.toast.enabled"), pStatus.getName());
            }
        } else {
            SystemToast.addOrUpdate(
                toastcomponent,
                SystemToast.SystemToastId.f_303336_,
