...
public class PostPass implements AutoCloseable {
    ...
    private final int f_315357_;

    public PostPass(ResourceProvider p_327734_, String pName, RenderTarget pInTarget, RenderTarget pOutTarget, boolean p_332417_) throws IOException {
        this.effect = new EffectInstance(p_327734_, pName);
        this.inTarget = pInTarget;
        this.outTarget = pOutTarget;
        this.f_315357_ = p_332417_ ? 9729 : 9728;
    }
    ...
    public int m_320529_() {
        return this.f_315357_;
    }
}