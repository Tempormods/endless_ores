...
public class CreateWorldScreen extends Screen {
    ...
    static final Component f_314626_ = Component.translatable("selectWorld.allowCommands.info");
    ...
    public static final ResourceLocation f_314408_ = new ResourceLocation("textures/gui/tab_header_background.png");
    private final HeaderAndFooterLayout f_313923_ = new HeaderAndFooterLayout(this);
    ...
    public static CreateWorldScreen createFromExisting(
        ...
        createworldscreen.uiState.m_321753_(pLevelSettings.allowCommands());
    ...
    protected void init() {
        ...
        LinearLayout linearlayout = this.f_313923_.addToFooter(LinearLayout.horizontal().spacing(8));
        ...
        this.f_313923_.visitWidgets(p_267851_ -> {
    ...
    public void repositionElements() {
        if (this.tabNavigationBar != null) {
            ...
            ScreenRectangle screenrectangle = new ScreenRectangle(0, i, this.width, this.height - this.f_313923_.getFooterHeight() - i);
            this.tabManager.setTabArea(screenrectangle);
            this.f_313923_.setHeaderHeight(i);
            this.f_313923_.arrangeElements();
        }
    }
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        pGuiGraphics.blit(Screen.f_316966_, 0, this.height - this.f_313923_.getFooterHeight() - 2, 0.0F, 0.0F, this.width, 2, 32, 2);
        RenderSystem.disableBlend();
    }

    @Override
    protected void m_323963_(GuiGraphics p_334471_) {
        p_334471_.blit(f_314408_, 0, 0, 0.0F, 0.0F, this.width, this.f_313923_.getHeaderHeight(), 16, 16);
        this.m_320284_(p_334471_, 0, this.f_313923_.getHeaderHeight(), this.width, this.height);
    }
        ...
        WorldLoader.<CreateWorldScreen.DataPackReloadCookie, WorldCreationContext>load(
                ...
                p_325422_ -> {
                    if (p_325422_.datapackWorldgen().registryOrThrow(Registries.WORLD_PRESET).size() == 0) {
                        ...
                        WorldCreationContext worldcreationcontext = this.uiState.getSettings();
                        DynamicOps<JsonElement> dynamicops = worldcreationcontext.worldgenLoadContext().m_318927_(JsonOps.INSTANCE);
                        ...
                        DynamicOps<JsonElement> dynamicops1 = p_325422_.datapackWorldgen().m_318927_(JsonOps.INSTANCE);
    ...
    class GameTab extends GridLayoutTab {
        ...
        private static final Component f_315008_ = Component.translatable("selectWorld.allowCommands.new");
        ...
        GameTab() {
            ...
            CycleButton<Boolean> cyclebutton2 = gridlayout$rowhelper.addChild(
                CycleButton.onOffBuilder()
                    .withTooltip(p_325425_ -> Tooltip.create(CreateWorldScreen.f_314626_))
                    .create(0, 0, 210, 20, f_315008_, (p_325426_, p_325427_) -> CreateWorldScreen.this.uiState.m_321753_(p_325427_))
            );
            CreateWorldScreen.this.uiState.addListener(p_325429_ -> {
                cyclebutton2.setValue(CreateWorldScreen.this.uiState.m_324109_());
