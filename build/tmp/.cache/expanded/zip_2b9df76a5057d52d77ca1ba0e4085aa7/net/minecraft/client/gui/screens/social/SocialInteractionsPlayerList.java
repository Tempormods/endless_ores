...
public class SocialInteractionsPlayerList extends ContainerObjectSelectionList<PlayerEntry> {
    ...
    public SocialInteractionsPlayerList(SocialInteractionsScreen pSocialInteractionsScreen, Minecraft pMinecraft, int pWidth, int pHeight, int pY0, int pY1) {
        super(pMinecraft, pWidth, pHeight, pY0, pY1);
        this.socialInteractionsScreen = pSocialInteractionsScreen;
    }

    @Override
    protected void m_323247_(GuiGraphics p_329536_) {
    }

    @Override
    protected void m_319011_(GuiGraphics p_334427_) {
    }

    @Override
    protected void enableScissor(GuiGraphics pGuiGraphics) {
        pGuiGraphics.enableScissor(this.getX(), this.getY() + 4, this.m_307439_(), this.m_306468_());
    }
