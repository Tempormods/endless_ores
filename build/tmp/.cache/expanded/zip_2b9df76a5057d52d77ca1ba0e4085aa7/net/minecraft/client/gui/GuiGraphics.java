...
public class GuiGraphics implements net.minecraftforge.client.extensions.IForgeGuiGraphics {
    ...
    public boolean m_322958_(int p_334767_, int p_334338_) {
        return this.scissorStack.m_319411_(p_334767_, p_334338_);
    }
    ...
    public void m_319756_(RenderType p_327925_, int p_328209_, int p_335424_, int p_329528_, int p_336385_, int p_332231_) {
        Matrix4f matrix4f = this.pose.last().pose();
    ...
    public void blitSprite(
        ResourceLocation pSprite, int pSliceWidth, int pSliceHeight, int p_299965_, int p_300008_, int pX, int pY, int pWidth, int pHeight
    ) {
    ...
    private void blitSprite(
        ...
        if (pWidth != 0 && pHeight != 0) {
            this.innerBlit(
                ...
                pY + pHeight,
                pBlitOffset,
                pSprite.getU((float)p_300994_ / (float)pSliceWidth),
                pSprite.getU((float)(p_300994_ + pWidth) / (float)pSliceWidth),
                pSprite.getV((float)p_297577_ / (float)pSliceHeight),
                pSprite.getV((float)(p_297577_ + pHeight) / (float)pSliceHeight)
            );
        }
    }
    ...
    public void renderFakeItem(ItemStack pStack, int pX, int pY) {
        this.m_306951_(pStack, pX, pY, 0);
    }

    public void m_306951_(ItemStack p_309605_, int p_310104_, int p_309448_, int p_310674_) {
    ...
    private void renderItem(
        ...
        if (!pStack.isEmpty()) {
            ...
            try {
                ...
                crashreportcategory.setDetail("Item Components", () -> String.valueOf(pStack.m_318732_()));
    ...
    static class ScissorStack {
        ...
        public boolean m_319411_(int p_329411_, int p_333404_) {
            return this.stack.isEmpty() ? true : this.stack.peek().m_319431_(p_329411_, p_333404_);
        }
    }
}
