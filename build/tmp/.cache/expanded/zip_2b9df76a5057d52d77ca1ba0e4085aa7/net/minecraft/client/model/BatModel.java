...
public class BatModel extends HierarchicalModel<Bat> {
    ...
    private final ModelPart f_303142_;
    ...
    public BatModel(ModelPart pRoot) {
        ...
        this.f_303142_ = this.body.getChild("feet");
    }
    ...
    public void setupAnim(Bat pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        if (pEntity.isResting()) {
            this.m_306796_(pNetHeadYaw);
        }

        this.animate(pEntity.f_302314_, BatAnimation.f_302773_, pAgeInTicks, 1.0F);
        this.animate(pEntity.f_303573_, BatAnimation.f_302981_, pAgeInTicks, 1.0F);
    }

    private void m_306796_(float p_310053_) {
