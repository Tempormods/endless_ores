...
public class PufferfishRenderer extends MobRenderer<Pufferfish, EntityModel<Pufferfish>> {
    ...
    protected void setupRotations(Pufferfish pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float p_336044_) {
        pPoseStack.translate(0.0F, Mth.cos(pAgeInTicks * 0.05F) * 0.08F, 0.0F);
        super.setupRotations(pEntityLiving, pPoseStack, pAgeInTicks, pRotationYaw, pPartialTicks, p_336044_);
    }
}