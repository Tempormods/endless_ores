...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>> extends AbstractContainerWidget {
    ...
    private static final ResourceLocation f_317013_ = new ResourceLocation("widget/scroller_background");
    private static final ResourceLocation f_315877_ = new ResourceLocation("textures/gui/menu_list_background.png");
    private static final ResourceLocation f_313898_ = new ResourceLocation("textures/gui/inworld_menu_list_background.png");
    ...
    public AbstractSelectionList(Minecraft pMinecraft, int pWidth, int pHeight, int pY0, int pY1) {
        super(0, pY0, pWidth, pHeight, CommonComponents.EMPTY);
    ...
    public void m_319425_(int p_336225_, HeaderAndFooterLayout p_331081_) {
        this.m_321569_(p_336225_, p_331081_.m_319781_(), p_331081_.getHeaderHeight());
    }

    public void m_321569_(int p_334988_, int p_333730_, int p_328806_) {
        this.m_305310_(p_334988_, p_333730_);
    ...
    protected boolean clickedHeader(int pMouseX, int pMouseY) {
        return false;
    }
    ...
    public void renderWidget(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        if (this.m_324471_()) {
            ...
            pGuiGraphics.blitSprite(f_317013_, l, this.getY(), 6, this.getHeight());
    ...
    protected boolean m_324471_() {
        return this.getMaxScroll() > 0;
    }

    protected void m_319011_(GuiGraphics p_331270_) {
        RenderSystem.enableBlend();
        ResourceLocation resourcelocation = this.minecraft.level == null ? Screen.f_316769_ : Screen.f_314458_;
        ResourceLocation resourcelocation1 = this.minecraft.level == null ? Screen.f_316966_ : Screen.f_316128_;
        p_331270_.blit(resourcelocation, this.getX(), this.getY() - 2, 0.0F, 0.0F, this.getWidth(), 2, 32, 2);
        p_331270_.blit(resourcelocation1, this.getX(), this.m_306468_(), 0.0F, 0.0F, this.getWidth(), 2, 32, 2);
        RenderSystem.disableBlend();
    }

    protected void m_323247_(GuiGraphics p_333412_) {
        RenderSystem.enableBlend();
        ResourceLocation resourcelocation = this.minecraft.level == null ? f_315877_ : f_313898_;
        p_333412_.blit(
            resourcelocation,
            this.getX(),
            this.getY(),
            (float)this.m_307439_(),
            (float)(this.m_306468_() + (int)this.getScrollAmount()),
            this.getWidth(),
            this.getHeight(),
            32,
            32
    ...
    protected void enableScissor(GuiGraphics pGuiGraphics) {
        pGuiGraphics.enableScissor(this.getX(), this.getY(), this.m_307439_(), this.m_306468_());
    }
    ...
    protected void ensureVisible(E pEntry) {
        ...
        int k = this.m_306468_() - i - this.itemHeight - this.itemHeight;
        if (k < 0) {
            this.scroll(-k);
        }
    }
    ...
    protected int getScrollbarPosition() {
        return this.m_319264_();
    }

    protected int m_319264_() {
        return this.m_323514_() + this.m_321155_();
    }

    private int m_321155_() {
        return 10;
    }
    ...
    public boolean mouseDragged(double pMouseX, double pMouseY, int pButton, double pDragX, double pDragY) {
        if (super.mouseDragged(pMouseX, pMouseY, pButton, pDragX, pDragY)) {
            ...
            } else if (pMouseY > (double)this.m_306468_()) {
    ...
    public boolean isMouseOver(double pMouseX, double pMouseY) {
        return pMouseY >= (double)this.getY()
            && pMouseY <= (double)this.m_306468_()
            && pMouseX >= (double)this.getX()
            && pMouseX <= (double)this.m_307439_();
    }
    ...
    protected void renderList(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        for (int i1 = 0; i1 < l; i1++) {
            ...
            if (k1 >= this.getY() && j1 <= this.m_306468_()) {
    ...
    private int m_323514_() {
        return this.m_325018_() + this.getRowWidth();
    }
