...
public class ClientBundleTooltip implements ClientTooltipComponent {
    ...
    private final BundleContents f_314813_;

    public ClientBundleTooltip(BundleContents p_335644_) {
        this.f_314813_ = p_335644_;
    }
    ...
    public void renderImage(Font pFont, int pX, int pY, GuiGraphics pGuiGraphics) {
        ...
        boolean flag = this.f_314813_.m_320631_().compareTo(Fraction.ONE) >= 0;
        int k = 0;
    ...
    private int gridSizeX() {
        return Math.max(2, (int)Math.ceil(Math.sqrt((double)this.f_314813_.m_321706_() + 1.0)));
    }

    private int gridSizeY() {
        return (int)Math.ceil(((double)this.f_314813_.m_321706_() + 1.0) / (double)this.gridSizeX());
    }
