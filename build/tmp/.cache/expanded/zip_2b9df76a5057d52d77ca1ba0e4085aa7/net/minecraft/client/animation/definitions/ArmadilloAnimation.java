...
public class ArmadilloAnimation {
    public static final AnimationDefinition f_315724_ = AnimationDefinition.Builder.withLength(0.5F)
        .addAnimation(
            "body",
        ...
        .build();
    public static final AnimationDefinition f_314004_ = AnimationDefinition.Builder.withLength(1.4583F)
        .looping()
        .addAnimation(
            "body",
            new AnimationChannel(
        ...
        .build();
    public static final AnimationDefinition f_315658_ = AnimationDefinition.Builder.withLength(2.5F)
        .addAnimation(
            "head",
            new AnimationChannel(
                AnimationChannel.Targets.ROTATION,
        ...
        .build();
    public static final AnimationDefinition f_315893_ = AnimationDefinition.Builder.withLength(1.5F)
        .addAnimation(
            "head",
            new AnimationChannel(
                AnimationChannel.Targets.ROTATION,
