...
public class CatRenderer extends MobRenderer<Cat, CatModel<Cat>> {
    ...
    protected void setupRotations(Cat pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float p_328718_) {
        super.setupRotations(pEntityLiving, pPoseStack, pAgeInTicks, pRotationYaw, pPartialTicks, p_328718_);
