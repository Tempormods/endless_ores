...
public class TitleScreen extends Screen {
    ...
    private static final Component f_316071_ = Component.translatable("narrator.screen.title");
    ...
    public static CompletableFuture<Void> preloadResources(TextureManager pTexMngr, Executor pBackgroundExecutor) {
        return CompletableFuture.allOf(
            ...
            pTexMngr.preload(PanoramaRenderer.f_314014_, pBackgroundExecutor),
            f_314949_.preload(pTexMngr, pBackgroundExecutor)
        );
    }
    ...
    private void createDemoMenuOptions(int pY, int pRowHeight) {
        ...
        this.addRenderableWidget(Button.builder(Component.translatable("menu.playdemo"), p_325371_ -> {
            if (flag) {
                this.minecraft.createWorldOpenFlows().m_320872_("Demo_World", () -> this.minecraft.setScreen(this));
            } else {
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        if (this.fading) {
            ...
            if (f1 > 1.0F) {
                ...
                this.f_315047_ = Mth.clampedMap(f1, 0.0F, 0.5F, 0.0F, 1.0F);
            }
        ...
        if ((i & -67108864) != 0) {
            ...
            if (this.splash != null && !this.minecraft.options.m_307023_().get()) {
    ...
    private void m_320273_(float p_335005_) {
    ...
    @Override
    protected void m_318720_(GuiGraphics p_335595_, float p_331154_) {
        f_317031_.render(p_335595_, this.width, this.height, this.f_315047_, this.m_323263_());
    }
