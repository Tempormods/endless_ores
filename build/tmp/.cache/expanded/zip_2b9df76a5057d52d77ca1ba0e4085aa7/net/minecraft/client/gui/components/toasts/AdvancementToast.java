...
public class AdvancementToast implements Toast {
    ...
    public Toast.Visibility render(GuiGraphics pGuiGraphics, ToastComponent pToastComponent, long pTimeSinceLastVisible) {
        ...
        if (displayinfo != null) {
            ...
            if (list.size() == 1) {
                pGuiGraphics.drawString(pToastComponent.getMinecraft().font, displayinfo.m_306629_().m_306854_(), 30, 7, i | 0xFF000000, false);
                ...
                if (pTimeSinceLastVisible < 1500L) {
                    ...
                    pGuiGraphics.drawString(pToastComponent.getMinecraft().font, displayinfo.m_306629_().m_306854_(), 30, 11, i | k, false);
                } else {
