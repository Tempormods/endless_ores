...
public abstract class SpriteIconButton extends Button {
    ...
    SpriteIconButton(
        ...
        super(0, 0, pWidth, pHeight, pMessage, pOnPress, p_335316_ == null ? DEFAULT_NARRATION : p_335316_);
    ...
    public static class Builder {
        ...
        @Nullable
        Button.CreateNarration f_314116_;
        ...
        public SpriteIconButton.Builder m_323620_(Button.CreateNarration p_328959_) {
            this.f_314116_ = p_328959_;
            return this;
        }
            ...
            if (this.sprite == null) {
                ...
                return (SpriteIconButton)(this.iconOnly
                    ? new SpriteIconButton.CenteredIcon(
                        this.width, this.height, this.message, this.spriteWidth, this.spriteHeight, this.sprite, this.onPress, this.f_314116_
                    )
