...
public class EffectInstance implements Effect, AutoCloseable {
    ...
    public EffectInstance(ResourceProvider p_334130_, String pName) throws IOException {
    ...
    public static EffectProgram getOrCreate(ResourceProvider p_331503_, Program.Type pProgramType, String pName) throws IOException {
