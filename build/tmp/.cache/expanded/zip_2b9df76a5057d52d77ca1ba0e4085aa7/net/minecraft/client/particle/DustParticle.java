...
public class DustParticle extends DustParticleBase<DustParticleOptions> {
    protected DustParticle(
        ...
        this.rCol = this.randomizeColor(pOptions.m_323596_().x(), f);
        this.gCol = this.randomizeColor(pOptions.m_323596_().y(), f);
        this.bCol = this.randomizeColor(pOptions.m_323596_().z(), f);
    }
