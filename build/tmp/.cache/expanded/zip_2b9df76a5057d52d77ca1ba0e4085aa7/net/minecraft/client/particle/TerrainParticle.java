...
public class TerrainParticle extends TextureSheetParticle {
    ...
    @Nullable
    static TerrainParticle m_321734_(
    ...
    public static class DustPillarProvider implements ParticleProvider<BlockParticleOption> {
        ...
        public Particle createParticle(
            ...
            Particle particle = TerrainParticle.m_321734_(p_331644_, p_335147_, p_334048_, p_329502_, p_331778_, p_332962_, p_334493_, p_329453_);
            if (particle != null) {
    ...
    public static class Provider implements ParticleProvider<BlockParticleOption> {
        ...
        public Particle createParticle(
            ...
            return TerrainParticle.m_321734_(pType, pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
        }
    }
}
