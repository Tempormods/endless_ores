...
public class ConfirmExperimentalFeaturesScreen extends Screen {
    ...
    class DetailsScreen extends Screen {
        private static final Component f_317043_ = Component.translatable("selectWorld.experimental.details.title");
        final HeaderAndFooterLayout f_317051_ = new HeaderAndFooterLayout(this);
        @Nullable
        private ConfirmExperimentalFeaturesScreen.DetailsScreen.PackList f_314114_;
        ...
        @Override
        protected void init() {
            this.f_317051_.m_324480_(f_317043_, this.font);
            this.f_314114_ = this.f_317051_
            ...
            this.f_317051_.addToFooter(Button.builder(CommonComponents.GUI_BACK, p_251286_ -> this.onClose()).build());
            this.f_317051_.visitWidgets(p_325419_ -> {
        ...
        @Override
        protected void repositionElements() {
            if (this.f_314114_ != null) {
                this.f_314114_.m_319425_(this.width, this.f_317051_);
            }

            this.f_317051_.arrangeElements();
        }
        ...
        class PackList extends ObjectSelectionList<ConfirmExperimentalFeaturesScreen.DetailsScreen.PackListEntry> {
            public PackList(final Minecraft pMinecraft, final Collection<Pack> pEnabledPacks) {
                super(pMinecraft, DetailsScreen.this.width, DetailsScreen.this.f_317051_.m_319781_(), DetailsScreen.this.f_317051_.getHeaderHeight(), (9 + 2) * 3);
