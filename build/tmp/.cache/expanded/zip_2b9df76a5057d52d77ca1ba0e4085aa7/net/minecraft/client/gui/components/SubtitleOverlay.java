...
public class SubtitleOverlay implements SoundEventListener {
    ...
    private final List<SubtitleOverlay.Subtitle> f_303493_ = new ArrayList<>();
    ...
    public void render(GuiGraphics pGuiGraphics) {
        ...
        if (this.isListening) {
            ListenerTransform listenertransform = soundmanager.m_307930_();
            Vec3 vec3 = listenertransform.f_303699_();
            Vec3 vec31 = listenertransform.f_302679_();
            Vec3 vec32 = listenertransform.m_306092_();
            this.f_303493_.clear();

            for (SubtitleOverlay.Subtitle subtitleoverlay$subtitle : this.subtitles) {
                if (subtitleoverlay$subtitle.m_305478_(vec3)) {
                    this.f_303493_.add(subtitleoverlay$subtitle);
                }
            }

            if (!this.f_303493_.isEmpty()) {
                int i2 = 0;
                int j2 = 0;
                double d0 = this.minecraft.options.notificationDisplayTime().get();
                Iterator<SubtitleOverlay.Subtitle> iterator = this.f_303493_.iterator();
                ...
                for (SubtitleOverlay.Subtitle subtitleoverlay$subtitle2 : this.f_303493_) {
                    int i = 255;
    ...
    @Override
    public void onPlaySound(SoundInstance pSound, WeighedSoundEvents pAccessor, float p_311530_) {
        if (pAccessor.getSubtitle() != null) {
            ...
            this.subtitles.add(new SubtitleOverlay.Subtitle(component, p_311530_, new Vec3(pSound.getX(), pSound.getY(), pSound.getZ())));
        }
    }
    ...
    public static class Subtitle {
        ...
        private final float f_303624_;
        private long time;
        private Vec3 location;

        public Subtitle(Component pText, float p_312799_, Vec3 pLocation) {
            this.text = pText;
            this.f_303624_ = p_312799_;
        ...
        public boolean m_305478_(Vec3 p_313169_) {
            return Float.isInfinite(this.f_303624_) || p_313169_.closerThan(this.location, (double)this.f_303624_);
        }
    }
}