...
public class PandaRenderer extends MobRenderer<Panda, PandaModel<Panda>> {
    ...
    protected void setupRotations(Panda pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float p_331784_) {
        super.setupRotations(pEntityLiving, pPoseStack, pAgeInTicks, pRotationYaw, pPartialTicks, p_331784_);
