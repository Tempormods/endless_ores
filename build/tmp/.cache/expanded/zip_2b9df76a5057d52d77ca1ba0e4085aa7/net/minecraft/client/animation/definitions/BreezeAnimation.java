...
public class BreezeAnimation {
    public static final AnimationDefinition f_302892_ = AnimationDefinition.Builder.withLength(1.125F)
        .addAnimation(
            "head",
        ...
        .build();
    public static final AnimationDefinition f_302325_ = AnimationDefinition.Builder.withLength(1.125F)
        .addAnimation(
            "body",
            new AnimationChannel(
                AnimationChannel.Targets.POSITION,
        ...
        .build();
    public static final AnimationDefinition f_303619_ = AnimationDefinition.Builder.withLength(0.2F)
        .addAnimation(
            "body",
            new AnimationChannel(
                AnimationChannel.Targets.POSITION,
        ...
        .build();
    public static final AnimationDefinition f_314955_ = AnimationDefinition.Builder.withLength(0.1F)
        .addAnimation(
            "body",
            new AnimationChannel(
                AnimationChannel.Targets.POSITION,
