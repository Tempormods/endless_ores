...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
    ...
    public static void renderCrystalBeams(
        ...
        for (int j = 1; j <= 8; j++) {
            ...
            vertexconsumer.m_320578_(posestack$pose, f4 * 0.2F, f5 * 0.2F, 0.0F)
                .color(0, 0, 0, 255)
                .uv(f6, f2)
                ...
                .endVertex();
            vertexconsumer.m_320578_(posestack$pose, f4, f5, f1)
                ...
                .normal(posestack$pose, 0.0F, -1.0F, 0.0F)
                .endVertex();
            vertexconsumer.m_320578_(posestack$pose, f7, f8, f1)
                .color(255, 255, 255, 255)
                .uv(f9, f3)
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(pPackedLight)
                .normal(posestack$pose, 0.0F, -1.0F, 0.0F)
                .endVertex();
            vertexconsumer.m_320578_(posestack$pose, f7 * 0.2F, f8 * 0.2F, 0.0F)
                .color(0, 0, 0, 255)
                .uv(f9, f2)
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(pPackedLight)
