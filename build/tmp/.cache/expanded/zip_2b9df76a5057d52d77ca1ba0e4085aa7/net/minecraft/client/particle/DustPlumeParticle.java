...
public class DustPlumeParticle extends BaseAshSmokeParticle {
    private static final int f_303508_ = 12235202;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet f_303099_;

        public Provider(SpriteSet p_310852_) {
            this.f_303099_ = p_310852_;
        }
        ...
        public Particle createParticle(
            ...
            return new DustPlumeParticle(p_310371_, p_310904_, p_310946_, p_312810_, p_309747_, p_311225_, p_310480_, 1.0F, this.f_303099_);
        }
    }
}