...
public class SpellParticle extends TextureSheetParticle {
    ...
    public void tick() {
        ...
        if (this.isCloseToScopingPlayer()) {
            ...
            this.alpha = Mth.lerp(0.05F, this.alpha, this.f_316302_);
        }
    }
    ...
    public static class MobEffectProvider implements ParticleProvider<ColorParticleOption> {
        private final SpriteSet f_314627_;

        public MobEffectProvider(SpriteSet p_328237_) {
            this.f_314627_ = p_328237_;
        }
        ...
        public Particle createParticle(
            ...
            Particle particle = new SpellParticle(p_333235_, p_327722_, p_329690_, p_335059_, p_332176_, p_334375_, p_330165_, this.f_314627_);
            particle.setColor(p_329447_.m_320442_(), p_329447_.m_319328_(), p_329447_.m_321365_());
            particle.setAlpha(p_329447_.m_323169_());
            return particle;
        }
    }
