...
public final class OptionInstance<T> {
    ...
    public AbstractWidget m_324463_(Options p_332722_) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static record IntRange(int minInclusive, int maxInclusive, boolean f_316444_) implements OptionInstance.IntRangeBase {
    ...
    public static final class OptionInstanceSliderButton<N> extends AbstractOptionSliderButton {
        ...
        protected void applyValue() {
            if (this.f_316343_) {
                ...
                this.f_316943_ = Util.getMillis() + 600L;
            }
        }
        ...
        public void renderWidget(GuiGraphics p_332467_, int p_329907_, int p_334179_, float p_329288_) {
            ...
            if (this.f_316943_ != null && Util.getMillis() >= this.f_316943_) {
                this.f_316943_ = null;
                this.m_323527_();
            }
        }
    ...
    interface SliderableValueSet<T> extends OptionInstance.ValueSet<T> {
        ...
        default Function<OptionInstance<T>, AbstractWidget> createButton(
            ...
            return p_325282_ -> new OptionInstance.OptionInstanceSliderButton<>(
                    pOptions, pX, pY, pWidth, 20, p_325282_, this, pTooltipSupplier, pOnValueChanged, this.m_320795_()
                );
        }
    }
