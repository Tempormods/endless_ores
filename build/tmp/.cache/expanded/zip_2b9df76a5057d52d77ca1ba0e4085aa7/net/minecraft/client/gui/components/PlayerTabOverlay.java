...
public class PlayerTabOverlay {
    ...
    public void render(GuiGraphics pGuiGraphics, int pWidth, Scoreboard pScoreboard, @Nullable Objective pObjective) {
        ...
        for (PlayerInfo playerinfo : list) {
            ...
            int i1 = 0;
            if (pObjective != null) {
                ScoreHolder scoreholder = ScoreHolder.m_305011_(playerinfo.getProfile());
                ReadOnlyScoreInfo readonlyscoreinfo = pScoreboard.m_305759_(scoreholder, pObjective);
                if (readonlyscoreinfo != null) {
                    l = readonlyscoreinfo.m_305685_();
                }

                if (pObjective.getRenderType() != ObjectiveCriteria.RenderType.HEARTS) {
                    NumberFormat numberformat = pObjective.m_305063_(StyledFormat.f_302354_);
                    component1 = ReadOnlyScoreInfo.m_305849_(readonlyscoreinfo, numberformat);
        ...
        for (int k4 = 0; k4 < j2; k4++) {
            ...
            if (k4 < list.size()) {
                ...
                pGuiGraphics.drawString(
                    this.minecraft.font,
                    playertaboverlay$scoredisplayentry.f_303716_,
                    l1,
                    i2,
    ...
    private void renderTablistScore(
        Objective pObjective, int pY, PlayerTabOverlay.ScoreDisplayEntry p_312058_, int p_283533_, int p_281254_, UUID pPlayerUuid, GuiGraphics pGuiGraphics
    ) {
        if (pObjective.getRenderType() == ObjectiveCriteria.RenderType.HEARTS) {
            this.renderTablistHearts(pY, p_283533_, p_281254_, pPlayerUuid, pGuiGraphics, p_312058_.f_303697_);
        } else if (p_312058_.f_303794_ != null) {
            pGuiGraphics.drawString(this.minecraft.font, p_312058_.f_303794_, p_281254_ - p_312058_.f_302857_, pY, 16777215);
        }
    }
    ...
    private void renderTablistHearts(int pY, int p_283173_, int p_282149_, UUID pPlayerUuid, GuiGraphics pGuiGraphics, int pHealth) {
        ...
        if (i > 0) {
            ...
            if (k <= 3) {
                ...
                pGuiGraphics.drawString(
                    this.minecraft.font, component1, (p_282149_ + p_283173_ - this.minecraft.font.width(component1)) / 2, pY, j1
                );
            } else {
    ...
    @OnlyIn(Dist.CLIENT)
    static record ScoreDisplayEntry(Component f_303716_, int f_303697_, @Nullable Component f_303794_, int f_302857_) {
    }
}