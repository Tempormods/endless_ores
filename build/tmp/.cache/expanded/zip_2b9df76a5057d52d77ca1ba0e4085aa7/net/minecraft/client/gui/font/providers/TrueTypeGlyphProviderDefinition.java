            ...
            try (InputStream inputstream = p_286229_.open(this.location.withPrefix("font/"))) {
                ...
                synchronized (FreeTypeUtil.f_314736_) {
                    try (MemoryStack memorystack = MemoryStack.stackPush()) {
                        ...
                        FreeTypeUtil.m_322856_(FreeType.FT_New_Memory_Face(FreeTypeUtil.m_319232_(), bytebuffer, 0L, pointerbuffer), "Initializing font face");
                    ...
                    FreeTypeUtil.m_322856_(FreeType.FT_Select_Charmap(ft_face, FreeType.FT_ENCODING_UNICODE), "Find unicode charmap");
