...
public class LevelLoadingScreen extends Screen {
    ...
    private static final Object2IntMap<ChunkStatus> COLORS = Util.make(new Object2IntOpenHashMap<>(), p_280803_ -> {
        ...
        p_280803_.put(ChunkStatus.f_314297_, 5526612);
        p_280803_.put(ChunkStatus.f_317114_, 10066329);
        p_280803_.put(ChunkStatus.f_316571_, 6250897);
        p_280803_.put(ChunkStatus.f_316460_, 8434258);
        p_280803_.put(ChunkStatus.f_316398_, 13750737);
        p_280803_.put(ChunkStatus.f_316036_, 7497737);
        p_280803_.put(ChunkStatus.f_314171_, 3159410);
        p_280803_.put(ChunkStatus.f_314060_, 2213376);
        p_280803_.put(ChunkStatus.f_315473_, 13421772);
        p_280803_.put(ChunkStatus.f_316967_, 16769184);
        p_280803_.put(ChunkStatus.f_316387_, 15884384);
        p_280803_.put(ChunkStatus.f_315432_, 16777215);
    });
