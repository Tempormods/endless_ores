...
public class IntegratedServer extends MinecraftServer {
    ...
    protected LocalSampleLogger m_318596_() {
        return this.minecraft.getDebugOverlay().m_324537_();
    }
    ...
    public boolean publishServer(@Nullable GameType pGameMode, boolean pCheats, int pPort) {
        try {
            ...
            this.getPlayerList().m_318715_(pCheats);
    ...
    private void m_321341_() {
        if (this.storageSource.m_323802_()) {
            SystemToast.m_321093_(this.minecraft);
        }
    }

    @Override
    public void logTickTime(ChunkPos p_335057_) {
        this.m_321341_();
        SystemToast.m_321637_(this.minecraft, p_335057_);
    }

    @Override
    public void m_322794_(ChunkPos p_328809_) {
        this.m_321341_();
        SystemToast.m_323567_(this.minecraft, p_328809_);
    }
}
