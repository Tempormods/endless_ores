...
public abstract class Particle {
    ...
    public static record LifetimeAlpha(float f_315806_, float f_316797_, float f_315332_, float f_315978_) {
        ...
        public float m_320282_(int p_335935_, int p_329593_, float p_335112_) {
            if (Mth.equal(this.f_315806_, this.f_316797_)) {
                return this.f_315806_;
            } else {
                float f = Mth.inverseLerp(((float)p_335935_ + p_335112_) / (float)p_329593_, this.f_315332_, this.f_315978_);
                return Mth.clampedLerp(this.f_315806_, this.f_316797_, f);
            }
        }
    }
}
