...
public class ExperimentsScreen extends Screen {
    private static final Component f_315315_ = Component.translatable("selectWorld.experiments");
    private static final Component f_315316_ = Component.translatable("selectWorld.experiments.info").withStyle(ChatFormatting.RED);
    ...
    @Override
    protected void init() {
        this.layout.m_324480_(f_315315_, this.font);
        LinearLayout linearlayout = this.layout.addToContents(LinearLayout.vertical());
        linearlayout.addChild(new MultiLineTextWidget(f_315316_, this.font).setMaxWidth(310), p_296222_ -> p_296222_.paddingBottom(15));
    ...
    public Component getNarrationMessage() {
        return CommonComponents.joinForNarration(super.getNarrationMessage(), f_315316_);
    }
