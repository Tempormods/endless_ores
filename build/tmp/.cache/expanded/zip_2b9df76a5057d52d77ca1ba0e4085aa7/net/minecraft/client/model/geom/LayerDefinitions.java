...
public class LayerDefinitions {
    ...
    public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
        ...
        builder.put(ModelLayers.f_316495_, ArmadilloModel.m_320313_());
        ...
        builder.put(ModelLayers.f_316706_, BoggedModel.m_322540_());
        builder.put(ModelLayers.f_316561_, layerdefinition3);
        builder.put(ModelLayers.f_316376_, layerdefinition1);
        builder.put(ModelLayers.f_316513_, LayerDefinition.create(HumanoidModel.createMesh(new CubeDeformation(0.2F), 0.0F), 64, 32));
        builder.put(ModelLayers.BOOK, BookModel.createBodyLayer());
        builder.put(ModelLayers.f_303100_, BreezeModel.m_304895_(32, 32));
        ...
        builder.put(ModelLayers.f_303259_, WindChargeModel.m_305784_());
        ...
        builder.put(ModelLayers.WOLF, LayerDefinition.create(WolfModel.m_324610_(CubeDeformation.NONE), 64, 32));
        builder.put(ModelLayers.f_315853_, LayerDefinition.create(WolfModel.m_324610_(new CubeDeformation(0.2F)), 64, 32));
