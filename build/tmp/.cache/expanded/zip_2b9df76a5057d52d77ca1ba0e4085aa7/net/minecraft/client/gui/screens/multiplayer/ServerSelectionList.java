...
public class ServerSelectionList extends ObjectSelectionList<ServerSelectionList.Entry> {
    ...
    static final Component CANT_RESOLVE_TEXT = Component.translatable("multiplayer.status.cannot_resolve").m_306658_(-65536);
    static final Component CANT_CONNECT_TEXT = Component.translatable("multiplayer.status.cannot_connect").m_306658_(-65536);
    ...
    public ServerSelectionList(JoinMultiplayerScreen pScreen, Minecraft pMinecraft, int pWidth, int pHeight, int pY0, int pY1) {
    ...
    public void updateNetworkServers(List<LanServer> pLanServers) {
        ...
        for (int i1 = this.networkServers.size() - i; i1 < this.networkServers.size(); i1++) {
            ...
            if (l >= this.getY() && k <= this.m_306468_()) {
    ...
    public class OnlineServerEntry extends ServerSelectionList.Entry {
        ...
        private static final int f_315691_ = 5;
        private static final int f_316961_ = 10;
        private static final int f_314117_ = 8;
        private final JoinMultiplayerScreen screen;
        ...
        private long lastClickTime;
        @Nullable
        private List<Component> f_314918_;
        @Nullable
        private ResourceLocation f_313992_;
        @Nullable
        private Component f_317096_;
        ...
        public void render(
            ...
            if (this.serverData.m_323345_() == ServerData.State.INITIAL) {
                this.serverData.m_322383_(ServerData.State.PINGING);
                                ...
                                this.screen
                                    ...
                                    .pingServer(
                                        ...
                                        () -> {
                                            ...
                                            this.minecraft.execute(this::m_321999_);
                                        }
                                    );
                            } catch (UnknownHostException unknownhostexception) {
                                this.serverData.m_322383_(ServerData.State.UNREACHABLE);
            ...
            if (this.serverData.m_323345_() == ServerData.State.PINGING) {
                int j1 = (int)(Util.getMillis() / 100L + (long)(pIndex * 2) & 7L);
                if (j1 > 4) {
                    j1 = 8 - j1;
                }
                this.f_313992_ = switch (j1) {
            ...
            if (this.f_313992_ != null) {
                pGuiGraphics.blitSprite(this.f_313992_, k1, pTop, 10, 8);
            }
            ...
            Component component = (Component)(this.serverData.m_323345_() == ServerData.State.INCOMPATIBLE
            ...
            if (this.f_317096_ != null && pMouseX >= k1 && pMouseX <= k1 + 10 && pMouseY >= pTop && pMouseY <= pTop + 8) {
                this.screen.setTooltipForNextRenderPass(this.f_317096_);
            } else if (this.f_314918_ != null && pMouseX >= k && pMouseX <= k + j && pMouseY >= pTop && pMouseY <= pTop - 1 + 9) {
                this.screen.setTooltipForNextRenderPass(Lists.transform(this.f_314918_, Component::getVisualOrderText));
            }
        ...
        private void m_321999_() {
            this.f_314918_ = null;
            switch (this.serverData.m_323345_()) {
                case INITIAL:
                case PINGING:
                    this.f_313992_ = ServerSelectionList.PING_1_SPRITE;
                    this.f_317096_ = ServerSelectionList.PINGING_STATUS;
                    break;
                case INCOMPATIBLE:
                    this.f_313992_ = ServerSelectionList.INCOMPATIBLE_SPRITE;
                    this.f_317096_ = ServerSelectionList.INCOMPATIBLE_STATUS;
                    this.f_314918_ = this.serverData.playerList;
                    break;
                case UNREACHABLE:
                    this.f_313992_ = ServerSelectionList.UNREACHABLE_SPRITE;
                    this.f_317096_ = ServerSelectionList.NO_CONNECTION_STATUS;
                    break;
                case SUCCESSFUL:
                    if (this.serverData.ping < 150L) {
                        this.f_313992_ = ServerSelectionList.PING_5_SPRITE;
                    } else if (this.serverData.ping < 300L) {
                        this.f_313992_ = ServerSelectionList.PING_4_SPRITE;
                    } else if (this.serverData.ping < 600L) {
                        this.f_313992_ = ServerSelectionList.PING_3_SPRITE;
                    } else if (this.serverData.ping < 1000L) {
                        this.f_313992_ = ServerSelectionList.PING_2_SPRITE;
                    } else {
                        this.f_313992_ = ServerSelectionList.PING_1_SPRITE;
                    }

                    this.f_317096_ = Component.translatable("multiplayer.status.ping", this.serverData.ping);
                    this.f_314918_ = this.serverData.playerList;
            }
        }
