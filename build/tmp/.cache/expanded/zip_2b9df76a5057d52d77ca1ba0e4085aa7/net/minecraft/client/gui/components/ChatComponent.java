...
public class ChatComponent {
    ...
    public void render(GuiGraphics pGuiGraphics, int pTickCount, int pMouseX, int pMouseY, boolean p_328818_) {
    ...
    private void m_320310_(GuiMessage p_332173_) {
        int i = Mth.floor((double)this.getWidth() / this.getScale());
        GuiMessageTag.Icon guimessagetag$icon = p_332173_.m_324870_();
    ...
    private void m_319022_(GuiMessage p_330648_) {
    ...
    public void m_324317_(ChatComponent.State p_330708_) {
        this.recentChat.clear();
        this.recentChat.addAll(p_330708_.f_313945_);
        this.messageDeletionQueue.clear();
        this.messageDeletionQueue.addAll(p_330708_.f_314978_);
        this.allMessages.clear();
        this.allMessages.addAll(p_330708_.f_315793_);
        this.m_324364_();
    }
    ...
    public static class State {
        ...
        public State(List<GuiMessage> p_334723_, List<String> p_331396_, List<ChatComponent.DelayedMessageDeletion> p_332733_) {
            this.f_315793_ = p_334723_;
            this.f_313945_ = p_331396_;
            this.f_314978_ = p_332733_;
        }
    }
}