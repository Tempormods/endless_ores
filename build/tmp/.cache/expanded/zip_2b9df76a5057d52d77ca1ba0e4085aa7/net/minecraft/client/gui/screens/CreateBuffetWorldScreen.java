...
public class CreateBuffetWorldScreen extends Screen {
    private static final Component BIOME_SELECT_INFO = Component.translatable("createWorld.customize.buffet.biome").m_306658_(-8355712);
    private static final int f_314468_ = 8;
    private final HeaderAndFooterLayout f_315611_ = new HeaderAndFooterLayout(this);
    ...
    @Override
    protected void init() {
        LinearLayout linearlayout = this.f_315611_.addToHeader(LinearLayout.vertical().spacing(8));
        ...
        this.list = this.f_315611_.addToContents(new CreateBuffetWorldScreen.BiomeList());
        LinearLayout linearlayout1 = this.f_315611_.addToFooter(LinearLayout.horizontal().spacing(8));
        ...
        this.f_315611_.visitWidgets(this::addRenderableWidget);
        this.repositionElements();
    }

    @Override
    protected void repositionElements() {
        this.f_315611_.arrangeElements();
        this.list.m_319425_(this.width, this.f_315611_);
    }
