...
public class SalmonRenderer extends MobRenderer<Salmon, SalmonModel<Salmon>> {
    ...
    protected void setupRotations(Salmon pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float p_329335_) {
        super.setupRotations(pEntityLiving, pPoseStack, pAgeInTicks, pRotationYaw, pPartialTicks, p_329335_);
        float f = 1.0F;
        float f1 = 1.0F;
