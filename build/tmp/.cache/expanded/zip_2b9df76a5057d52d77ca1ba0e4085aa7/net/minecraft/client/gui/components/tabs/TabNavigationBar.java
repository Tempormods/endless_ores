...
public class TabNavigationBar extends AbstractContainerEventHandler implements Renderable, NarratableEntry {
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        pGuiGraphics.blit(
            Screen.f_316769_, 0, this.layout.getY() + this.layout.getHeight() - 2, 0.0F, 0.0F, this.tabButtons.get(0).getX(), 2, 32, 2
        );
        int i = this.tabButtons.get(this.tabButtons.size() - 1).m_307439_();
        pGuiGraphics.blit(Screen.f_316769_, i, this.layout.getY() + this.layout.getHeight() - 2, 0.0F, 0.0F, this.width, 2, 32, 2);
