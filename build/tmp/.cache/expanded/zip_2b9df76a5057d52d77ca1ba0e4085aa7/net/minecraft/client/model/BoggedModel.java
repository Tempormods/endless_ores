...
public class BoggedModel extends SkeletonModel<Bogged> {
    private final ModelPart f_317098_;

    public BoggedModel(ModelPart p_329837_) {
        super(p_329837_);
        this.f_317098_ = p_329837_.getChild("head").getChild("mushrooms");
    }

    public static LayerDefinition m_322540_() {
        MeshDefinition meshdefinition = HumanoidModel.createMesh(CubeDeformation.NONE, 0.0F);
        PartDefinition partdefinition = meshdefinition.getRoot();
        SkeletonModel.m_322411_(partdefinition);
    ...
    public void prepareMobModel(Bogged p_333204_, float p_330113_, float p_329620_, float p_334779_) {
        this.f_317098_.visible = !p_333204_.m_324815_();
