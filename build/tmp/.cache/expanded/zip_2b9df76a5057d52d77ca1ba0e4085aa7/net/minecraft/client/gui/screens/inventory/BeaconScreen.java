...
public class BeaconScreen extends AbstractContainerScreen<BeaconMenu> {
    ...
    class BeaconPowerButton extends BeaconScreen.BeaconScreenButton {
        ...
        public BeaconPowerButton(final int pX, final int pY, final Holder<MobEffect> p_336384_, final boolean pIsPrimary, final int pTier) {
            super(pX, pY);
    ...
    class BeaconUpgradePowerButton extends BeaconScreen.BeaconPowerButton {
        public BeaconUpgradePowerButton(final int pX, final int pY, final Holder<MobEffect> p_330320_) {
            super(pX, pY, p_330320_, false, 3);
        }
