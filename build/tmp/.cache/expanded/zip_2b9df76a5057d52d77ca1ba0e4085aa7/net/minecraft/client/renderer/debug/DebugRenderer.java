...
public class DebugRenderer {
    ...
    public final BreezeDebugRenderer f_302493_;
    ...
    public DebugRenderer(Minecraft pMinecraft) {
        ...
        this.f_302493_ = new BreezeDebugRenderer(pMinecraft);
    }
    ...
    public static void renderFilledBox(
        ...
        if (camera.isInitialized()) {
            ...
            AABB aabb = AABB.m_307411_(pStartPos, pEndPos).move(vec3);
