...
public class ServerStatusPinger {
    ...
    private static final Component CANT_CONNECT_MESSAGE = Component.translatable("multiplayer.status.cannot_connect").m_306658_(-65536);
    private final List<Connection> connections = Collections.synchronizedList(Lists.newArrayList());

    public void pingServer(final ServerData pServer, final Runnable pServerListUpdater, final Runnable p_335024_) throws UnknownHostException {
        ...
        if (optional.isEmpty()) {
            ...
            try {
                ...
                connection.send(ServerboundStatusRequestPacket.f_315857_);
        ...
        new Bootstrap().group(Connection.NETWORK_WORKER_GROUP.get()).handler(new ChannelInitializer<Channel>() {
            ...
            protected void initChannel(Channel p_105498_) {
                ...
                p_105498_.pipeline().addLast(new LegacyServerPinger(pServerAddress, (p_325482_, p_325483_, p_325484_, p_325485_, p_325486_) -> {
                    pServerData.m_322383_(ServerData.State.INCOMPATIBLE);
