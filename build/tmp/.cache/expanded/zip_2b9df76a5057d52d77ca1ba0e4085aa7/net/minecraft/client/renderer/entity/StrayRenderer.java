...
public class StrayRenderer extends SkeletonRenderer<Stray> {
    ...
    private static final ResourceLocation f_315665_ = new ResourceLocation("textures/entity/skeleton/stray_overlay.png");
    ...
    public StrayRenderer(EntityRendererProvider.Context p_174409_) {
        ...
        this.addLayer(new SkeletonClothingLayer<>(this, p_174409_.getModelSet(), ModelLayers.STRAY_OUTER_LAYER, f_315665_));
    }
