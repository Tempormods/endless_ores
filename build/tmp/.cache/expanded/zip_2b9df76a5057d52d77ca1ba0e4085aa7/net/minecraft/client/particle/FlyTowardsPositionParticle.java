...
public class FlyTowardsPositionParticle extends TextureSheetParticle {
    ...
    FlyTowardsPositionParticle(
        ...
        this.setAlpha(p_330679_.f_315806_());
        this.xd = p_331161_;
        this.yd = p_331135_;
        this.zd = p_331015_;
    ...
    public ParticleRenderType getRenderType() {
        return this.f_314137_.m_320160_() ? ParticleRenderType.PARTICLE_SHEET_OPAQUE : ParticleRenderType.PARTICLE_SHEET_TRANSLUCENT;
    }
    ...
    public void tick() {
        ...
        if (this.age++ >= this.lifetime) {
            ...
            f1 *= f1;
            f1 *= f1;
            this.x = this.f_315124_ + this.xd * (double)f;
            this.y = this.f_315139_ + this.yd * (double)f - (double)(f1 * 1.2F);
            this.z = this.f_316468_ + this.zd * (double)f;
    ...
    public void render(VertexConsumer p_329880_, Camera p_328408_, float p_328709_) {
        this.setAlpha(this.f_314137_.m_320282_(this.age, this.lifetime, p_328709_));
    ...
    public static class EnchantProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            flytowardspositionparticle.pickSprite(this.f_316710_);
    ...
    public static class NautilusProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            flytowardspositionparticle.pickSprite(this.f_316199_);
            return flytowardspositionparticle;
        }
    }
    ...
    public static class VaultConnectionProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            flytowardspositionparticle.pickSprite(this.f_315002_);
            return flytowardspositionparticle;
        }
    }
}
