...
public class WhiteSmokeParticle extends BaseAshSmokeParticle {
    private static final int f_303306_ = 12235202;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet f_303082_;

        public Provider(SpriteSet p_309673_) {
            this.f_303082_ = p_309673_;
        }
        ...
        public Particle createParticle(
            ...
            return new WhiteSmokeParticle(p_309967_, p_312945_, p_312815_, p_311211_, p_311415_, p_310534_, p_312986_, 1.0F, this.f_303082_);
        }
    }
}