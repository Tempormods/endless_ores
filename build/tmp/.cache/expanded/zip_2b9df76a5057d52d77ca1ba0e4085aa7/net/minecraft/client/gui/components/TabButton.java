...
public class TabButton extends AbstractWidget {
    ...
    public void renderWidget(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        if (this.isSelected()) {
            this.m_321757_(pGuiGraphics, this.getX() + 2, this.getY() + 2, this.m_307439_() - 2, this.m_306468_());
            this.renderFocusUnderline(pGuiGraphics, font, i);
        }
    }

    protected void m_321757_(GuiGraphics p_334401_, int p_333407_, int p_335108_, int p_329341_, int p_334182_) {
        Screen.m_323099_(p_334401_, Screen.f_315252_, p_333407_, p_335108_, 0.0F, 0.0F, p_329341_ - p_333407_, p_334182_ - p_335108_);
    }
