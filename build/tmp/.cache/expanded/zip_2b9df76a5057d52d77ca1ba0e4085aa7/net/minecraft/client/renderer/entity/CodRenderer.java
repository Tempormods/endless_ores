...
public class CodRenderer extends MobRenderer<Cod, CodModel<Cod>> {
    ...
    protected void setupRotations(Cod pEntityLiving, PoseStack pPoseStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks, float p_333854_) {
        super.setupRotations(pEntityLiving, pPoseStack, pAgeInTicks, pRotationYaw, pPartialTicks, p_333854_);
