...
public class EntityRenderers {
    ...
    static {
        ...
        register(EntityType.f_316265_, ArmadilloRenderer::new);
        ...
        register(EntityType.f_316281_, BoggedRenderer::new);
        register(EntityType.f_302782_, BreezeRenderer::new);
        register(EntityType.f_315936_, WindChargeRenderer::new);
        ...
        register(EntityType.f_314497_, OminousItemSpawnerRenderer::new);
        ...
        register(EntityType.f_303421_, WindChargeRenderer::new);
