...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
    ...
    protected void renderSlot(GuiGraphics pGuiGraphics, Slot pSlot) {
        ...
        if (!flag1) {
            ...
            if (pSlot.m_305540_()) {
                pGuiGraphics.m_306951_(itemstack, i, j, j1);
            } else {
    ...
    protected void m_305068_(int p_310652_, int p_312119_, boolean p_310240_) {
        this.minecraft.gameMode.m_307403_(p_310652_, p_312119_, p_310240_);
    }
