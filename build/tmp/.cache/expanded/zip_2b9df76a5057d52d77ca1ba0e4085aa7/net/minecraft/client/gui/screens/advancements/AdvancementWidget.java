...
public class AdvancementWidget {
    ...
    public AdvancementWidget(AdvancementTab pTab, Minecraft pMinecraft, AdvancementNode pAdvancementNode, DisplayInfo pDisplay) {
        ...
        this.description = Language.getInstance()
            .getVisualOrder(this.findOptimalLines(ComponentUtils.mergeStyles(pDisplay.getDescription().copy(), Style.EMPTY.withColor(pDisplay.m_306629_().m_305069_())), l));
    ...
    public void draw(GuiGraphics pGuiGraphics, int pX, int pY) {
        if (!this.display.isHidden() || this.progress != null && this.progress.isDone()) {
            ...
            pGuiGraphics.blitSprite(advancementwidgettype.frameSprite(this.display.m_306629_()), pX + this.x + 3, pY + this.y, 26, 26);
    ...
    public void drawHover(GuiGraphics pGuiGraphics, int pX, int pY, float pFade, int pWidth, int pHeight) {
        ...
        pGuiGraphics.blitSprite(advancementwidgettype2.frameSprite(this.display.m_306629_()), pX + this.x + 3, pY + this.y, 26, 26);
        if (flag) {
