...
public abstract class AbstractContainerWidget extends AbstractWidget implements ContainerEventHandler {
    @Nullable
    private GuiEventListener f_303406_;
    private boolean f_302865_;
    ...
    public final boolean isDragging() {
        return this.f_302865_;
    }

    @Override
    public final void setDragging(boolean p_311596_) {
        this.f_302865_ = p_311596_;
    }

    @Nullable
    @Override
    public GuiEventListener getFocused() {
        return this.f_303406_;
    }

    @Override
    public void setFocused(@Nullable GuiEventListener p_312828_) {
        if (this.f_303406_ != null) {
            this.f_303406_.setFocused(false);
        }
