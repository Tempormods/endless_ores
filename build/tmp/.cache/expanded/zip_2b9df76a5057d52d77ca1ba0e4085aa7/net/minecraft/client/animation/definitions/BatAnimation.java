...
public class BatAnimation {
    public static final AnimationDefinition f_302981_ = AnimationDefinition.Builder.withLength(0.5F)
        .looping()
        .addAnimation(
            "head",
        ...
        .build();
    public static final AnimationDefinition f_302773_ = AnimationDefinition.Builder.withLength(0.5F)
        .looping()
        .addAnimation(
            "head",
            new AnimationChannel(
