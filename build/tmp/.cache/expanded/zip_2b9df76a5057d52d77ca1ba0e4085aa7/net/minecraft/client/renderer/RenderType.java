...
public abstract class RenderType extends RenderStateShard {
    ...
    public static RenderType m_305574_(ResourceLocation p_311465_) {
        return ENTITY_TRANSLUCENT_EMISSIVE.apply(p_311465_, false);
    }

    public static RenderType m_305520_(ResourceLocation p_311543_, float p_312161_, float p_310801_) {
        return create(
            "breeze_wind",
            DefaultVertexFormat.NEW_ENTITY,
            VertexFormat.Mode.QUADS,
    ...
    private static RenderType.CompositeRenderType m_318882_(boolean p_332692_) {
        return create(
            "clouds",
