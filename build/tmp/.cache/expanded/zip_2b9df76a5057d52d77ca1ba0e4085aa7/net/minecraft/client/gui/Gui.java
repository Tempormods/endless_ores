...
public class Gui {
    ...
    public Gui(Minecraft p_330021_) {
        ...
        LayeredDraw layereddraw = new LayeredDraw()
            ...
            .m_322513_(this::renderCrosshair)
            .m_322513_(this::m_319215_)
            .m_322513_(this::m_324707_)
            .m_322513_(this::renderEffects)
            .m_322513_((p_325313_, p_325314_) -> this.bossOverlay.render(p_325313_));
        LayeredDraw layereddraw1 = new LayeredDraw()
            .m_322513_(this::renderDemoOverlay)
            .m_322513_((p_325315_, p_325316_) -> {
            ...
            .m_322513_((p_325317_, p_325318_) -> this.subtitleOverlay.render(p_325317_));
        this.f_316662_
            .m_323151_(layereddraw, () -> !p_330021_.options.hideGui)
            .m_322513_(this::m_322680_)
            .m_323151_(layereddraw1, () -> !p_330021_.options.hideGui);
    }
    ...
    public void render(GuiGraphics pGuiGraphics, float pPartialTick) {
        ...
        this.f_316662_.m_322951_(pGuiGraphics, pPartialTick);
        RenderSystem.disableDepthTest();
    }

    private void m_318727_(GuiGraphics p_333627_, float p_328583_) {
    ...
    private void m_322680_(GuiGraphics p_329087_, float p_327844_) {
    ...
    private void m_324281_(GuiGraphics p_330258_, float p_333446_) {
    ...
    private void m_320668_(GuiGraphics p_331218_, float p_335033_) {
    ...
    private void m_322096_(GuiGraphics p_329202_, float p_328014_) {
    ...
    private void m_323286_(GuiGraphics p_332744_, float p_331037_) {
    ...
    private void m_320053_(GuiGraphics p_330031_, float p_334685_) {
        Scoreboard scoreboard = this.minecraft.level.getScoreboard();
    ...
    private void renderCrosshair(GuiGraphics pGuiGraphics, float p_331279_) {
        ...
        if (options.getCameraType().isFirstPerson()) {
            if (this.minecraft.gameMode.getPlayerMode() != GameType.SPECTATOR || this.canRenderCrosshairForSpectator(this.minecraft.hitResult)) {
                ...
                if (this.debugOverlay.showDebugScreen() && !this.minecraft.player.isReducedDebugInfo() && !options.reducedDebugInfo().get()) {
                    ...
                    int i = 15;
                    pGuiGraphics.blitSprite(CROSSHAIR_SPRITE, (pGuiGraphics.guiWidth() - 15) / 2, (pGuiGraphics.guiHeight() - 15) / 2, 15, 15);
    ...
    private void renderEffects(GuiGraphics pGuiGraphics, float p_334386_) {
            ...
            for (MobEffectInstance mobeffectinstance : Ordering.natural().reverse().sortedCopy(collection)) {
                ...
                if (mobeffectinstance.showIcon()) {
                    ...
                    list.add(() -> {
                        ...
                        pGuiGraphics.blit(l1 + 3, i1 + 3, 0, 18, 18, textureatlassprite);
    ...
    private void m_319215_(GuiGraphics p_333625_, float p_329779_) {
        if (this.minecraft.gameMode.getPlayerMode() == GameType.SPECTATOR) {
            this.spectatorGui.renderHotbar(p_333625_);
        } else {
            this.m_324469_(p_333625_, p_329779_);
        }
    ...
    private void m_324469_(GuiGraphics p_332738_, float p_329377_) {
    ...
    private void m_324707_(GuiGraphics p_335340_, float p_332198_) {
    ...
    public void renderSelectedItemName(GuiGraphics pGuiGraphics, int yShift) {
        ...
        if (this.toolHighlightTimer > 0 && !this.lastToolHighlight.isEmpty()) {
            MutableComponent mutablecomponent = Component.empty().append(this.lastToolHighlight.getHoverName()).withStyle(this.lastToolHighlight.getRarity().m_321696_());
            if (this.lastToolHighlight.m_319951_(DataComponents.f_316016_)) {
    ...
    private void renderDemoOverlay(GuiGraphics pGuiGraphics, float p_335136_) {
        if (this.minecraft.isDemo()) {
            ...
            if (this.minecraft.level.getGameTime() >= 120500L) {
                ...
                component = Component.translatable(
                    "demo.remainingTime",
                    StringUtil.formatTickDuration((int)(120500L - this.minecraft.level.getGameTime()), this.minecraft.level.m_304826_().m_306179_())
                );
            }

            int i = this.getFont().width(component);
            pGuiGraphics.drawString(this.getFont(), component, pGuiGraphics.guiWidth() - i - 10, 5, 16777215);
            this.minecraft.getProfiler().pop();
        }
    }
    ...
    private void displayScoreboardSidebar(GuiGraphics pGuiGraphics, Objective pObjective) {
        ...
        NumberFormat numberformat = pObjective.m_305063_(StyledFormat.f_303088_);

        @OnlyIn(Dist.CLIENT)
        record DisplayEntry(Component f_302553_, Component f_303810_, int f_302793_) {
        }

        DisplayEntry[] agui$1displayentry = scoreboard.m_306706_(pObjective)
            .stream()
            .filter(p_308174_ -> !p_308174_.m_307477_())
            .sorted(f_302813_)
            .limit(15L)
            .map(p_308178_ -> {
                PlayerTeam playerteam = scoreboard.getPlayersTeam(p_308178_.f_302847_());
                Component component1 = p_308178_.m_305530_();
        ...
        for (DisplayEntry gui$1displayentry : agui$1displayentry) {
            j = Math.max(j, this.getFont().width(gui$1displayentry.f_302553_) + (gui$1displayentry.f_302793_ > 0 ? k + gui$1displayentry.f_302793_ : 0));
        }
        ...
        pGuiGraphics.drawManaged(() -> {
            ...
            for (int j3 = 0; j3 < i1; j3++) {
                ...
                int k3 = k1 - (i1 - j3) * 9;
                pGuiGraphics.drawString(this.getFont(), gui$1displayentry1.f_302553_, i2, k3, -1, false);
                pGuiGraphics.drawString(this.getFont(), gui$1displayentry1.f_303810_, j2 - gui$1displayentry1.f_302793_, k3, -1, false);
            }
        });
    }
    ...
    private void renderPlayerHealth(GuiGraphics pGuiGraphics) {
        ...
        if (player != null) {
            ...
            m_232354_(pGuiGraphics, player, j1, l1, i2, l);
            ...
            if (l2 == 0) {
                ...
                this.m_320133_(pGuiGraphics, player, j1, i1);
                j2 -= 10;
            }
    ...
    private static void m_232354_(GuiGraphics p_332897_, Player p_332999_, int p_330861_, int p_331335_, int p_329919_, int p_329454_) {
    ...
    private void m_320133_(GuiGraphics p_330960_, Player p_328268_, int p_331606_, int p_330339_) {
    ...
    public void renderSavingIndicator(GuiGraphics pGuiGraphics, float p_334882_) {
