...
public class EditGameRulesScreen extends Screen {
    private static final Component f_316287_ = Component.translatable("editGamerule.title");
    private static final int f_315007_ = 8;
    final HeaderAndFooterLayout f_316237_ = new HeaderAndFooterLayout(this);
    ...
    @Nullable
    private EditGameRulesScreen.RuleList f_313989_;
    @Nullable
    ...
    @Override
    protected void init() {
        this.f_316237_.m_324480_(f_316287_, this.font);
        this.f_313989_ = this.f_316237_.addToContents(new EditGameRulesScreen.RuleList(this.gameRules));
        LinearLayout linearlayout = this.f_316237_.addToFooter(LinearLayout.horizontal().spacing(8));
        ...
        this.f_316237_.visitWidgets(p_325432_ -> {
    ...
    protected void repositionElements() {
        this.f_316237_.arrangeElements();
        if (this.f_313989_ != null) {
            this.f_313989_.m_319425_(this.width, this.f_316237_);
        }
    }
    ...
    public class RuleList extends ContainerObjectSelectionList<EditGameRulesScreen.RuleEntry> {
        private static final int f_315566_ = 24;

        public RuleList(final GameRules pGameRules) {
            super(
                Minecraft.getInstance(),
                EditGameRulesScreen.this.width,
                EditGameRulesScreen.this.f_316237_.m_319781_(),
                EditGameRulesScreen.this.f_316237_.getHeaderHeight(),
                24
            );
