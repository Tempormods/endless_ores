...
public class UpdateOneTwentyOneDamageTypeTagsProvider extends TagsProvider<DamageType> {
    ...
    protected void addTags(HolderLookup.Provider p_312660_) {
        this.tag(DamageTypeTags.f_302961_).add(DamageTypes.ARROW, DamageTypes.TRIDENT);
        this.tag(DamageTypeTags.IS_PROJECTILE).add(DamageTypes.f_314576_);
        this.tag(DamageTypeTags.ALWAYS_KILLS_ARMOR_STANDS).add(DamageTypes.f_314576_);
    }
}