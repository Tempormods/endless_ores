...
public class VanillaChestLoot implements LootTableSubProvider {
    ...
    public void generate(HolderLookup.Provider p_329114_, BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_250931_) {
                            ...
                            LootItem.lootTableItem(Items.MAP)
                                ...
                                .apply(
                                    ExplorationMapFunction.makeExplorationMap()
                                        ...
                                        .setMapDecoration(MapDecorationTypes.f_316825_)
                                        .setZoom((byte)1)
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.f_303642_).setWeight(5))
        ...
        p_250931_.accept(BuiltInLootTables.f_303517_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_315207_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_315354_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_314271_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_315697_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_315306_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_315822_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_315133_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_303341_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_302226_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_303376_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_302884_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_302208_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_303584_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_302850_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_303173_, LootTable.lootTable());
        p_250931_.accept(BuiltInLootTables.f_302648_, LootTable.lootTable());
        m_304740_(p_250931_);
    }

    public static void m_304740_(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_312949_) {
        p_312949_.accept(BuiltInLootTables.f_303815_, LootTable.lootTable());
        p_312949_.accept(BuiltInLootTables.f_303325_, LootTable.lootTable());
        p_312949_.accept(BuiltInLootTables.f_316043_, LootTable.lootTable());
        p_312949_.accept(BuiltInLootTables.f_316831_, LootTable.lootTable());
        p_312949_.accept(BuiltInLootTables.f_315958_, LootTable.lootTable());
    }
