...
public class VanillaItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider p_255639_) {
        ...
        this.tag(ItemTags.f_316264_).add(Items.TROPICAL_FISH_BUCKET);
        ...
        this.tag(ItemTags.f_317094_).add(Items.LEATHER_BOOTS, Items.CHAINMAIL_BOOTS, Items.GOLDEN_BOOTS, Items.IRON_BOOTS, Items.DIAMOND_BOOTS, Items.NETHERITE_BOOTS);
        this.tag(ItemTags.f_316741_).add(Items.LEATHER_LEGGINGS, Items.CHAINMAIL_LEGGINGS, Items.GOLDEN_LEGGINGS, Items.IRON_LEGGINGS, Items.DIAMOND_LEGGINGS, Items.NETHERITE_LEGGINGS);
        this.tag(ItemTags.f_314764_).add(Items.LEATHER_CHESTPLATE, Items.CHAINMAIL_CHESTPLATE, Items.GOLDEN_CHESTPLATE, Items.IRON_CHESTPLATE, Items.DIAMOND_CHESTPLATE, Items.NETHERITE_CHESTPLATE);
        this.tag(ItemTags.f_316976_)
        ...
        this.tag(ItemTags.TRIMMABLE_ARMOR)
            .addTag(ItemTags.f_317094_)
            .addTag(ItemTags.f_316741_)
            .addTag(ItemTags.f_314764_)
            .addTag(ItemTags.f_316976_);
        ...
        this.tag(ItemTags.f_314991_).addTag(ItemTags.f_317094_);
        this.tag(ItemTags.f_314045_).addTag(ItemTags.f_316741_);
        this.tag(ItemTags.f_315053_).addTag(ItemTags.f_314764_);
        this.tag(ItemTags.f_316014_).addTag(ItemTags.f_316976_);
        this.tag(ItemTags.f_317078_)
            .addTag(ItemTags.f_314991_)
            .addTag(ItemTags.f_314045_)
            .addTag(ItemTags.f_315053_)
            .addTag(ItemTags.f_316014_);
        this.tag(ItemTags.f_316261_).addTag(ItemTags.SWORDS);
        this.tag(ItemTags.f_314461_).addTag(ItemTags.f_316261_);
        this.tag(ItemTags.f_314502_).addTag(ItemTags.SWORDS).addTag(ItemTags.AXES);
        this.tag(ItemTags.f_316107_).addTag(ItemTags.f_314502_);
        this.tag(ItemTags.f_314984_)
            .addTag(ItemTags.AXES)
            .addTag(ItemTags.PICKAXES)
            .addTag(ItemTags.SHOVELS)
            .addTag(ItemTags.HOES)
            .add(Items.SHEARS);
        this.tag(ItemTags.f_314570_)
            .addTag(ItemTags.AXES)
            .addTag(ItemTags.PICKAXES)
            .addTag(ItemTags.SHOVELS)
            .addTag(ItemTags.HOES);
        this.tag(ItemTags.f_313995_).add(Items.FISHING_ROD);
        this.tag(ItemTags.f_316827_).add(Items.TRIDENT);
        this.tag(ItemTags.f_314809_)
            .addTag(ItemTags.f_317094_)
            .addTag(ItemTags.f_316741_)
            .addTag(ItemTags.f_314764_)
            .addTag(ItemTags.f_316976_)
        ...
        this.tag(ItemTags.f_317054_).add(Items.BOW);
        this.tag(ItemTags.f_317097_)
            .addTag(ItemTags.f_317094_)
            .addTag(ItemTags.f_316741_)
            .addTag(ItemTags.f_314764_)
            .addTag(ItemTags.f_316976_)
            .add(Items.ELYTRA)
            .addTag(ItemTags.f_317150_)
            .add(Items.CARVED_PUMPKIN);
        this.tag(ItemTags.f_317092_).add(Items.CROSSBOW);
        this.tag(ItemTags.f_314986_).addTag(ItemTags.f_314809_).add(Items.COMPASS).add(Items.CARVED_PUMPKIN).addTag(ItemTags.f_317150_);
        this.tag(ItemTags.f_314020_).add(Items.LEATHER_HELMET, Items.LEATHER_CHESTPLATE, Items.LEATHER_LEGGINGS, Items.LEATHER_BOOTS, Items.LEATHER_HORSE_ARMOR, Items.f_314362_);
        this.tag(ItemTags.f_314741_)
            .add(
                Items.BEEF,
                Items.CHICKEN,
                Items.COOKED_BEEF,
        ...
        this.tag(ItemTags.f_316425_).addTag(ItemTags.f_314741_);
        this.tag(ItemTags.f_316292_).add(Items.COD, Items.SALMON);
        this.tag(ItemTags.f_314035_).add(Items.COD, Items.SALMON);
        this.tag(ItemTags.f_316234_)
        ...
        this.tag(ItemTags.f_314143_).add(Items.GOLDEN_CARROT, Items.GOLDEN_APPLE, Items.ENCHANTED_GOLDEN_APPLE);
        this.tag(ItemTags.f_315451_).add(Items.CACTUS);
        this.tag(ItemTags.f_316663_).add(Items.SPIDER_EYE);
        this.tag(ItemTags.f_316276_).addTag(ItemTags.FLOWERS);
        this.tag(ItemTags.f_316289_).add(Items.WHEAT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.BEETROOT_SEEDS, Items.TORCHFLOWER_SEEDS, Items.PITCHER_POD);
        this.tag(ItemTags.f_314631_).add(Items.SLIME_BALL);
        this.tag(ItemTags.f_315349_).add(Items.CRIMSON_FUNGUS);
        this.tag(ItemTags.f_314714_).add(Items.WHEAT, Items.HAY_BLOCK);
        this.tag(ItemTags.f_315676_).add(Items.HAY_BLOCK);
        this.tag(ItemTags.f_316653_).add(Items.BAMBOO);
        this.tag(ItemTags.f_314144_).add(Items.CARROT, Items.POTATO, Items.BEETROOT);
        this.tag(ItemTags.f_314532_).add(Items.CARROT, Items.GOLDEN_CARROT, Items.DANDELION);
        this.tag(ItemTags.f_314410_).add(Items.WARPED_FUNGUS);
        this.tag(ItemTags.f_316811_).addTag(ItemTags.f_314410_).add(Items.WARPED_FUNGUS_ON_A_STICK);
        this.tag(ItemTags.f_314831_).add(Items.SEAGRASS);
        this.tag(ItemTags.f_316572_).add(Items.WHEAT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.BEETROOT_SEEDS, Items.TORCHFLOWER_SEEDS, Items.PITCHER_POD);
        this.tag(ItemTags.f_315269_).add(Items.COOKIE);
        this.tag(ItemTags.f_315238_).add(Items.WHEAT);
        this.tag(ItemTags.f_314146_).add(Items.WHEAT);
        this.tag(ItemTags.f_316983_).add(Items.WHEAT);
    }
}