...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(Blocks.f_303635_, noDrop());
        this.add(Blocks.f_303609_, noDrop());
        this.add(Blocks.f_302627_, noDrop());
        this.add(Blocks.f_302247_, noDrop());
        this.add(Blocks.f_302395_, noDrop());
        this.add(Blocks.f_302272_, noDrop());
        this.add(Blocks.f_303663_, noDrop());
        this.add(Blocks.f_303101_, noDrop());
        ...
        this.add(Blocks.f_303044_, noDrop());
        this.add(Blocks.f_302743_, noDrop());
        this.add(Blocks.f_303426_, noDrop());
        this.add(Blocks.f_302213_, noDrop());
        this.add(Blocks.f_303652_, noDrop());
        this.add(Blocks.f_302449_, noDrop());
        this.add(Blocks.f_302818_, noDrop());
        this.add(Blocks.f_303547_, noDrop());
        this.add(Blocks.f_303371_, noDrop());
        this.add(Blocks.f_303237_, noDrop());
        this.add(Blocks.f_302382_, noDrop());
        this.add(Blocks.f_303571_, noDrop());
        this.add(Blocks.f_303545_, noDrop());
        this.add(Blocks.f_302914_, noDrop());
        this.add(Blocks.f_302689_, noDrop());
        this.add(Blocks.f_303448_, noDrop());
        this.add(Blocks.f_302507_, noDrop());
        this.add(Blocks.f_303811_, noDrop());
        this.add(Blocks.f_303363_, noDrop());
        this.add(Blocks.f_302554_, noDrop());
        this.add(Blocks.f_302612_, noDrop());
        this.add(Blocks.f_303118_, noDrop());
        this.add(Blocks.f_303215_, noDrop());
        this.add(Blocks.f_302995_, noDrop());
        this.add(Blocks.f_303236_, noDrop());
        this.add(Blocks.f_303549_, noDrop());
        this.add(Blocks.f_303013_, noDrop());
        this.add(Blocks.f_303410_, noDrop());
        this.add(Blocks.f_302872_, noDrop());
        this.add(Blocks.f_303373_, noDrop());
        this.add(Blocks.f_302358_, noDrop());
        this.add(Blocks.f_303271_, noDrop());
        this.add(Blocks.f_303674_, noDrop());
        this.add(Blocks.f_302668_, noDrop());
        this.add(Blocks.f_302439_, noDrop());
        this.add(Blocks.f_303797_, noDrop());
        this.add(Blocks.f_302556_, noDrop());
        this.add(Blocks.f_302347_, noDrop());
        this.add(Blocks.f_314894_, noDrop());
        ...
        this.add(Blocks.f_302565_, noDrop());
        this.add(Blocks.f_303201_, noDrop());
        this.add(Blocks.f_303010_, noDrop());
        this.add(Blocks.f_303016_, noDrop());
        this.add(Blocks.f_302634_, noDrop());
        this.add(Blocks.f_303222_, noDrop());
        this.add(Blocks.f_302853_, noDrop());
        this.add(Blocks.f_303692_, noDrop());
                                    ...
                                    LootItem.lootTableItem(p_325870_)
                                        .apply(
                                            CopyComponentsFunction.m_324952_(CopyComponentsFunction.Source.BLOCK_ENTITY)
                                                .m_323761_(DataComponents.f_315901_)
                                                .m_323761_(DataComponents.f_315959_)
                ...
                LootTable.lootTable()
                    ...
                    .withPool(
                        LootPool.lootPool()
                            ...
                            .add(LootItem.lootTableItem(Items.CARROT).apply(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.f_316753_, 0.5714286F, 3)))
                    )
            )
        );
                ...
                LootTable.lootTable()
                    ...
                    .withPool(
                        LootPool.lootPool()
                            ...
                            .add(LootItem.lootTableItem(Items.POTATO).apply(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.f_316753_, 0.5714286F, 3)))
                    )
                    .withPool(
                        LootPool.lootPool()
                            .when(lootitemcondition$builder4)
                    ...
                    LootTable.lootTable()
                        .withPool(
                            LootPool.lootPool()
                                ...
                                .apply(ApplyBonusCount.addUniformBonusCount(Enchantments.f_316753_))
                        )
                        .withPool(
                            LootPool.lootPool()
                                .when(
            ...
            p_325866_ -> createSilkTouchDispatchTable(
                    ...
                    (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                        ...
                        LootItem.lootTableItem(Items.GOLD_NUGGET)
                            ...
                            .apply(ApplyBonusCount.addOreBonusCount(Enchantments.f_316753_))
                    )
                )
        );
        ...
        this.add(Blocks.TALL_GRASS, p_308499_ -> this.createDoublePlantWithSeedDrops(p_308499_, Blocks.f_303709_));
        ...
        this.add(Blocks.f_303709_, p_249038_ -> this.createGrassDrops(p_249038_));
        this.add(
            Blocks.GLOWSTONE,
                            ...
                            LootPool.lootPool()
                                ...
                                .add(
                                    LootItem.lootTableItem(Items.NETHER_WART)
                                        ...
                                        .apply(
                                            ApplyBonusCount.addUniformBonusCount(Enchantments.f_316753_)
                                                .when(
                                                    LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_325867_)
                                                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3))
                                                )
            ...
            p_325872_ -> createSilkTouchDispatchTable(
                    ...
                    this.applyExplosionCondition(
                        ...
                        LootItem.lootTableItem(Items.FLINT)
                            .when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.f_316753_, 0.1F, 0.14285715F, 0.25F, 1.0F))
                        ...
                        DynamicLoot.dynamicEntry(DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID)
                            ...
                            .otherwise(
                                LootItem.lootTableItem(p_277929_)
                                    .apply(CopyComponentsFunction.m_324952_(CopyComponentsFunction.Source.BLOCK_ENTITY).m_323761_(DataComponents.f_316536_))
                            )
                    )
            );
    }
