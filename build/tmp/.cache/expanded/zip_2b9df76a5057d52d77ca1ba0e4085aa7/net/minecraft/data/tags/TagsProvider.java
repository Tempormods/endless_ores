...
public abstract class TagsProvider<T> implements DataProvider {
        ...
        return this.createContentsProvider()
            ...
            .thenCompose(
                p_325926_ -> {
                    ...
                    Predicate<ResourceLocation> predicate = p_255496_ -> registrylookup.m_254926_(ResourceKey.create(this.registryKey, p_255496_)).isPresent();
    ...
    public static class TagAppender<T> implements net.minecraftforge.common.extensions.IForgeTagAppender<T> {
        ...
        public final TagsProvider.TagAppender<T> m_320335_(List<ResourceKey<T>> p_328546_) {
