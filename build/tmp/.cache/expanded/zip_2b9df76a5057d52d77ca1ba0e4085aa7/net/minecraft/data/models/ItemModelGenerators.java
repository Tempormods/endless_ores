...
public class ItemModelGenerators {
    ...
    private static final List<ItemModelGenerators.TrimModelData> GENERATED_TRIM_MODELS = List.of(
        ...
        new ItemModelGenerators.TrimModelData("iron", 0.2F, Map.of(ArmorMaterials.f_40455_, "iron_darker")),
        new ItemModelGenerators.TrimModelData("netherite", 0.3F, Map.of(ArmorMaterials.f_40459_, "netherite_darker")),
        new ItemModelGenerators.TrimModelData("redstone", 0.4F, Map.of()),
        new ItemModelGenerators.TrimModelData("copper", 0.5F, Map.of()),
        new ItemModelGenerators.TrimModelData("gold", 0.6F, Map.of(ArmorMaterials.f_40456_, "gold_darker")),
        new ItemModelGenerators.TrimModelData("emerald", 0.7F, Map.of()),
        new ItemModelGenerators.TrimModelData("diamond", 0.8F, Map.of(ArmorMaterials.f_40457_, "diamond_darker")),
    ...
    private void m_321912_(Item p_328925_) {
    ...
    private JsonObject generateBaseArmorTrimTemplate(ResourceLocation pModelLocation, Map<TextureSlot, ResourceLocation> p_267324_, Holder<ArmorMaterial> p_331857_) {
        ...
        for (ItemModelGenerators.TrimModelData itemmodelgenerators$trimmodeldata : GENERATED_TRIM_MODELS) {
            ...
            jsonobject1.addProperty("model", this.getItemModelForTrimMaterial(pModelLocation, itemmodelgenerators$trimmodeldata.name(p_331857_)).toString());
    ...
    private void generateArmorTrims(ArmorItem pArmorItem) {
        if (pArmorItem.getType().m_321718_()) {
            ...
            if (pArmorItem.getMaterial().m_318604_(ArmorMaterials.f_40453_)) {
    ...
    public void run() {
        ...
        this.generateFlatItem(Items.f_314244_, ModelTemplates.FLAT_ITEM);
        ...
        this.generateFlatItem(Items.f_315544_, ModelTemplates.FLAT_ITEM);
        ...
        this.generateFlatItem(Items.f_316582_, ModelTemplates.FLAT_ITEM);
        ...
        this.generateFlatItem(Items.f_316480_, ModelTemplates.FLAT_ITEM);
        ...
        this.generateFlatItem(Items.f_315681_, ModelTemplates.FLAT_ITEM);
        ...
        this.generateFlatItem(Items.f_315945_, ModelTemplates.FLAT_ITEM);
        this.generateFlatItem(Items.f_314862_, ModelTemplates.f_315587_);
        this.m_321912_(Items.f_314362_);
        ...
        this.generateFlatItem(Items.f_316167_, ModelTemplates.FLAT_ITEM);
        this.generateFlatItem(Items.f_314806_, ModelTemplates.FLAT_ITEM);
        ...
        this.generateFlatItem(Items.f_314824_, ModelTemplates.FLAT_ITEM);
        this.generateFlatItem(Items.FRIEND_POTTERY_SHERD, ModelTemplates.FLAT_ITEM);
        this.generateFlatItem(Items.f_316059_, ModelTemplates.FLAT_ITEM);
        ...
        this.generateFlatItem(Items.f_315489_, ModelTemplates.FLAT_ITEM);
        ...
        this.generateFlatItem(Items.f_302928_, ModelTemplates.FLAT_ITEM);
        this.generateFlatItem(Items.f_314905_, ModelTemplates.FLAT_ITEM);
        this.generateFlatItem(Items.f_316650_, ModelTemplates.FLAT_ITEM);
    }
