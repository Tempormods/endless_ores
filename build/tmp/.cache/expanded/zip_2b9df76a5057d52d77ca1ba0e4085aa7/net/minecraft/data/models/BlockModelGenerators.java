...
public class BlockModelGenerators {
    ...
    final Map<Block, TexturedModel> texturedModels = ImmutableMap.<Block, TexturedModel>builder()
        ...
        .put(Blocks.f_302382_, TexturedModel.COLUMN_WITH_WALL.get(Blocks.f_302382_))
        .put(Blocks.f_302743_, TexturedModel.COLUMN_WITH_WALL.get(Blocks.f_302743_))
        .build();
    ...
    private void m_306694_(Block p_311336_, Block p_309682_) {
        ResourceLocation resourcelocation = ModelTemplates.DOOR_BOTTOM_LEFT.m_305275_(p_311336_);
        ResourceLocation resourcelocation1 = ModelTemplates.DOOR_BOTTOM_LEFT_OPEN.m_305275_(p_311336_);
        ResourceLocation resourcelocation2 = ModelTemplates.DOOR_BOTTOM_RIGHT.m_305275_(p_311336_);
        ResourceLocation resourcelocation3 = ModelTemplates.DOOR_BOTTOM_RIGHT_OPEN.m_305275_(p_311336_);
        ResourceLocation resourcelocation4 = ModelTemplates.DOOR_TOP_LEFT.m_305275_(p_311336_);
        ResourceLocation resourcelocation5 = ModelTemplates.DOOR_TOP_LEFT_OPEN.m_305275_(p_311336_);
        ResourceLocation resourcelocation6 = ModelTemplates.DOOR_TOP_RIGHT.m_305275_(p_311336_);
        ResourceLocation resourcelocation7 = ModelTemplates.DOOR_TOP_RIGHT_OPEN.m_305275_(p_311336_);
    ...
    private void m_306005_(Block p_312446_, Block p_310485_) {
        ResourceLocation resourcelocation = ModelTemplates.TRAPDOOR_TOP.m_305275_(p_312446_);
        ResourceLocation resourcelocation1 = ModelTemplates.TRAPDOOR_BOTTOM.m_305275_(p_312446_);
        ResourceLocation resourcelocation2 = ModelTemplates.TRAPDOOR_OPEN.m_305275_(p_312446_);
    ...
    private void m_305326_() {
        ResourceLocation resourcelocation = ModelLocationUtils.getModelLocation(Blocks.f_303044_);
        ResourceLocation resourcelocation1 = ModelLocationUtils.getModelLocation(Blocks.f_303044_, "_triggered");
        ResourceLocation resourcelocation2 = ModelLocationUtils.getModelLocation(Blocks.f_303044_, "_crafting");
        ResourceLocation resourcelocation3 = ModelLocationUtils.getModelLocation(Blocks.f_303044_, "_crafting_triggered");
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(Blocks.f_303044_)
                    ...
                    .with(
                        PropertyDispatch.properties(BlockStateProperties.TRIGGERED, CrafterBlock.f_302342_)
    ...
    private void m_306304_(Block p_311077_) {
        ...
        this.blockStateOutput.accept(this.m_305465_(p_311077_, resourcelocation, resourcelocation2, resourcelocation1, resourcelocation3));
    }

    private BlockStateGenerator m_305465_(
    ...
    private void m_306319_(Block p_310234_, Block p_312487_) {
        ...
        this.blockStateOutput.accept(this.m_305465_(p_312487_, resourcelocation, resourcelocation2, resourcelocation1, resourcelocation3));
    }
    ...
    private void m_307870_() {
        Block block = Blocks.f_302964_;
        TextureMapping texturemapping = TextureMapping.m_305982_(block, "_side_inactive", "_top_inactive");
        TextureMapping texturemapping1 = TextureMapping.m_305982_(block, "_side_active", "_top_active");
        TextureMapping texturemapping2 = TextureMapping.m_305982_(block, "_side_active", "_top_ejecting_reward");
        TextureMapping texturemapping3 = TextureMapping.m_305982_(block, "_side_inactive_ominous", "_top_inactive_ominous");
        TextureMapping texturemapping4 = TextureMapping.m_305982_(block, "_side_active_ominous", "_top_active_ominous");
        TextureMapping texturemapping5 = TextureMapping.m_305982_(block, "_side_active_ominous", "_top_ejecting_reward_ominous");
        ResourceLocation resourcelocation = ModelTemplates.f_302568_.create(block, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation1 = ModelTemplates.f_302568_.createWithSuffix(block, "_active", texturemapping1, this.modelOutput);
        ResourceLocation resourcelocation2 = ModelTemplates.f_302568_.createWithSuffix(block, "_ejecting_reward", texturemapping2, this.modelOutput);
        ResourceLocation resourcelocation3 = ModelTemplates.f_302568_.createWithSuffix(block, "_inactive_ominous", texturemapping3, this.modelOutput);
        ResourceLocation resourcelocation4 = ModelTemplates.f_302568_.createWithSuffix(block, "_active_ominous", texturemapping4, this.modelOutput);
        ResourceLocation resourcelocation5 = ModelTemplates.f_302568_.createWithSuffix(block, "_ejecting_reward_ominous", texturemapping5, this.modelOutput);
        this.delegateItemModel(block, resourcelocation);
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(block)
                    .with(
                        PropertyDispatch.properties(BlockStateProperties.f_302708_, BlockStateProperties.f_314881_)
                            .generate(
                                (p_325891_, p_325892_) -> {
    ...
    private void m_320317_() {
        Block block = Blocks.f_316985_;
        TextureMapping texturemapping = TextureMapping.m_323503_(block, "_front_off", "_side_off", "_top", "_bottom");
        TextureMapping texturemapping1 = TextureMapping.m_323503_(block, "_front_on", "_side_on", "_top", "_bottom");
        TextureMapping texturemapping2 = TextureMapping.m_323503_(block, "_front_ejecting", "_side_on", "_top", "_bottom");
        TextureMapping texturemapping3 = TextureMapping.m_323503_(block, "_front_ejecting", "_side_on", "_top_ejecting", "_bottom");
        ResourceLocation resourcelocation = ModelTemplates.f_315019_.create(block, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation1 = ModelTemplates.f_315019_.createWithSuffix(block, "_active", texturemapping1, this.modelOutput);
        ResourceLocation resourcelocation2 = ModelTemplates.f_315019_.createWithSuffix(block, "_unlocking", texturemapping2, this.modelOutput);
        ResourceLocation resourcelocation3 = ModelTemplates.f_315019_.createWithSuffix(block, "_ejecting_reward", texturemapping3, this.modelOutput);
        TextureMapping texturemapping4 = TextureMapping.m_323503_(block, "_front_off_ominous", "_side_off_ominous", "_top_ominous", "_bottom_ominous");
        TextureMapping texturemapping5 = TextureMapping.m_323503_(block, "_front_on_ominous", "_side_on_ominous", "_top_ominous", "_bottom_ominous");
        TextureMapping texturemapping6 = TextureMapping.m_323503_(block, "_front_ejecting_ominous", "_side_on_ominous", "_top_ominous", "_bottom_ominous");
        TextureMapping texturemapping7 = TextureMapping.m_323503_(
            block, "_front_ejecting_ominous", "_side_on_ominous", "_top_ejecting_ominous", "_bottom_ominous"
        );
        ResourceLocation resourcelocation4 = ModelTemplates.f_315019_.createWithSuffix(block, "_ominous", texturemapping4, this.modelOutput);
        ResourceLocation resourcelocation5 = ModelTemplates.f_315019_.createWithSuffix(block, "_active_ominous", texturemapping5, this.modelOutput);
        ResourceLocation resourcelocation6 = ModelTemplates.f_315019_.createWithSuffix(block, "_unlocking_ominous", texturemapping6, this.modelOutput);
        ResourceLocation resourcelocation7 = ModelTemplates.f_315019_.createWithSuffix(block, "_ejecting_reward_ominous", texturemapping7, this.modelOutput);
        this.delegateItemModel(block, resourcelocation);
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(block)
                    .with(createHorizontalFacingDispatch())
                    .with(PropertyDispatch.properties(VaultBlock.f_314947_, VaultBlock.f_317007_).generate((p_325883_, p_325884_) -> {
    ...
    public void run() {
        ...
        this.family(Blocks.CUT_COPPER)
            ...
            .m_306189_(Blocks.CUT_COPPER, Blocks.WAXED_CUT_COPPER)
            .m_306189_(Blocks.f_302689_, Blocks.f_303363_)
        ...
        this.family(Blocks.EXPOSED_CUT_COPPER)
            ...
            .m_306189_(Blocks.EXPOSED_CUT_COPPER, Blocks.WAXED_EXPOSED_CUT_COPPER)
            .m_306189_(Blocks.f_303448_, Blocks.f_302554_)
        ...
        this.family(Blocks.WEATHERED_CUT_COPPER)
            ...
            .m_306189_(Blocks.WEATHERED_CUT_COPPER, Blocks.WAXED_WEATHERED_CUT_COPPER)
            .m_306189_(Blocks.f_302507_, Blocks.f_302612_)
        ...
        this.family(Blocks.OXIDIZED_CUT_COPPER)
            ...
            .m_306189_(Blocks.OXIDIZED_CUT_COPPER, Blocks.WAXED_OXIDIZED_CUT_COPPER)
            .m_306189_(Blocks.f_303811_, Blocks.f_303118_)
            .generateFor(BlockFamilies.WAXED_OXIDIZED_CUT_COPPER);
        this.m_306304_(Blocks.f_302358_);
        this.m_306304_(Blocks.f_303271_);
        this.m_306304_(Blocks.f_303674_);
        this.m_306304_(Blocks.f_302668_);
        this.m_306319_(Blocks.f_302358_, Blocks.f_302439_);
        this.m_306319_(Blocks.f_303271_, Blocks.f_303797_);
        this.m_306319_(Blocks.f_303674_, Blocks.f_302556_);
        this.m_306319_(Blocks.f_302668_, Blocks.f_302347_);
        ...
        this.createTrivialBlock(Blocks.SPAWNER, TexturedModel.f_302860_);
        ...
        this.createNonTemplateModelBlock(Blocks.f_314894_);
        ...
        this.createDoor(Blocks.f_302565_);
        this.createDoor(Blocks.f_303201_);
        this.createDoor(Blocks.f_303010_);
        this.createDoor(Blocks.f_303016_);
        this.m_306694_(Blocks.f_302565_, Blocks.f_302634_);
        this.m_306694_(Blocks.f_303201_, Blocks.f_303222_);
        this.m_306694_(Blocks.f_303010_, Blocks.f_302853_);
        this.m_306694_(Blocks.f_303016_, Blocks.f_303692_);
        this.createTrapdoor(Blocks.f_303635_);
        this.createTrapdoor(Blocks.f_303609_);
        this.createTrapdoor(Blocks.f_302627_);
        this.createTrapdoor(Blocks.f_302247_);
        this.m_306005_(Blocks.f_303635_, Blocks.f_302395_);
        this.m_306005_(Blocks.f_303609_, Blocks.f_302272_);
        this.m_306005_(Blocks.f_302627_, Blocks.f_303663_);
        this.m_306005_(Blocks.f_302247_, Blocks.f_303101_);
        this.createTrivialCube(Blocks.f_303215_);
        this.createTrivialCube(Blocks.f_302995_);
        this.createTrivialCube(Blocks.f_303236_);
        this.createTrivialCube(Blocks.f_303549_);
        this.copyModel(Blocks.f_303215_, Blocks.f_303013_);
        this.copyModel(Blocks.f_302995_, Blocks.f_303410_);
        this.copyModel(Blocks.f_303236_, Blocks.f_302872_);
        this.copyModel(Blocks.f_303549_, Blocks.f_303373_);
        ...
        this.createCrossBlockWithDefaultItem(Blocks.f_303709_, BlockModelGenerators.TintState.TINTED);
    ...
    class BlockFamilyProvider {
        ...
        private final Set<Block> f_303317_ = new HashSet<>();
        ...
        public BlockModelGenerators.BlockFamilyProvider m_306189_(Block p_309456_, Block p_312030_) {
        ...
        public BlockModelGenerators.BlockFamilyProvider generateFor(BlockFamily pFamily) {
            ...
            pFamily.getVariants().forEach((p_308515_, p_308516_) -> {
                if (!this.f_303317_.contains(p_308516_)) {
