...
public class TrailRuinsStructurePools {
    ...
    public static void bootstrap(BootstrapContext<StructureTemplatePool> p_331263_) {
        HolderGetter<StructureTemplatePool> holdergetter = p_331263_.m_255434_(Registries.TEMPLATE_POOL);
        Holder<StructureTemplatePool> holder = holdergetter.getOrThrow(Pools.EMPTY);
        HolderGetter<StructureProcessorList> holdergetter1 = p_331263_.m_255434_(Registries.PROCESSOR_LIST);
