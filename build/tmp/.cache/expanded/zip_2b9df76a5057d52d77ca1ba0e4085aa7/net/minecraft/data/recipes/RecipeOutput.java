...
public interface RecipeOutput {
    default void accept(ResourceLocation p_310578_, Recipe<?> p_312265_, @Nullable AdvancementHolder p_310407_) {
        if (p_310407_ == null) {
            ...
            var ops = registry().m_318927_(com.mojang.serialization.JsonOps.INSTANCE);
            var json = Advancement.f_303179_.encodeStart(ops, p_310407_.value()).getOrThrow(IllegalStateException::new);
