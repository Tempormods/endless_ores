...
public class BlockFamily {
    ...
    public Optional<String> getRecipeGroupPrefix() {
        return StringUtil.m_320314_(this.recipeGroupPrefix) ? Optional.empty() : Optional.of(this.recipeGroupPrefix);
    }

    public Optional<String> getRecipeUnlockedBy() {
        return StringUtil.m_320314_(this.recipeUnlockedBy) ? Optional.empty() : Optional.of(this.recipeUnlockedBy);
    }
