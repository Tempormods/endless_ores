...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(BlockTags.f_316762_);
        this.tag(BlockTags.f_316248_);
        this.tag(BlockTags.f_315121_).addTag(BlockTags.NEEDS_DIAMOND_TOOL);
        this.tag(BlockTags.f_315528_).addTag(BlockTags.NEEDS_DIAMOND_TOOL).addTag(BlockTags.NEEDS_IRON_TOOL);
        this.tag(BlockTags.f_316327_).addTag(BlockTags.NEEDS_DIAMOND_TOOL).addTag(BlockTags.NEEDS_IRON_TOOL).addTag(BlockTags.NEEDS_STONE_TOOL);
        this.tag(BlockTags.f_315377_).addTag(BlockTags.NEEDS_DIAMOND_TOOL).addTag(BlockTags.NEEDS_IRON_TOOL).addTag(BlockTags.NEEDS_STONE_TOOL);
        ...
        this.tag(BlockTags.f_314780_).addTag(BlockTags.ANIMALS_SPAWNABLE_ON).addTag(BlockTags.f_314078_).add(Blocks.RED_SAND, Blocks.COARSE_DIRT);
        ...
        pProvider.lookupOrThrow(Registries.BLOCK).m_318796_(p_284651_ -> p_284651_.defaultBlockState().canBeReplaced()).listElementIds().forEach(intrinsictagappender::add);
        ...
        this.tag(BlockTags.f_317104_).addTag(BlockTags.BEEHIVES);
    }
}