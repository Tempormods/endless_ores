...
public class RegistryPatchGenerator {
    public static CompletableFuture<RegistrySetBuilder.PatchedRegistries> m_305415_(
        ...
        return p_310881_.thenApply(
            p_309945_ -> {
                ...
                RegistryDataLoader.getWorldGenAndDimensionStream().forEach(p_313050_ -> p_313050_.m_305182_(cloner$factory::m_304739_));
                ...
                HolderLookup.Provider holderlookup$provider = registrysetbuilder$patchedregistries.f_303626_();
