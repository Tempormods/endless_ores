            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(NestedLootTable.m_320126_(BuiltInLootTables.FISHING_JUNK).setWeight(10).setQuality(-2))
                        .add(
                            NestedLootTable.m_320126_(BuiltInLootTables.FISHING_TREASURE)
                                .setWeight(5)
                                .setQuality(2)
                                .when(
                        ...
                        .add(NestedLootTable.m_320126_(BuiltInLootTables.FISHING_FISH).setWeight(85).setQuality(-1))
                )
        );
