...
public class EntityTypeTagsProvider extends IntrinsicHolderTagsProvider<EntityType<?>> {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(EntityTypeTags.f_303793_)
            .add(
        ...
        this.tag(EntityTypeTags.f_303412_)
            .addTag(EntityTypeTags.SKELETONS)
            .addTag(EntityTypeTags.f_303793_)
        ...
        this.tag(EntityTypeTags.f_303534_)
            .addTag(EntityTypeTags.f_303412_)
            .add(
                EntityType.AXOLOTL,
                EntityType.FROG,
                EntityType.GUARDIAN,
        ...
        this.tag(EntityTypeTags.f_314047_)
            .add(EntityType.EVOKER)
            .add(EntityType.ILLUSIONER)
            .add(EntityType.PILLAGER)
            .add(EntityType.VINDICATOR);
        this.tag(EntityTypeTags.f_316007_)
        ...
        this.tag(EntityTypeTags.f_315418_)
            .add(EntityType.BEE)
            .add(EntityType.ENDERMITE)
            .add(EntityType.SILVERFISH)
            .add(EntityType.SPIDER)
            .add(EntityType.CAVE_SPIDER);
        this.tag(EntityTypeTags.f_314231_).addTag(EntityTypeTags.f_303412_);
        this.tag(EntityTypeTags.f_316912_).addTag(EntityTypeTags.f_303412_);
        this.tag(EntityTypeTags.f_314802_).addTag(EntityTypeTags.f_303412_);
        this.tag(EntityTypeTags.f_314612_).addTag(EntityTypeTags.f_314047_);
        this.tag(EntityTypeTags.f_314707_)
            .add(EntityType.TURTLE)
            .add(EntityType.GUARDIAN)
            .add(EntityType.ELDER_GUARDIAN)
            .add(EntityType.COD)
            ...
            .add(EntityType.GLOW_SQUID)
            .add(EntityType.TADPOLE);
        this.tag(EntityTypeTags.f_316359_).addTag(EntityTypeTags.f_316007_);
        this.tag(EntityTypeTags.f_314167_).addTag(EntityTypeTags.f_315418_);
        this.tag(EntityTypeTags.f_314378_).addTag(EntityTypeTags.f_303412_);
        this.tag(EntityTypeTags.f_314896_).add(EntityType.FIREBALL);
    }
}
