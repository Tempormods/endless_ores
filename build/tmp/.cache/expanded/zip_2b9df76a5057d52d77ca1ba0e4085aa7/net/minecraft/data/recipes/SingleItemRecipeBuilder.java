...
public class SingleItemRecipeBuilder implements RecipeBuilder {
    ...
    private final SingleItemRecipe.Factory<?> f_303835_;

    public SingleItemRecipeBuilder(RecipeCategory pCategory, SingleItemRecipe.Factory<?> p_311287_, Ingredient pIngredient, ItemLike pResult, int pCount) {
        this.category = pCategory;
        this.f_303835_ = p_311287_;
    ...
    public void save(RecipeOutput pRecipeOutput, ResourceLocation pId) {
        ...
        SingleItemRecipe singleitemrecipe = this.f_303835_
            .m_306940_(Objects.requireNonNullElse(this.group, ""), this.ingredient, new ItemStack(this.result, this.count));
