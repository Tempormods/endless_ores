...
public class BlockFamilies {
    ...
    public static final BlockFamily COPPER_BLOCK = familyBuilder(Blocks.COPPER_BLOCK)
        ...
        .door(Blocks.f_302565_)
        .trapdoor(Blocks.f_303635_)
        .dontGenerateModel()
        .getFamily();
    ...
    public static final BlockFamily WAXED_EXPOSED_COPPER = familyBuilder(Blocks.WAXED_EXPOSED_COPPER)
        ...
        .door(Blocks.f_303222_)
        .trapdoor(Blocks.f_302272_)
    ...
    public static final BlockFamily WAXED_WEATHERED_COPPER = familyBuilder(Blocks.WAXED_WEATHERED_COPPER)
        ...
        .door(Blocks.f_302853_)
        .trapdoor(Blocks.f_303663_)
    ...
    public static final BlockFamily WAXED_OXIDIZED_COPPER = familyBuilder(Blocks.WAXED_OXIDIZED_COPPER)
        ...
        .door(Blocks.f_303692_)
        .trapdoor(Blocks.f_303101_)
    ...
    public static final BlockFamily f_303603_ = familyBuilder(Blocks.TUFF)
        .wall(Blocks.f_302213_)
        .stairs(Blocks.f_303426_)
        .slab(Blocks.f_303571_)
        .chiseled(Blocks.f_302743_)
        .polished(Blocks.f_303652_)
        .getFamily();
    public static final BlockFamily f_303214_ = familyBuilder(Blocks.f_303652_)
        .wall(Blocks.f_302818_)
        .stairs(Blocks.f_302449_)
        .slab(Blocks.f_302914_)
        .polished(Blocks.f_303547_)
        .getFamily();
    public static final BlockFamily f_303123_ = familyBuilder(Blocks.f_303547_)
        .wall(Blocks.f_303237_)
        .stairs(Blocks.f_303371_)
        .slab(Blocks.f_303545_)
        .chiseled(Blocks.f_302382_)
        .getFamily();
