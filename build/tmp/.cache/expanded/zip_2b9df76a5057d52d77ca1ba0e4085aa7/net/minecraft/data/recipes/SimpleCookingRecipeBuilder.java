...
public class SimpleCookingRecipeBuilder implements RecipeBuilder {
    ...
    private final AbstractCookingRecipe.Factory<?> f_302544_;
    ...
    public static <T extends AbstractCookingRecipe> SimpleCookingRecipeBuilder generic(
        ...
        return new SimpleCookingRecipeBuilder(pCategory, determineRecipeCategory(pSerializer, pResult), pResult, pIngredient, pExperience, pCookingTime, p_311862_);
    }
    ...
    public void save(RecipeOutput pRecipeOutput, ResourceLocation pId) {
        ...
        AbstractCookingRecipe abstractcookingrecipe = this.f_302544_
            .m_306886_(
    ...
    private static CookingBookCategory determineSmeltingRecipeCategory(ItemLike pResult) {
        if (pResult.asItem().m_320917_().m_321946_(DataComponents.f_315399_)) {
