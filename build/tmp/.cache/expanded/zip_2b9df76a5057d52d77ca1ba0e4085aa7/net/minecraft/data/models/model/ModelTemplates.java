...
public class ModelTemplates {
    ...
    public static final ModelTemplate f_303032_ = create("cube_all_inner_faces", TextureSlot.ALL);
    ...
    public static final ModelTemplate f_302568_ = create("cube_bottom_top_inner_faces", TextureSlot.TOP, TextureSlot.BOTTOM, TextureSlot.SIDE);
    ...
    public static final ModelTemplate f_315019_ = create(
        "template_vault", TextureSlot.TOP, TextureSlot.BOTTOM, TextureSlot.SIDE, TextureSlot.FRONT
    );
    public static final ModelTemplate f_315587_ = createItem("handheld_mace", TextureSlot.LAYER0);
