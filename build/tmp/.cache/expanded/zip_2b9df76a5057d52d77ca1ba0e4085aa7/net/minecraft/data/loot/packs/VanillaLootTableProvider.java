...
public class VanillaLootTableProvider {
    public static LootTableProvider create(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> p_330840_) {
        return new LootTableProvider(
            ...
            List.of(
                ...
                new LootTableProvider.SubProviderEntry(VanillaEquipmentLoot::new, LootContextParamSets.f_313897_),
                ...
                new LootTableProvider.SubProviderEntry(VanillaShearingLoot::new, LootContextParamSets.f_316219_)
            ),
            p_330840_
        );
    }
