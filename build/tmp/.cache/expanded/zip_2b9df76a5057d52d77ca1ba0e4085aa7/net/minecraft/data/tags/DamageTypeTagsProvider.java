...
public class DamageTypeTagsProvider extends TagsProvider<DamageType> {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(DamageTypeTags.f_303155_).add(DamageTypes.PLAYER_ATTACK, DamageTypes.PLAYER_EXPLOSION);
        this.tag(DamageTypeTags.f_316562_)
        ...
        this.tag(DamageTypeTags.f_314599_).add(DamageTypes.PLAYER_ATTACK);
    }
}
