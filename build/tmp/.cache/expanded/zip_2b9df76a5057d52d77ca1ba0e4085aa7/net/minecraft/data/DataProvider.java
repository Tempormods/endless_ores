...
public interface DataProvider {
    ...
    static <T> CompletableFuture<?> saveStable(CachedOutput pOutput, HolderLookup.Provider p_330662_, Codec<T> pCodec, T pValue, Path pPath) {
        RegistryOps<JsonElement> registryops = p_330662_.m_318927_(JsonOps.INSTANCE);
