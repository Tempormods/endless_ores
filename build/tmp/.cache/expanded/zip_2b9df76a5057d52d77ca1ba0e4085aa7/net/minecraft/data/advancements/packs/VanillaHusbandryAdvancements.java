...
public class VanillaHusbandryAdvancements implements AdvancementSubProvider {
    ...
    public void generate(HolderLookup.Provider pRegistries, Consumer<AdvancementHolder> pWriter) {
        ...
        m_321369_(Advancement.Builder.advancement(), pRegistries)
            .parent(advancementholder3)
            .display(
                Items.BONE,
        ...
        Advancement.Builder.advancement()
            ...
            .addCriterion(
                "repair_wolf_armor",
                PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(
                    ItemPredicate.Builder.item().of(Items.f_314244_),
                    Optional.of(
                        EntityPredicate.wrap(
                            EntityPredicate.Builder.entity()
                                .of(EntityType.WOLF)
                                .equipment(
                                    EntityEquipmentPredicate.Builder.equipment()
                                        .m_324162_(
                                            ItemPredicate.Builder.item()
                                                .of(Items.f_314362_)
                                                .m_324309_(DataComponentPredicate.m_321115_().m_319245_(DataComponents.f_313972_, 0).m_324461_())
                                        )
                                )
                        )
                    )
            ...
            .forEach(
                p_325841_ -> pBuilder.addCriterion(
                        ...
                        PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(
                            ...
                            Optional.of(
                                EntityPredicate.wrap(
                                    EntityPredicate.Builder.entity().of(EntityType.FROG).subPredicate(EntitySubPredicates.m_318658_(p_325841_))
                                )
                            )
                        )
                    )
        ...
        BuiltInRegistries.CAT_VARIANT
            ...
            .forEach(
                p_325843_ -> pBuilder.addCriterion(
                        ...
                        TameAnimalTrigger.TriggerInstance.tamedAnimal(EntityPredicate.Builder.entity().subPredicate(EntitySubPredicates.m_319315_(p_325843_)))
                    )
            );
        return pBuilder;
    }

    private static Advancement.Builder m_321369_(Advancement.Builder p_336151_, HolderLookup.Provider p_331812_) {
        HolderLookup.RegistryLookup<WolfVariant> registrylookup = p_331812_.lookupOrThrow(Registries.f_317086_);
                ...
                p_325846_ -> {
                    ...
                    p_336151_.addCriterion(
                        ...
                        TameAnimalTrigger.TriggerInstance.tamedAnimal(
                            EntityPredicate.Builder.entity().subPredicate(EntitySubPredicates.m_320274_(HolderSet.direct(holder)))
                        )
                    );
                }
            );
