...
public class FeatureUtils {
    ...
    public static void register(
        BootstrapContext<ConfiguredFeature<?, ?>> p_331914_, ResourceKey<ConfiguredFeature<?, ?>> pKey, Feature<NoneFeatureConfiguration> pFeature
    ) {
        register(p_331914_, pKey, pFeature, FeatureConfiguration.NONE);
    }

    public static <FC extends FeatureConfiguration, F extends Feature<FC>> void register(
        BootstrapContext<ConfiguredFeature<?, ?>> p_330706_, ResourceKey<ConfiguredFeature<?, ?>> pKey, F pFeature, FC pConfig
    ) {
        p_330706_.m_321889_(pKey, new ConfiguredFeature(pFeature, pConfig));
    }
}