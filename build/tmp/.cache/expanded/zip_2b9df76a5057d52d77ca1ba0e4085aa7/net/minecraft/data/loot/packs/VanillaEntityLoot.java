...
public class VanillaEntityLoot extends EntityLootSubProvider {
    ...
    public void generate() {
        ...
        this.add(EntityType.f_316265_, LootTable.lootTable());
        ...
        this.add(EntityType.f_316281_, LootTable.lootTable());
        this.add(
            EntityType.CAT,
            LootTable.lootTable()
                .withPool(
        ...
        this.add(EntityType.f_302782_, LootTable.lootTable());
            ...
            LootTable.lootTable()
                ...
                .withPool(
                    LootPool.lootPool()
                        .setRolls(ConstantValue.exactly(1.0F))
                        .add(
                            NestedLootTable.m_320126_(BuiltInLootTables.FISHING_FISH)
                                .apply(
                                    SmeltItemFunction.smelted().when(LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, ENTITY_ON_FIRE))
                                )
                        )
