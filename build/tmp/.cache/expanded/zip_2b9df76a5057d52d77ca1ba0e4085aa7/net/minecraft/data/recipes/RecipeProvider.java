...
public abstract class RecipeProvider implements DataProvider {
    ...
    private final CompletableFuture<HolderLookup.Provider> f_315873_;
    ...
    public RecipeProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> p_333797_) {
        ...
        this.f_315873_ = p_333797_;
    }

    @Override
    public final CompletableFuture<?> run(CachedOutput pOutput) {
        return this.f_315873_.thenCompose(p_325912_ -> this.m_252749_(pOutput, p_325912_));
    }

    protected CompletableFuture<?> m_252749_(final CachedOutput p_331109_, final HolderLookup.Provider p_328892_) {
            ...
            new RecipeOutput() {
                ...
                public void accept(ResourceLocation p_312383_, Recipe<?> p_312007_, @Nullable ResourceLocation advancementId, @Nullable com.google.gson.JsonElement advancement) {
                    if (!set.add(p_312383_)) {
                        ...
                        list.add(DataProvider.saveStable(p_331109_, p_328892_, Recipe.f_302387_, p_312007_, RecipeProvider.this.recipePathProvider.json(p_312383_)));
                        if (advancement != null) {
    ...
    protected CompletableFuture<?> buildAdvancement(CachedOutput pOutput, HolderLookup.Provider p_335995_, AdvancementHolder pAdvancementBuilder) {
        return DataProvider.saveStable(pOutput, p_335995_, Advancement.f_303179_, pAdvancementBuilder.value(), this.advancementPathProvider.json(pAdvancementBuilder.id()));
    }
    ...
    private static <T extends AbstractCookingRecipe> void oreCooking(
        ...
        for (ItemLike itemlike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), pCategory, pResult, pExperience, pCookingTime, pSerializer, p_312098_)
                .group(pGroup)
    ...
    protected static <T extends AbstractCookingRecipe> void cookRecipes(
        RecipeOutput pRecipeOutput, String pCookingMethod, RecipeSerializer<T> pCookingSerializer, AbstractCookingRecipe.Factory<T> p_312851_, int pCookingTime
    ) {
        simpleCookingRecipe(pRecipeOutput, pCookingMethod, pCookingSerializer, p_312851_, pCookingTime, Items.BEEF, Items.COOKED_BEEF, 0.35F);
        simpleCookingRecipe(pRecipeOutput, pCookingMethod, pCookingSerializer, p_312851_, pCookingTime, Items.CHICKEN, Items.COOKED_CHICKEN, 0.35F);
        simpleCookingRecipe(pRecipeOutput, pCookingMethod, pCookingSerializer, p_312851_, pCookingTime, Items.COD, Items.COOKED_COD, 0.35F);
        simpleCookingRecipe(pRecipeOutput, pCookingMethod, pCookingSerializer, p_312851_, pCookingTime, Items.KELP, Items.DRIED_KELP, 0.1F);
        simpleCookingRecipe(pRecipeOutput, pCookingMethod, pCookingSerializer, p_312851_, pCookingTime, Items.SALMON, Items.COOKED_SALMON, 0.35F);
        simpleCookingRecipe(pRecipeOutput, pCookingMethod, pCookingSerializer, p_312851_, pCookingTime, Items.MUTTON, Items.COOKED_MUTTON, 0.35F);
        simpleCookingRecipe(pRecipeOutput, pCookingMethod, pCookingSerializer, p_312851_, pCookingTime, Items.PORKCHOP, Items.COOKED_PORKCHOP, 0.35F);
        simpleCookingRecipe(pRecipeOutput, pCookingMethod, pCookingSerializer, p_312851_, pCookingTime, Items.POTATO, Items.BAKED_POTATO, 0.35F);
        simpleCookingRecipe(pRecipeOutput, pCookingMethod, pCookingSerializer, p_312851_, pCookingTime, Items.RABBIT, Items.COOKED_RABBIT, 0.35F);
    }
    ...
    private static <T extends AbstractCookingRecipe> void simpleCookingRecipe(
        ...
        SimpleCookingRecipeBuilder.generic(Ingredient.of(pMaterial), RecipeCategory.FOOD, pResult, pExperience, pCookingTime, pCookingSerializer, p_311509_)
            .unlockedBy(getHasName(pMaterial), has(pMaterial))
            .save(pRecipeOutput, getItemName(pResult) + "_from_" + pCookingMethod);
    }

    protected static void waxRecipes(RecipeOutput pRecipeOutput, FeatureFlagSet p_312821_) {
    ...
    protected static void generateRecipes(RecipeOutput pRecipeOutput, BlockFamily pBlockFamily, FeatureFlagSet p_312313_) {
    ...
    private static Criterion<InventoryChangeTrigger.TriggerInstance> inventoryTrigger(ItemPredicate... pPredicates) {
        return CriteriaTriggers.INVENTORY_CHANGED
            .createCriterion(new InventoryChangeTrigger.TriggerInstance(Optional.empty(), InventoryChangeTrigger.TriggerInstance.Slots.f_303621_, List.of(pPredicates)));
    }
