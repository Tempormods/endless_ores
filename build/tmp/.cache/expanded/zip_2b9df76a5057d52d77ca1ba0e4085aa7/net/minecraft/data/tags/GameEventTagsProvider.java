...
public class GameEventTagsProvider extends TagsProvider<GameEvent> {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        this.tag(GameEventTags.VIBRATIONS).m_320335_(VIBRATIONS_EXCEPT_FLAP).m_320335_(VibrationSystem.RESONANCE_EVENTS).add(GameEvent.FLAP.key());
        ...
        this.tag(GameEventTags.WARDEN_CAN_LISTEN)
            .m_320335_(VIBRATIONS_EXCEPT_FLAP)
            .m_320335_(VibrationSystem.RESONANCE_EVENTS)
