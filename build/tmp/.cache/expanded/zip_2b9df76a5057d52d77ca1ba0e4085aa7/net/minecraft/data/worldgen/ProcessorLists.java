...
public class ProcessorLists {
    ...
    private static void register(
        BootstrapContext<StructureProcessorList> p_332799_, ResourceKey<StructureProcessorList> pKey, List<StructureProcessor> pProcessors
    ) {
        p_332799_.m_321889_(pKey, new StructureProcessorList(pProcessors));
    }

    public static void bootstrap(BootstrapContext<StructureProcessorList> p_333601_) {
        HolderGetter<Block> holdergetter = p_333601_.m_255434_(Registries.BLOCK);
    ...
    private static CappedProcessor trailsArchyLootProcessor(ResourceKey<LootTable> p_332708_, int pValue) {
