...
public class TrialChambersStructurePools {
    public static final ResourceKey<StructureTemplatePool> f_302378_ = Pools.createKey("trial_chambers/chamber/end");
    public static final ResourceKey<StructureTemplatePool> f_302389_ = Pools.createKey("trial_chambers/hallway/fallback");
    public static final ResourceKey<StructureTemplatePool> f_302504_ = Pools.createKey("trial_chambers/chamber/entrance_cap");
    public static final List<PoolAliasBinding> f_302598_ = ImmutableList.<PoolAliasBinding>builder()
        .add(
            PoolAliasBinding.m_307343_(
                SimpleWeightedRandomList.<List<PoolAliasBinding>>builder()
                    .m_306905_(
                        List.of(
                            PoolAliasBinding.m_305746_(m_307224_("contents/ranged"), m_307224_("ranged/skeleton")),
                            PoolAliasBinding.m_305746_(m_307224_("contents/slow_ranged"), m_307224_("slow_ranged/skeleton"))
                        )
                    )
                    .m_306905_(
                        List.of(
                            PoolAliasBinding.m_305746_(m_307224_("contents/ranged"), m_307224_("ranged/stray")),
                            PoolAliasBinding.m_305746_(m_307224_("contents/slow_ranged"), m_307224_("slow_ranged/stray"))
                        )
                    )
                    .m_306905_(
                        List.of(
                            PoolAliasBinding.m_305746_(m_307224_("contents/ranged"), m_307224_("ranged/poison_skeleton")),
                            PoolAliasBinding.m_305746_(m_307224_("contents/slow_ranged"), m_307224_("slow_ranged/poison_skeleton"))
                        )
                    )
                    .build()
            )
        ...
        .add(
            PoolAliasBinding.m_305102_(
                m_307224_("contents/melee"),
                SimpleWeightedRandomList.<String>builder()
                    .m_306905_(m_307224_("melee/zombie"))
                    .m_306905_(m_307224_("melee/husk"))
                    .m_306905_(m_307224_("melee/slime"))
                    .build()
            )
        )
        .add(
            PoolAliasBinding.m_305102_(
                m_307224_("contents/small_melee"),
                SimpleWeightedRandomList.<String>builder()
                    .m_306905_(m_307224_("small_melee/spider"))
                    .m_306905_(m_307224_("small_melee/cave_spider"))
                    .m_306905_(m_307224_("small_melee/silverfish"))
                    .m_306905_(m_307224_("small_melee/baby_zombie"))
                    .build()
            )
        )
        .build();

    public static String m_307224_(String p_311025_) {
        return "trial_chambers/spawner/" + p_311025_;
    }

    public static void m_306329_(BootstrapContext<StructureTemplatePool> p_333856_) {
        HolderGetter<StructureTemplatePool> holdergetter = p_333856_.m_255434_(Registries.TEMPLATE_POOL);
        Holder<StructureTemplatePool> holder = holdergetter.getOrThrow(Pools.EMPTY);
        Holder<StructureTemplatePool> holder1 = holdergetter.getOrThrow(f_302389_);
        Holder<StructureTemplatePool> holder2 = holdergetter.getOrThrow(f_302504_);
        HolderGetter<StructureProcessorList> holdergetter1 = p_333856_.m_255434_(Registries.PROCESSOR_LIST);
        Holder<StructureProcessorList> holder3 = holdergetter1.getOrThrow(UpdateOneTwentyOneProcessorLists.f_303360_);
        p_333856_.m_321889_(
            f_302378_,
        ...
        PoolAliasBindings.m_304795_(p_333856_, holder, f_302598_);
    }
}