...
public class AncientCityStructurePools {
    public static void bootstrap(BootstrapContext<StructureTemplatePool> p_329774_) {
        HolderGetter<PlacedFeature> holdergetter = p_329774_.m_255434_(Registries.PLACED_FEATURE);
        Holder<PlacedFeature> holder = holdergetter.getOrThrow(CavePlacements.SCULK_PATCH_ANCIENT_CITY);
        HolderGetter<StructureProcessorList> holdergetter1 = p_329774_.m_255434_(Registries.PROCESSOR_LIST);
        ...
        HolderGetter<StructureTemplatePool> holdergetter2 = p_329774_.m_255434_(Registries.TEMPLATE_POOL);
