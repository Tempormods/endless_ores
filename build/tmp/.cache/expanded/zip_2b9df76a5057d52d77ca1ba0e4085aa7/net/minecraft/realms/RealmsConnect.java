        ...
        (new Thread("Realms-connect-task") {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        minecraft.getDownloadedPackSource().m_305368_(RealmsConnect.this.connection, ServerPackManager.PackPromptStatus.ALLOWED);
                    } catch (Exception exception) {
                        minecraft.getDownloadedPackSource().m_306775_();
                        if (RealmsConnect.this.aborted) {
                            return;
                        }
