...
public class ResourceKey<T> implements Comparable<ResourceKey<?>> {
    ...
    public static <T> StreamCodec<ByteBuf, ResourceKey<T>> m_323597_(ResourceKey<? extends Registry<T>> p_335484_) {
        return ResourceLocation.f_314488_.m_323038_(p_326178_ -> create(p_335484_, p_326178_), ResourceKey::location);
    }
    ...
    public static <T> ResourceKey<Registry<T>> createRegistryKey(ResourceLocation pLocation) {
        return create(Registries.f_303875_, pLocation);
    }
    ...
    public ResourceKey<Registry<T>> m_323747_() {
