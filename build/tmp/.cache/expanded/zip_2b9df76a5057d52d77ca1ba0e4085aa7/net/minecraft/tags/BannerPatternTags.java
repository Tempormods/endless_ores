...
public class BannerPatternTags {
    ...
    public static final TagKey<BannerPattern> f_316816_ = create("pattern_item/flow");
    public static final TagKey<BannerPattern> f_314907_ = create("pattern_item/guster");
