...
public interface DamageTypeTags {
    ...
    TagKey<DamageType> f_302961_ = create("breeze_immune_to");
    ...
    TagKey<DamageType> f_303155_ = create("can_break_armor_stand");
    TagKey<DamageType> f_316562_ = create("bypasses_wolf_armor");
    TagKey<DamageType> f_314599_ = create("is_player_attack");
