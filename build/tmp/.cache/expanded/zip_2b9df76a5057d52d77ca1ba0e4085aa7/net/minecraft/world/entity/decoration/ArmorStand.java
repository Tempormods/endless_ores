...
public class ArmorStand extends LivingEntity {
    ...
    private static final EntityDimensions BABY_DIMENSIONS = EntityType.ARMOR_STAND.getDimensions().scale(0.5F).m_320568_(0.9875F);
    ...
    public static AttributeSupplier.Builder m_321608_() {
        return createLivingAttributes().add(Attributes.f_316806_, 0.0);
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_328656_) {
        ...
        p_328656_.m_318949_(DATA_CLIENT_FLAGS, (byte)0);
        p_328656_.m_318949_(DATA_HEAD_POSE, DEFAULT_HEAD_POSE);
        p_328656_.m_318949_(DATA_BODY_POSE, DEFAULT_BODY_POSE);
        p_328656_.m_318949_(DATA_LEFT_ARM_POSE, DEFAULT_LEFT_ARM_POSE);
        p_328656_.m_318949_(DATA_RIGHT_ARM_POSE, DEFAULT_RIGHT_ARM_POSE);
        p_328656_.m_318949_(DATA_LEFT_LEG_POSE, DEFAULT_LEFT_LEG_POSE);
        p_328656_.m_318949_(DATA_RIGHT_LEG_POSE, DEFAULT_RIGHT_LEG_POSE);
    }
    ...
    @Override
    public boolean m_320440_(EquipmentSlot p_332073_) {
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        for (ItemStack itemstack : this.armorItems) {
            listtag.add(itemstack.m_324153_(this.m_321891_()));
        }
        ...
        for (ItemStack itemstack1 : this.handItems) {
            listtag1.add(itemstack1.m_324153_(this.m_321891_()));
        }
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (pCompound.contains("HandItems", 9)) {
            ...
            for (int j = 0; j < this.handItems.size(); j++) {
                ...
                this.handItems.set(j, ItemStack.m_318937_(this.m_321891_(), compoundtag2));
            }
        }
    ...
    private EquipmentSlot getClickedSlot(Vec3 pVector) {
        ...
        double d0 = pVector.y / (double)(this.getScale() * this.m_320705_());
    ...
    private boolean swapItem(Player pPlayer, EquipmentSlot pSlot, ItemStack pStack, InteractionHand pHand) {
        ...
        if (!itemstack.isEmpty() && (this.disabledSlots & 1 << pSlot.getFilterFlag() + 8) != 0) {
            ...
            return false;
        } else if (pPlayer.m_322042_() && itemstack.isEmpty() && !pStack.isEmpty()) {
            this.m_21035_(pSlot, pStack.copyWithCount(1));
            return true;
            ...
            this.m_21035_(pSlot, pStack.split(1));
            return true;
        }
    }
    ...
    public boolean hurt(DamageSource pSource, float pAmount) {
        if (this.level().isClientSide || this.isRemoved()) {
            ...
            boolean flag = pSource.is(DamageTypeTags.f_303155_);
