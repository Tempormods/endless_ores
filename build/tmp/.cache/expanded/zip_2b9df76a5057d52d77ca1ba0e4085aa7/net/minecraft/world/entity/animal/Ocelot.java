...
public class Ocelot extends Animal {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_331325_) {
        ...
        p_331325_.m_318949_(DATA_TRUSTING, false);
    }

    @Override
    protected void registerGoals() {
        this.temptGoal = new Ocelot.OcelotTemptGoal(this, 0.6, p_335521_ -> p_335521_.is(ItemTags.f_316292_), true);
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_316292_);
    }
    ...
    static class OcelotTemptGoal extends TemptGoal {
        ...
        public OcelotTemptGoal(Ocelot pOcelot, double pSpeedModifier, Predicate<ItemStack> p_330301_, boolean pCanScare) {
            super(pOcelot, pSpeedModifier, p_330301_, pCanScare);
            this.ocelot = pOcelot;
        }
