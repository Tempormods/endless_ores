...
public final class RegionFileStorage implements AutoCloseable {
    ...
    private final RegionStorageInfo f_316179_;
    private final Path folder;
    private final boolean sync;

    RegionFileStorage(RegionStorageInfo p_330451_, Path pFolder, boolean pSync) {
        this.folder = pFolder;
        this.sync = pSync;
        this.f_316179_ = p_330451_;
    }
    ...
    private RegionFile getRegionFile(ChunkPos pChunkPos) throws IOException {
        ...
        if (regionfile != null) {
            ...
            RegionFile regionfile1 = new RegionFile(this.f_316179_, path, this.folder, this.sync);
