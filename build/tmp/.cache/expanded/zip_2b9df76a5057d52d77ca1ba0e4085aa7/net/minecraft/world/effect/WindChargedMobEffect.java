...
class WindChargedMobEffect extends MobEffect {
    protected WindChargedMobEffect(MobEffectCategory p_332863_, int p_333215_) {
        super(p_332863_, p_333215_, ParticleTypes.f_314220_);
    }

    @Override
    public void m_319157_(LivingEntity p_333151_, int p_331087_, Entity.RemovalReason p_335248_) {
        if (p_335248_ == Entity.RemovalReason.KILLED && p_333151_.level() instanceof ServerLevel serverlevel) {
            ...
            serverlevel.m_255039_(
                p_333151_,
                null,
                AbstractWindCharge.f_316764_,
                d2,
                d0,
                d1,
                f,
