...
public class Cow extends Animal {
    private static final EntityDimensions f_315285_ = EntityType.COW.getDimensions().scale(0.5F).m_320568_(0.665F);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25, p_332367_ -> p_332367_.is(ItemTags.f_315238_), false));
    ...
    public boolean isFood(ItemStack p_330979_) {
        return p_330979_.is(ItemTags.f_315238_);
    }
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_329860_) {
        return this.isBaby() ? f_315285_ : super.m_31586_(p_329860_);
    }
}