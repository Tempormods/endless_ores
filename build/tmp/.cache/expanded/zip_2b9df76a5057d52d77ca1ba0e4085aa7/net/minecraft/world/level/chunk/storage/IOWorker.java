...
public class IOWorker implements ChunkScanAccess, AutoCloseable {
    ...
    protected IOWorker(RegionStorageInfo p_335181_, Path pFolder, boolean pSync) {
        this.storage = new RegionFileStorage(p_335181_, pFolder, pSync);
        this.mailbox = new ProcessorMailbox<>(
            new StrictQueue.FixedPriorityQueue(IOWorker.Priority.values().length), Util.ioPool(), "IOWorker-" + p_335181_.f_314842_()
        );
    }
