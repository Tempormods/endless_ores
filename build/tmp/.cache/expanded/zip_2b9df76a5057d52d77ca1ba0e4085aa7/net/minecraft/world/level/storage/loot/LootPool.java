...
public class LootPool {
    public static final Codec<LootPool> CODEC = RecordCodecBuilder.create(
        p_327556_ -> p_327556_.group(
                    ...
                    LootItemConditions.f_317075_.listOf().optionalFieldOf("conditions", List.of()).forGetter(p_297008_ -> p_297008_.conditions),
                    LootItemFunctions.f_314213_.listOf().optionalFieldOf("functions", List.of()).forGetter(p_297009_ -> p_297009_.functions),
    ...
    LootPool(
        ...
        this.compositeCondition = Util.m_322468_(p_297697_);
