...
public class TrunkPlacerType<P extends TrunkPlacer> {
    ...
    private static <P extends TrunkPlacer> TrunkPlacerType<P> register(String pKey, MapCodec<P> p_328214_) {
        return Registry.register(BuiltInRegistries.TRUNK_PLACER_TYPE, pKey, new TrunkPlacerType<>(p_328214_));
    }
