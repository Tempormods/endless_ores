...
public class FireworkStarRecipe extends CustomRecipe {
    ...
    private static final Ingredient f_316738_ = Ingredient.of(Items.GLOWSTONE_DUST);
        ...
        for (int i = 0; i < pInv.getContainerSize(); i++) {
            ...
            if (!itemstack.isEmpty()) {
                if (SHAPE_INGREDIENT.test(itemstack)) {
                    ...
                    flag2 = true;
                } else if (f_316738_.test(itemstack)) {
                    if (flag4) {
                        return false;
                    }
    ...
    public ItemStack assemble(CraftingContainer pContainer, HolderLookup.Provider p_335220_) {
        ...
        itemstack1.m_322496_(DataComponents.f_315608_, new FireworkExplosion(fireworkexplosion$shape, intlist, IntList.of(), flag1, flag));
        return itemstack1;
    }
