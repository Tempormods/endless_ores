...
public class FlyNodeEvaluator extends WalkNodeEvaluator {
    ...
    private static final float f_317136_ = 1.0F;
    ...
    public Node getStart() {
        ...
        if (this.canFloat() && this.mob.isInWater()) {
            ...
            for (BlockState blockstate = this.f_314620_.m_320852_(blockpos$mutableblockpos);
                blockstate.is(Blocks.WATER);
                blockstate = this.f_314620_.m_320852_(blockpos$mutableblockpos)
            ) {
    ...
    @Override
    public Target m_319819_(double p_328296_, double p_329795_, double p_334015_) {
        return this.m_322518_(p_328296_, p_329795_, p_334015_);
    }
    ...
    @Override
    protected PathType m_321558_(int p_332812_, int p_330135_, int p_330816_) {
        return this.pathTypeByPosCache
            .computeIfAbsent(
                BlockPos.asLong(p_332812_, p_330135_, p_330816_),
                p_327510_ -> this.m_319854_(this.f_314620_, p_332812_, p_330135_, p_330816_, this.mob)
            );
    }

    @Override
    public PathType m_320240_(PathfindingContext p_333778_, int p_332501_, int p_330191_, int p_335791_) {
        PathType pathtype = p_333778_.m_324267_(p_332501_, p_330191_, p_335791_);
        if (pathtype == PathType.OPEN && p_330191_ >= p_333778_.m_321732_().getMinBuildHeight() + 1) {
            BlockPos blockpos = new BlockPos(p_332501_, p_330191_ - 1, p_335791_);
            PathType pathtype1 = p_333778_.m_324267_(blockpos.getX(), blockpos.getY(), blockpos.getZ());
            if (pathtype1 == PathType.DAMAGE_FIRE || pathtype1 == PathType.LAVA) {
                ...
                if (!blockpos.equals(p_333778_.m_323060_())) {
