...
public class SpawnerBlockEntity extends BlockEntity implements Spawner {
    ...
    @Override
    protected void m_318667_(CompoundTag p_328601_, HolderLookup.Provider p_329952_) {
        super.m_318667_(p_328601_, p_329952_);
        this.spawner.load(this.level, this.worldPosition, p_328601_);
    }

    @Override
    protected void saveAdditional(CompoundTag pTag, HolderLookup.Provider p_332669_) {
        super.saveAdditional(pTag, p_332669_);
    ...
    public CompoundTag getUpdateTag(HolderLookup.Provider p_329063_) {
        CompoundTag compoundtag = this.m_320696_(p_329063_);
