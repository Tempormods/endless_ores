...
public class GrassBlock extends SpreadingSnowyDirtBlock implements BonemealableBlock {
    public static final MapCodec<GrassBlock> f_303636_ = m_306223_(GrassBlock::new);

    @Override
    public MapCodec<GrassBlock> m_304657_() {
        return f_303636_;
    }
    ...
    public void performBonemeal(ServerLevel p_221270_, RandomSource p_221271_, BlockPos p_221272_, BlockState p_221273_) {
        ...
        BlockState blockstate = Blocks.f_303709_.defaultBlockState();
    ...
    @Override
    public BonemealableBlock.Type m_319049_() {
