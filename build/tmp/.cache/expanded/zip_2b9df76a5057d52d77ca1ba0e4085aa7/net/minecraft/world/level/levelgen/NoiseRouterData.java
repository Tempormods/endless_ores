...
public class NoiseRouterData {
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstrapContext<DensityFunction> p_335193_) {
        HolderGetter<NormalNoise.NoiseParameters> holdergetter = p_335193_.m_255434_(Registries.NOISE);
        HolderGetter<DensityFunction> holdergetter1 = p_335193_.m_255434_(Registries.DENSITY_FUNCTION);
        p_335193_.m_321889_(ZERO, DensityFunctions.zero());
        int i = DimensionType.MIN_Y * 2;
        int j = DimensionType.MAX_Y * 2;
        p_335193_.m_321889_(Y, DensityFunctions.yClampedGradient(i, j, (double)i, (double)j));
        ...
        p_335193_.m_321889_(BASE_3D_NOISE_OVERWORLD, BlendedNoise.createUnseeded(0.25, 0.125, 80.0, 160.0, 8.0));
        p_335193_.m_321889_(BASE_3D_NOISE_NETHER, BlendedNoise.createUnseeded(0.25, 0.375, 80.0, 60.0, 8.0));
        p_335193_.m_321889_(BASE_3D_NOISE_END, BlendedNoise.createUnseeded(0.25, 0.25, 80.0, 160.0, 4.0));
        Holder<DensityFunction> holder = p_335193_.m_321889_(
            CONTINENTS,
        ...
        Holder<DensityFunction> holder1 = p_335193_.m_321889_(
            EROSION,
        ...
        p_335193_.m_321889_(RIDGES_FOLDED, peaksAndValleys(densityfunction2));
        ...
        Holder<DensityFunction> holder2 = p_335193_.m_321889_(
            CONTINENTS_LARGE,
        ...
        Holder<DensityFunction> holder3 = p_335193_.m_321889_(
            EROSION_LARGE,
        ...
        p_335193_.m_321889_(SLOPED_CHEESE_END, DensityFunctions.add(DensityFunctions.endIslands(0L), getFunction(holdergetter1, BASE_3D_NOISE_END)));
        p_335193_.m_321889_(SPAGHETTI_ROUGHNESS_FUNCTION, spaghettiRoughnessFunction(holdergetter));
        p_335193_.m_321889_(SPAGHETTI_2D_THICKNESS_MODULATOR, DensityFunctions.cacheOnce(DensityFunctions.mappedNoise(holdergetter.getOrThrow(Noises.SPAGHETTI_2D_THICKNESS), 2.0, 1.0, -0.6, -1.3)));
        p_335193_.m_321889_(SPAGHETTI_2D, spaghetti2D(holdergetter1, holdergetter));
        p_335193_.m_321889_(ENTRANCES, entrances(holdergetter1, holdergetter));
        p_335193_.m_321889_(NOODLE, noodle(holdergetter1, holdergetter));
        return p_335193_.m_321889_(PILLARS, pillars(holdergetter));
    }
    ...
    private static void registerTerrainNoises(
        ...
        DensityFunction densityfunction2 = registerAndWrap(
            p_330992_, pDepthKey, DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5, -1.5), densityfunction)
        );
        ...
        p_330992_.m_321889_(pSlopedCheeseKey, DensityFunctions.add(densityfunction5, getFunction(pDensityFunctionGetter, BASE_3D_NOISE_OVERWORLD)));
    }

    private static DensityFunction registerAndWrap(BootstrapContext<DensityFunction> p_331307_, ResourceKey<DensityFunction> pKey, DensityFunction pDensityFunction) {
        return new DensityFunctions.HolderHolder(p_331307_.m_321889_(pKey, pDensityFunction));
    }
