...
public class LongJumpToRandomPos<E extends Mob> extends Behavior<E> {
    ...
    protected final float f_316580_;
    ...
    public static <E extends Mob> boolean defaultAcceptableLandingSpot(E p_251540_, BlockPos p_248879_) {
        ...
        return level.getBlockState(blockpos).isSolidRender(level, blockpos) && p_251540_.getPathfindingMalus(WalkNodeEvaluator.m_324593_(p_251540_, p_248879_)) == 0.0F;
    }
    ...
    public LongJumpToRandomPos(
        ...
        this.f_316580_ = pMaxJumpVelocity;
    ...
    protected Vec3 calculateOptimalJumpVector(Mob pMob, Vec3 pTarget) {
        ...
        float f = (float)(pMob.getAttributeValue(Attributes.JUMP_STRENGTH) * (double)this.f_316580_);

        for (int i : list) {
            Optional<Vec3> optional = LongJumpUtil.m_305962_(pMob, pTarget, f, i, true);
