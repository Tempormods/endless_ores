...
public record GameEvent(int notificationRadius) {
    ...
    public static Holder<GameEvent> m_322753_(Registry<GameEvent> p_336256_) {
    ...
    public static final class ListenerInfo implements Comparable<GameEvent.ListenerInfo> {
        ...
        public ListenerInfo(Holder<GameEvent> p_334906_, Vec3 pSource, GameEvent.Context pContext, GameEventListener pRecipient, Vec3 pRecipientPosition) {
