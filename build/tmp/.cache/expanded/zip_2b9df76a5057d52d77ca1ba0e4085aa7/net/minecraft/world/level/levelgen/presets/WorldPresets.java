...
public class WorldPresets {
    ...
    static class Bootstrap {
        ...
        Bootstrap(BootstrapContext<WorldPreset> p_335809_) {
            ...
            HolderGetter<DimensionType> holdergetter = p_335809_.m_255434_(Registries.DIMENSION_TYPE);
            this.noiseSettings = p_335809_.m_255434_(Registries.NOISE_SETTINGS);
            this.biomes = p_335809_.m_255434_(Registries.BIOME);
            this.placedFeatures = p_335809_.m_255434_(Registries.PLACED_FEATURE);
            this.structureSets = p_335809_.m_255434_(Registries.STRUCTURE_SET);
            this.multiNoiseBiomeSourceParameterLists = p_335809_.m_255434_(Registries.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST);
        ...
        private void registerCustomOverworldPreset(ResourceKey<WorldPreset> pDimensionKey, LevelStem pLevelStem) {
            this.context.m_321889_(pDimensionKey, this.createPresetWithCustomOverworld(pLevelStem));
        }
