...
public abstract class Display extends Entity {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_327982_) {
        p_327982_.m_318949_(DATA_POS_ROT_INTERPOLATION_DURATION_ID, 0);
        p_327982_.m_318949_(DATA_TRANSFORMATION_INTERPOLATION_START_DELTA_TICKS_ID, 0);
        p_327982_.m_318949_(DATA_TRANSFORMATION_INTERPOLATION_DURATION_ID, 0);
        p_327982_.m_318949_(DATA_TRANSLATION_ID, new Vector3f());
        p_327982_.m_318949_(DATA_SCALE_ID, new Vector3f(1.0F, 1.0F, 1.0F));
        p_327982_.m_318949_(DATA_RIGHT_ROTATION_ID, new Quaternionf());
        p_327982_.m_318949_(DATA_LEFT_ROTATION_ID, new Quaternionf());
        p_327982_.m_318949_(DATA_BILLBOARD_RENDER_CONSTRAINTS_ID, Display.BillboardConstraints.FIXED.getId());
        p_327982_.m_318949_(DATA_BRIGHTNESS_OVERRIDE_ID, -1);
        p_327982_.m_318949_(DATA_VIEW_RANGE_ID, 1.0F);
        p_327982_.m_318949_(DATA_SHADOW_RADIUS_ID, 0.0F);
        p_327982_.m_318949_(DATA_SHADOW_STRENGTH_ID, 1.0F);
        p_327982_.m_318949_(DATA_WIDTH_ID, 0.0F);
        p_327982_.m_318949_(DATA_HEIGHT_ID, 0.0F);
        p_327982_.m_318949_(DATA_GLOW_COLOR_OVERRIDE_ID, -1);
    }
    ...
    public static class BlockDisplay extends Display {
        ...
        protected void defineSynchedData(SynchedEntityData.Builder p_329731_) {
            ...
            p_329731_.m_318949_(DATA_BLOCK_STATE_ID, Blocks.AIR.defaultBlockState());
        }
    ...
    public static class ItemDisplay extends Display {
        ...
        private final SlotAccess slot = SlotAccess.m_320701_(this::getItemStack, this::setItemStack);
        @Nullable
        ...
        protected void defineSynchedData(SynchedEntityData.Builder p_332308_) {
            ...
            p_332308_.m_318949_(DATA_ITEM_STACK_ID, ItemStack.EMPTY);
            p_332308_.m_318949_(DATA_ITEM_DISPLAY_ID, ItemDisplayContext.NONE.getId());
        }
        ...
        protected void readAdditionalSaveData(CompoundTag pCompound) {
            ...
            if (pCompound.contains("item")) {
                this.setItemStack(ItemStack.m_323951_(this.m_321891_(), pCompound.getCompound("item")).orElse(ItemStack.EMPTY));
            } else {
        ...
        protected void addAdditionalSaveData(CompoundTag pCompound) {
            ...
            if (!this.getItemStack().isEmpty()) {
                pCompound.put("item", this.getItemStack().save(this.m_321891_()));
            }
    ...
    public static class TextDisplay extends Display {
        ...
        protected void defineSynchedData(SynchedEntityData.Builder p_330653_) {
            ...
            p_330653_.m_318949_(DATA_TEXT_ID, Component.empty());
            p_330653_.m_318949_(DATA_LINE_WIDTH_ID, 200);
            p_330653_.m_318949_(DATA_BACKGROUND_COLOR_ID, 1073741824);
            p_330653_.m_318949_(DATA_TEXT_OPACITY_ID, (byte)-1);
            p_330653_.m_318949_(DATA_STYLE_FLAGS_ID, (byte)0);
        }
        ...
        protected void readAdditionalSaveData(CompoundTag pCompound) {
            ...
            if (pCompound.contains("text", 8)) {
                ...
                try {
                    Component component = Component.Serializer.fromJson(s, this.m_321891_());
                    if (component != null) {
        ...
        protected void addAdditionalSaveData(CompoundTag pCompound) {
            super.addAdditionalSaveData(pCompound);
            pCompound.putString("text", Component.Serializer.toJson(this.getText(), this.m_321891_()));
