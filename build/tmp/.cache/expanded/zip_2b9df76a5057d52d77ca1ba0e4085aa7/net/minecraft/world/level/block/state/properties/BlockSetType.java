...
public record BlockSetType(
    ...
    boolean f_303181_,
    boolean f_303105_,
    BlockSetType.PressurePlateSensitivity f_303604_,
    SoundType soundType,
    ...
    private static final Map<String, BlockSetType> f_302819_ = new Object2ObjectArrayMap<>();
    public static final Codec<BlockSetType> f_303023_ = Codec.stringResolver(BlockSetType::name, f_302819_::get);
    ...
    public static final BlockSetType f_303086_ = register(
        new BlockSetType(
            "copper",
            true,
            true,
            ...
            BlockSetType.PressurePlateSensitivity.EVERYTHING,
            SoundType.COPPER,
            SoundEvents.f_302833_,
            SoundEvents.f_303543_,
            SoundEvents.f_302415_,
            SoundEvents.f_303820_,
            SoundEvents.METAL_PRESSURE_PLATE_CLICK_OFF,
            SoundEvents.METAL_PRESSURE_PLATE_CLICK_ON,
            SoundEvents.STONE_BUTTON_CLICK_OFF,
            SoundEvents.STONE_BUTTON_CLICK_ON
    ...
    public static BlockSetType register(BlockSetType pValue) {
        f_302819_.put(pValue.name, pValue);
        return pValue;
    }

    public static Stream<BlockSetType> values() {
        return f_302819_.values().stream();
    }
