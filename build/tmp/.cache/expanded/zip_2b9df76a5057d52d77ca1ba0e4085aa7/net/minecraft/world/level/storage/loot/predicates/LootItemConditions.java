...
public class LootItemConditions {
    ...
    public static final Codec<LootItemCondition> f_317075_ = Codec.lazyInitialized(() -> Codec.withAlternative(TYPED_CODEC, AllOfCondition.INLINE_CODEC));
    public static final Codec<Holder<LootItemCondition>> CODEC = RegistryFileCodec.create(Registries.f_315752_, f_317075_);
    ...
    private static LootItemConditionType register(String pName, MapCodec<? extends LootItemCondition> p_331746_) {
        return Registry.register(BuiltInRegistries.LOOT_CONDITION_TYPE, new ResourceLocation(pName), new LootItemConditionType(p_331746_));
    }
}