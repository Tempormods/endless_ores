...
public class Rabbit extends Animal implements VariantHolder<Rabbit.Variant> {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.0, p_333923_ -> p_333923_.is(ItemTags.f_314532_), false));
    ...
    protected float getJumpPower() {
        ...
        return super.m_320700_(f / 0.42F);
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_330536_) {
        ...
        p_330536_.m_318949_(DATA_TYPE_ID, Rabbit.Variant.BROWN.id);
    }
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_314532_);
    }
            ...
            if (this.isReachedTarget()) {
                ...
                if (this.canRaid && block instanceof CarrotBlock) {
                    ...
                    if (i == 0) {
                        ...
                        level.m_322719_(GameEvent.BLOCK_CHANGE, blockpos, GameEvent.Context.of(this.rabbit));
