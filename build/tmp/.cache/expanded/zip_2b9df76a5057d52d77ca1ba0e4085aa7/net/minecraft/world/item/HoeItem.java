...
public class HoeItem extends DiggerItem {
    ...
    public HoeItem(Tier pTier, Item.Properties pProperties) {
        ...
        if (pair == null) {
            ...
            if (predicate.test(pContext)) {
                ...
                if (!level.isClientSide) {
                    ...
                    if (player != null) {
                        pContext.getItemInHand().hurtAndBreak(1, player, LivingEntity.m_322775_(pContext.getHand()));
                    }
                }
    ...
    public static Consumer<UseOnContext> changeIntoState(BlockState pState) {
        return p_327147_ -> {
            ...
            p_327147_.getLevel().m_322719_(GameEvent.BLOCK_CHANGE, p_327147_.getClickedPos(), GameEvent.Context.of(p_327147_.getPlayer(), pState));
        };
    }
    ...
    public static Consumer<UseOnContext> changeIntoStateAndDropItem(BlockState pState, ItemLike pItemToDrop) {
        return p_327150_ -> {
            ...
            p_327150_.getLevel().m_322719_(GameEvent.BLOCK_CHANGE, p_327150_.getClickedPos(), GameEvent.Context.of(p_327150_.getPlayer(), pState));
