...
public class FoodData {
    ...
    private void m_320067_(int p_335153_, float p_332105_) {
    ...
    public void eat(int pFoodLevelModifier, float pSaturationLevelModifier) {
        this.m_320067_(pFoodLevelModifier, FoodConstants.m_324902_(pFoodLevelModifier, pSaturationLevelModifier));
    }

    public void eat(ItemStack pStack) {
        FoodProperties foodproperties = pStack.m_323252_(DataComponents.f_315399_);
        if (foodproperties != null) {
            this.m_320067_(foodproperties.nutrition(), foodproperties.f_315723_());
        }
    }
