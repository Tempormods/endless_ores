...
public class Llama extends AbstractChestedHorse implements VariantHolder<Llama.Variant>, RangedAttackMob {
    ...
    private static final EntityDimensions f_314884_ = EntityType.LLAMA
        .getDimensions()
        .m_323271_(EntityAttachments.m_321590_().m_322342_(EntityAttachment.PASSENGER, 0.0F, EntityType.LLAMA.getHeight() - 0.8125F, -0.3F))
        .scale(0.5F);
    boolean didSpit;
    @Nullable
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(5, new TemptGoal(this, 1.25, p_331564_ -> p_331564_.is(ItemTags.f_315676_), false));
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_327895_) {
        ...
        p_327895_.m_318949_(DATA_STRENGTH_ID, 0);
        p_327895_.m_318949_(DATA_VARIANT_ID, 0);
    }
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_314714_);
    }
    ...
    @Override
    public boolean m_30833_(ItemStack pStack) {
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_332334_) {
        return this.isBaby() ? f_314884_ : super.m_31586_(p_332334_);
    }
