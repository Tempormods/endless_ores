...
public class WitherBoss extends Monster implements PowerableMob, RangedAttackMob {
    ...
    private static final Predicate<LivingEntity> LIVING_ENTITY_SELECTOR = p_327004_ -> !p_327004_.getType().is(EntityTypeTags.f_314802_) && p_327004_.attackable();
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_332370_) {
        ...
        p_332370_.m_318949_(DATA_TARGET_A, 0);
        p_332370_.m_318949_(DATA_TARGET_B, 0);
        p_332370_.m_318949_(DATA_TARGET_C, 0);
        p_332370_.m_318949_(DATA_ID_INV, 0);
    }
    ...
    public void aiStep() {
        ...
        for (int l = 0; l < 3; l++) {
            ...
            if (flag && this.level().random.nextInt(4) == 0) {
                this.level()
                    .addParticle(
                        ColorParticleOption.m_321894_(ParticleTypes.ENTITY_EFFECT, 0.7F, 0.7F, 0.5F),
                        d8 + this.random.nextGaussian() * (double)f,
                        d10 + this.random.nextGaussian() * (double)f,
                        d2 + this.random.nextGaussian() * (double)f,
                        0.0,
        ...
        if (this.getInvulnerableTicks() > 0) {
            ...
            for (int i1 = 0; i1 < 3; i1++) {
                this.level()
                    .addParticle(
                        ColorParticleOption.m_321894_(ParticleTypes.ENTITY_EFFECT, 0.7F, 0.7F, 0.9F),
    ...
    public boolean hurt(DamageSource pSource, float pAmount) {
        if (this.isInvulnerableTo(pSource)) {
            ...
            if (entity1 != null && entity1.getType().is(EntityTypeTags.f_314802_)) {
                return false;
            } else {
                if (this.destroyBlocksTick <= 0) {
