...
public class TreeDecoratorType<P extends TreeDecorator> {
    ...
    private static <P extends TreeDecorator> TreeDecoratorType<P> register(String pKey, MapCodec<P> p_329425_) {
        return Registry.register(BuiltInRegistries.TREE_DECORATOR_TYPE, pKey, new TreeDecoratorType<>(p_329425_));
    }
