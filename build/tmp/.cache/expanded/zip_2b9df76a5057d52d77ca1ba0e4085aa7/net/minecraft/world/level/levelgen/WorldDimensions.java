...
public record WorldDimensions(Map<ResourceKey<LevelStem>, LevelStem> dimensions) {
    ...
    public static Map<ResourceKey<LevelStem>, LevelStem> withOverworld(
        Registry<DimensionType> pDimensionTypeRegistry, Map<ResourceKey<LevelStem>, LevelStem> p_327923_, ChunkGenerator pChunkGenerator
    ) {
        ...
        return withOverworld(p_327923_, holder, pChunkGenerator);
    }

    public static Map<ResourceKey<LevelStem>, LevelStem> withOverworld(
        Map<ResourceKey<LevelStem>, LevelStem> p_329337_, Holder<DimensionType> pDimensionType, ChunkGenerator pChunkGenerator
    ) {
    ...
    public WorldDimensions.Complete bake(Registry<LevelStem> pStemRegistry) {
        ...
        list.forEach(p_327459_ -> writableregistry.register(p_327459_.key, p_327459_.value, p_327459_.m_322379_()));
