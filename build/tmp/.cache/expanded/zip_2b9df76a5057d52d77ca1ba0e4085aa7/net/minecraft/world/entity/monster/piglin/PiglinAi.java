...
public class PiglinAi {
    ...
    protected static void updateActivity(Piglin pPiglin) {
        ...
        if (activity != activity1) {
            getSoundForCurrentActivity(pPiglin).ifPresent(pPiglin::m_323137_);
        }
    ...
    private static List<ItemStack> getBarterResponseItems(Piglin pPiglin) {
        LootTable loottable = pPiglin.level().getServer().m_323018_().m_321428_(BuiltInLootTables.PIGLIN_BARTERING);
    ...
    public static boolean isWearingGold(LivingEntity pLivingEntity) {
        for (ItemStack itemstack : pLivingEntity.m_322068_()) {
