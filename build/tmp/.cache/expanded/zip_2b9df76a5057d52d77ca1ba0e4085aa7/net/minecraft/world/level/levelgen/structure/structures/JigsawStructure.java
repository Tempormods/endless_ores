...
public final class JigsawStructure extends Structure {
    ...
    public static final int f_314708_ = 0;
    public static final int f_303065_ = 20;
    public static final MapCodec<JigsawStructure> CODEC = RecordCodecBuilder.<JigsawStructure>mapCodec(
            p_227640_ -> p_227640_.group(
                        ...
                        Codec.list(PoolAliasBinding.f_303072_).optionalFieldOf("pool_aliases", List.of()).forGetter(p_309350_ -> p_309350_.f_302829_)
                    )
    ...
    private final List<PoolAliasBinding> f_302829_;
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext pContext) {
        ...
        return JigsawPlacement.addPieces(
            ...
            PoolAliasLookup.m_307806_(this.f_302829_, blockpos, pContext.seed())
        );
    }
    ...
    public List<PoolAliasBinding> m_307102_() {
        return this.f_302829_;
    }
}