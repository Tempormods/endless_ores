...
public class NumberProviders {
    ...
    public static final LootNumberProviderType f_314126_ = register("storage", StorageValue.f_316731_);

    private static LootNumberProviderType register(String pName, MapCodec<? extends NumberProvider> p_330989_) {
        return Registry.register(BuiltInRegistries.LOOT_NUMBER_PROVIDER_TYPE, new ResourceLocation(pName), new LootNumberProviderType(p_330989_));
    }
}