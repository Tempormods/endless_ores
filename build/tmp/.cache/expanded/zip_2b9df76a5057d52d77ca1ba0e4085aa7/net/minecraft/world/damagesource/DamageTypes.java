...
public interface DamageTypes {
    ...
    ResourceKey<DamageType> f_314413_ = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("spit"));
    ResourceKey<DamageType> f_314576_ = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("wind_charge"));
    ...
    static void bootstrap(BootstrapContext<DamageType> p_335750_) {
        p_335750_.m_321889_(IN_FIRE, new DamageType("inFire", 0.1F, DamageEffects.BURNING));
        p_335750_.m_321889_(LIGHTNING_BOLT, new DamageType("lightningBolt", 0.1F));
        p_335750_.m_321889_(ON_FIRE, new DamageType("onFire", 0.0F, DamageEffects.BURNING));
        p_335750_.m_321889_(LAVA, new DamageType("lava", 0.1F, DamageEffects.BURNING));
        p_335750_.m_321889_(HOT_FLOOR, new DamageType("hotFloor", 0.1F, DamageEffects.BURNING));
        p_335750_.m_321889_(IN_WALL, new DamageType("inWall", 0.0F));
        p_335750_.m_321889_(CRAMMING, new DamageType("cramming", 0.0F));
        p_335750_.m_321889_(DROWN, new DamageType("drown", 0.0F, DamageEffects.DROWNING));
        p_335750_.m_321889_(STARVE, new DamageType("starve", 0.0F));
        p_335750_.m_321889_(CACTUS, new DamageType("cactus", 0.1F));
        p_335750_.m_321889_(
        ...
        p_335750_.m_321889_(FLY_INTO_WALL, new DamageType("flyIntoWall", 0.0F));
        p_335750_.m_321889_(FELL_OUT_OF_WORLD, new DamageType("outOfWorld", 0.0F));
        p_335750_.m_321889_(GENERIC, new DamageType("generic", 0.0F));
        p_335750_.m_321889_(MAGIC, new DamageType("magic", 0.0F));
        p_335750_.m_321889_(WITHER, new DamageType("wither", 0.0F));
        p_335750_.m_321889_(DRAGON_BREATH, new DamageType("dragonBreath", 0.0F));
        p_335750_.m_321889_(DRY_OUT, new DamageType("dryout", 0.1F));
        p_335750_.m_321889_(SWEET_BERRY_BUSH, new DamageType("sweetBerryBush", 0.1F, DamageEffects.POKING));
        p_335750_.m_321889_(FREEZE, new DamageType("freeze", 0.0F, DamageEffects.FREEZING));
        p_335750_.m_321889_(STALAGMITE, new DamageType("stalagmite", 0.0F));
        p_335750_.m_321889_(FALLING_BLOCK, new DamageType("fallingBlock", 0.1F));
        p_335750_.m_321889_(FALLING_ANVIL, new DamageType("anvil", 0.1F));
        p_335750_.m_321889_(FALLING_STALACTITE, new DamageType("fallingStalactite", 0.1F));
        p_335750_.m_321889_(STING, new DamageType("sting", 0.1F));
        p_335750_.m_321889_(MOB_ATTACK, new DamageType("mob", 0.1F));
        p_335750_.m_321889_(MOB_ATTACK_NO_AGGRO, new DamageType("mob", 0.1F));
        p_335750_.m_321889_(PLAYER_ATTACK, new DamageType("player", 0.1F));
        p_335750_.m_321889_(ARROW, new DamageType("arrow", 0.1F));
        p_335750_.m_321889_(TRIDENT, new DamageType("trident", 0.1F));
        p_335750_.m_321889_(MOB_PROJECTILE, new DamageType("mob", 0.1F));
        p_335750_.m_321889_(f_314413_, new DamageType("mob", 0.1F));
        p_335750_.m_321889_(FIREWORKS, new DamageType("fireworks", 0.1F));
        p_335750_.m_321889_(UNATTRIBUTED_FIREBALL, new DamageType("onFire", 0.1F, DamageEffects.BURNING));
        p_335750_.m_321889_(FIREBALL, new DamageType("fireball", 0.1F, DamageEffects.BURNING));
        p_335750_.m_321889_(WITHER_SKULL, new DamageType("witherSkull", 0.1F));
        p_335750_.m_321889_(THROWN, new DamageType("thrown", 0.1F));
        p_335750_.m_321889_(INDIRECT_MAGIC, new DamageType("indirectMagic", 0.0F));
        p_335750_.m_321889_(THORNS, new DamageType("thorns", 0.1F, DamageEffects.THORNS));
        p_335750_.m_321889_(EXPLOSION, new DamageType("explosion", DamageScaling.ALWAYS, 0.1F));
        p_335750_.m_321889_(PLAYER_EXPLOSION, new DamageType("explosion.player", DamageScaling.ALWAYS, 0.1F));
        p_335750_.m_321889_(SONIC_BOOM, new DamageType("sonic_boom", DamageScaling.ALWAYS, 0.0F));
        p_335750_.m_321889_(
        ...
        p_335750_.m_321889_(OUTSIDE_BORDER, new DamageType("outsideBorder", 0.0F));
        p_335750_.m_321889_(GENERIC_KILL, new DamageType("genericKill", 0.0F));
    }
}