...
public class EuclideanGameEventListenerRegistry implements GameEventListenerRegistry {
    ...
    @Override
    public boolean visitInRangeListeners(Holder<GameEvent> p_328893_, Vec3 pPos, GameEvent.Context pContext, GameEventListenerRegistry.ListenerVisitor pListenerVisitor) {
