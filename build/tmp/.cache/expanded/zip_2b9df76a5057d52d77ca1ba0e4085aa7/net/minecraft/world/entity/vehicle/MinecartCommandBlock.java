...
public class MinecartCommandBlock extends AbstractMinecart {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_333825_) {
        ...
        p_333825_.m_318949_(DATA_ID_COMMAND_NAME, "");
        p_333825_.m_318949_(DATA_ID_LAST_OUTPUT, CommonComponents.EMPTY);
    }

    @Override
    protected void readAdditionalSaveData(CompoundTag pCompound) {
        super.readAdditionalSaveData(pCompound);
        this.commandBlock.load(pCompound, this.m_321891_());
    ...
    protected void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        this.commandBlock.save(pCompound, this.m_321891_());
    }
