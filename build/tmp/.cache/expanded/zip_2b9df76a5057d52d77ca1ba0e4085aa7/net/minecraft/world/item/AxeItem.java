...
public class AxeItem extends DiggerItem {
    ...
    public AxeItem(Tier pTier, Item.Properties pProperties) {
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        Optional<BlockState> optional = modded != null ? Optional.of(modded) : this.m_304772_(level, blockpos, player, level.getBlockState(blockpos));
        if (optional.isEmpty()) {
            ...
            level.m_322719_(GameEvent.BLOCK_CHANGE, blockpos, GameEvent.Context.of(player, optional.get()));
            if (player != null) {
    ...
    private Optional<BlockState> m_304772_(Level p_312809_, BlockPos p_313114_, @Nullable Player p_312029_, BlockState p_311198_) {
