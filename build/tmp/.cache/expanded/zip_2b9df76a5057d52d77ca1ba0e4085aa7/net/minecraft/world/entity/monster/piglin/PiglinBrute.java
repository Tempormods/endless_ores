...
public class PiglinBrute extends AbstractPiglin {
    ...
    protected void populateDefaultEquipmentSlots(RandomSource pRandom, DifficultyInstance pDifficulty) {
        this.m_21035_(EquipmentSlot.MAINHAND, new ItemStack(Items.GOLDEN_AXE));
    }
    ...
    protected void playAngrySound() {
        this.m_323137_(SoundEvents.PIGLIN_BRUTE_ANGRY);
    }

    @Override
    protected void playConvertedSound() {
        this.m_323137_(SoundEvents.PIGLIN_BRUTE_CONVERTED_TO_ZOMBIFIED);
    }
}