...
public class NbtProviders {
    ...
    private static LootNbtProviderType register(String pName, MapCodec<? extends NbtProvider> p_335713_) {
        return Registry.register(BuiltInRegistries.LOOT_NBT_PROVIDER_TYPE, new ResourceLocation(pName), new LootNbtProviderType(p_335713_));
    }
}