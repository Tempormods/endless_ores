...
public class SkeletonHorse extends AbstractHorse {
    ...
    private static final EntityDimensions f_314278_ = EntityType.SKELETON_HORSE
        .getDimensions()
        .m_323271_(EntityAttachments.m_321590_().m_322342_(EntityAttachment.PASSENGER, 0.0F, EntityType.SKELETON_HORSE.getHeight() - 0.03125F, 0.0F))
        .scale(0.5F);
    ...
    public static boolean m_305737_(
        ...
        return !MobSpawnType.m_307588_(p_312214_)
            ? Animal.checkAnimalSpawnRules(p_312158_, p_312297_, p_312214_, p_312728_, p_309547_)
            : MobSpawnType.m_307154_(p_312214_) || isBrightEnoughToSpawn(p_312297_, p_312728_);
    }
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_328235_) {
        return this.isBaby() ? f_314278_ : super.m_31586_(p_328235_);
    }
