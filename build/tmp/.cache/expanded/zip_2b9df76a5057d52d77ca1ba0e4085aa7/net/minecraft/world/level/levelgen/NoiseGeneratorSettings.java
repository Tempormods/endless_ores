...
public record NoiseGeneratorSettings(
    ...
    public static void bootstrap(BootstrapContext<NoiseGeneratorSettings> p_334698_) {
        p_334698_.m_321889_(OVERWORLD, overworld(p_334698_, false, false));
        p_334698_.m_321889_(LARGE_BIOMES, overworld(p_334698_, false, true));
        p_334698_.m_321889_(AMPLIFIED, overworld(p_334698_, true, false));
        p_334698_.m_321889_(NETHER, nether(p_334698_));
        p_334698_.m_321889_(END, end(p_334698_));
        p_334698_.m_321889_(CAVES, caves(p_334698_));
        p_334698_.m_321889_(FLOATING_ISLANDS, floatingIslands(p_334698_));
    }
    ...
    public static NoiseGeneratorSettings end(BootstrapContext<?> p_330746_) {
        return new NoiseGeneratorSettings(
            ...
            NoiseRouterData.end(p_330746_.m_255434_(Registries.DENSITY_FUNCTION)),
            SurfaceRuleData.end(),
            List.of(),
            0,
            true,
    ...
    public static NoiseGeneratorSettings nether(BootstrapContext<?> p_329279_) {
        return new NoiseGeneratorSettings(
            ...
            NoiseRouterData.nether(p_329279_.m_255434_(Registries.DENSITY_FUNCTION), p_329279_.m_255434_(Registries.NOISE)),
    ...
    public static NoiseGeneratorSettings overworld(BootstrapContext<?> p_332236_, boolean pAmplified, boolean pLarge) {
        return new NoiseGeneratorSettings(
            NoiseSettings.OVERWORLD_NOISE_SETTINGS,
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.overworld(p_332236_.m_255434_(Registries.DENSITY_FUNCTION), p_332236_.m_255434_(Registries.NOISE), pLarge, pAmplified),
    ...
    public static NoiseGeneratorSettings caves(BootstrapContext<?> p_330713_) {
        return new NoiseGeneratorSettings(
            ...
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.caves(p_330713_.m_255434_(Registries.DENSITY_FUNCTION), p_330713_.m_255434_(Registries.NOISE)),
    ...
    public static NoiseGeneratorSettings floatingIslands(BootstrapContext<?> p_335454_) {
        return new NoiseGeneratorSettings(
            ...
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.floatingIslands(p_335454_.m_255434_(Registries.DENSITY_FUNCTION), p_335454_.m_255434_(Registries.NOISE)),
