...
public class Attributes {
    ...
    public static final Holder<Attribute> f_315802_ = register(
    ...
    public static final Holder<Attribute> f_315889_ = register(
    ...
    public static final Holder<Attribute> f_315424_ = register(
    ...
    public static final Holder<Attribute> f_315184_ = register(
    ...
    public static final Holder<Attribute> f_316299_ = register(
    ...
    public static final Holder<Attribute> f_316806_ = register(
    ...
    private static Holder<Attribute> register(String pId, Attribute pAttribute) {
        return Registry.registerForHolder(BuiltInRegistries.ATTRIBUTE, new ResourceLocation(pId), pAttribute);
    }

    public static Holder<Attribute> m_321043_(Registry<Attribute> p_336189_) {
        return MAX_HEALTH;
    }
}