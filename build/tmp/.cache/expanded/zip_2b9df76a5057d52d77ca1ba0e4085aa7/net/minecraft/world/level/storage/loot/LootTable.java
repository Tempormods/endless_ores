...
public class LootTable {
    ...
    public static final long f_314361_ = 0L;
    public static final Codec<LootTable> f_315527_ = RecordCodecBuilder.create(
        p_327557_ -> p_327557_.group(
                    ...
                    LootItemFunctions.f_314213_.listOf().optionalFieldOf("functions", List.of()).forGetter(p_297010_ -> p_297010_.functions)
                )
                .apply(p_327557_, LootTable::new)
    );
    public static final Codec<Holder<LootTable>> CODEC = RegistryFileCodec.create(Registries.f_314309_, f_315527_);
