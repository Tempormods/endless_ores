    ...
    public void tryMoveItems(int pSelectedMerchantRecipe) {
        if (pSelectedMerchantRecipe >= 0 && this.getOffers().size() > pSelectedMerchantRecipe) {
            ...
            if (this.tradeContainer.getItem(0).isEmpty() && this.tradeContainer.getItem(1).isEmpty()) {
                ...
                this.moveFromInventoryToPaymentSlot(0, merchantoffer.m_319694_());
                merchantoffer.m_320423_().ifPresent(p_332192_ -> this.moveFromInventoryToPaymentSlot(1, p_332192_));
            }
        }
    }

    private void moveFromInventoryToPaymentSlot(int pPaymentSlotIndex, ItemCost p_332037_) {
        for (int i = 3; i < 39; i++) {
            ItemStack itemstack = this.slots.get(i).getItem();
            if (!itemstack.isEmpty() && p_332037_.m_320083_(itemstack)) {
                ItemStack itemstack1 = this.tradeContainer.getItem(pPaymentSlotIndex);
                if (itemstack1.isEmpty() || ItemStack.m_322370_(itemstack, itemstack1)) {
