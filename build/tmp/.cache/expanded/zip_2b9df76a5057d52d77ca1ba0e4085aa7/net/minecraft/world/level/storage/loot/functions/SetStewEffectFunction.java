...
public class SetStewEffectFunction extends LootItemConditionalFunction {
    ...
    public ItemStack run(ItemStack pStack, LootContext pContext) {
        if (pStack.is(Items.SUSPICIOUS_STEW) && !this.effects.isEmpty()) {
            ...
            pStack.m_324919_(DataComponents.f_316666_, SuspiciousStewEffects.f_314102_, suspicioussteweffects$entry, SuspiciousStewEffects::m_323377_);
            return pStack;
        } else {
            return pStack;
        }
    ...
    public static class Builder extends LootItemConditionalFunction.Builder<SetStewEffectFunction.Builder> {
        ...
        public SetStewEffectFunction.Builder withEffect(Holder<MobEffect> p_331394_, NumberProvider pDurationValue) {
            this.effects.add(new SetStewEffectFunction.EffectEntry(p_331394_, pDurationValue));
            return this;
        }
