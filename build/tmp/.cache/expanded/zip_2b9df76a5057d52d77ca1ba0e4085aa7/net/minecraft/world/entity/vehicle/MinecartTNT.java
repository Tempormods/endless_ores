...
public class MinecartTNT extends AbstractMinecart {
    ...
    @Override
    public void m_38227_(DamageSource pSource) {
        double d0 = this.getDeltaMovement().horizontalDistanceSqr();
        if (!m_307426_(pSource) && !(d0 >= 0.01F)) {
    ...
    @Override
    boolean m_304763_(DamageSource p_310072_) {
        return m_307426_(p_310072_);
    }

    private static boolean m_307426_(DamageSource p_311405_) {
