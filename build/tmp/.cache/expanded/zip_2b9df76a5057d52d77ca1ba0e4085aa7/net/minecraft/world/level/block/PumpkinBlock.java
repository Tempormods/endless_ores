...
public class PumpkinBlock extends Block {
    public static final MapCodec<PumpkinBlock> f_302597_ = m_306223_(PumpkinBlock::new);

    @Override
    public MapCodec<PumpkinBlock> m_304657_() {
        return f_302597_;
    }
    ...
    protected ItemInteractionResult m_51273_(
        ...
        if (p_330568_.canPerformAction(net.minecraftforge.common.ToolActions.SHEARS_CARVE)) {
            return super.m_51273_(p_330568_, p_330263_, p_327756_, p_328675_, p_334049_, p_331851_, p_329008_);
        } else if (p_327756_.isClientSide) {
            return ItemInteractionResult.m_322455_(p_327756_.isClientSide);
        } else {
            ...
            p_330568_.hurtAndBreak(1, p_334049_, LivingEntity.m_322775_(p_331851_));
