...
public abstract class CompositeEntryBase extends LootPoolEntryContainer {
    ...
    public static <T extends CompositeEntryBase> MapCodec<T> createCodec(CompositeEntryBase.CompositeEntryConstructor<T> pConstructor) {
        return RecordCodecBuilder.mapCodec(
            p_327559_ -> p_327559_.group(LootPoolEntries.CODEC.listOf().optionalFieldOf("children", List.of()).forGetter(p_300130_ -> p_300130_.children))
                    ...
                    .apply(p_327559_, pConstructor::create)
        );
    }
