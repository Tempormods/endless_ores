...
public abstract class StructurePlacement {
    ...
    public boolean isStructureChunk(ChunkGeneratorStructureState pStructureState, int pX, int pZ) {
        return this.isPlacementChunk(pStructureState, pX, pZ)
            && this.m_318660_(pX, pZ, pStructureState.getLevelSeed())
            && this.m_319583_(pStructureState, pX, pZ);
    }

    public boolean m_318660_(int p_330491_, int p_330207_, long p_334851_) {
    ...
    public boolean m_319583_(ChunkGeneratorStructureState p_332649_, int p_327790_, int p_329174_) {
