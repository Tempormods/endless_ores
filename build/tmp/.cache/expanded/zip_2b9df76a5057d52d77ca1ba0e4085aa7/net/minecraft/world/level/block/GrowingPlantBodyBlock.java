...
public abstract class GrowingPlantBodyBlock extends GrowingPlantBlock implements BonemealableBlock {
    ...
    @Override
    protected abstract MapCodec<? extends GrowingPlantBodyBlock> m_304657_();
    ...
    @Override
    public ItemStack getCloneItemStack(LevelReader p_312726_, BlockPos pPos, BlockState pState) {
