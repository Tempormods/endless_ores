...
public interface HeightProviderType<P extends HeightProvider> {
    ...
    private static <P extends HeightProvider> HeightProviderType<P> register(String pKey, MapCodec<P> p_330940_) {
        return Registry.register(BuiltInRegistries.HEIGHT_PROVIDER_TYPE, pKey, () -> p_330940_);
    }
}