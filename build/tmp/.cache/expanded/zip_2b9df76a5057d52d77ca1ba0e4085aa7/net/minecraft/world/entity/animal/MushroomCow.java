...
public class MushroomCow extends Cow implements Shearable, VariantHolder<MushroomCow.MushroomType>, net.minecraftforge.common.IForgeShearable {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_336015_) {
        ...
        p_336015_.m_318949_(DATA_TYPE, MushroomCow.MushroomType.RED.type);
    }
    ...
    public InteractionResult mobInteract(Player pPlayer, InteractionHand pHand) {
        ...
        if (itemstack.is(Items.BOWL) && !this.isBaby()) {
            ...
            if (this.stewEffects != null) {
                ...
                itemstack2.m_322496_(DataComponents.f_316666_, this.stewEffects);
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (this.stewEffects != null) {
            SuspiciousStewEffects.f_314598_.encodeStart(NbtOps.INSTANCE, this.stewEffects).ifSuccess(p_296800_ -> pCompound.put("stew_effects", p_296800_));
        }
    }
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (pCompound.contains("stew_effects", 9)) {
            SuspiciousStewEffects.f_314598_.parse(NbtOps.INSTANCE, pCompound.get("stew_effects")).ifSuccess(p_326976_ -> this.stewEffects = p_326976_);
        }
    }
