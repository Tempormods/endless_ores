...
public class ScoreboardNameProviders {
    ...
    private static LootScoreProviderType register(String pName, MapCodec<? extends ScoreboardNameProvider> p_327870_) {
        return Registry.register(BuiltInRegistries.LOOT_SCORE_PROVIDER_TYPE, new ResourceLocation(pName), new LootScoreProviderType(p_327870_));
    }
}