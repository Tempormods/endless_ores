...
public class Goat extends Animal {
    ...
    public boolean isFood(ItemStack p_333559_) {
        return p_333559_.is(ItemTags.f_316983_);
    }
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_335397_) {
        return p_335397_ == Pose.LONG_JUMPING ? LONG_JUMPING_DIMENSIONS.scale(this.m_320705_()) : super.m_31586_(p_335397_);
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_336110_) {
        ...
        p_336110_.m_318949_(DATA_IS_SCREAMING_GOAT, false);
        p_336110_.m_318949_(DATA_HAS_LEFT_HORN, true);
        p_336110_.m_318949_(DATA_HAS_RIGHT_HORN, true);
    }
