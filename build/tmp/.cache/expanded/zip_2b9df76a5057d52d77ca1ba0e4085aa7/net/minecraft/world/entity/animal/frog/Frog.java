...
public class Frog extends Animal implements VariantHolder<Holder<FrogVariant>> {
    ...
    private static final ResourceKey<FrogVariant> f_316385_ = FrogVariant.TEMPERATE;
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_332901_) {
        ...
        p_332901_.m_318949_(DATA_VARIANT_ID, BuiltInRegistries.FROG_VARIANT.getHolderOrThrow(f_316385_));
        p_332901_.m_318949_(DATA_TONGUE_TARGET_ID, OptionalInt.empty());
    }
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.putString("variant", this.getVariant().unwrapKey().orElse(f_316385_).location().toString());
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData) {
        ...
        if (holder.is(BiomeTags.SPAWNS_COLD_VARIANT_FROGS)) {
            ...
            this.setVariant(BuiltInRegistries.FROG_VARIANT.getHolderOrThrow(f_316385_));
        }
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_314631_);
    }
    ...
    static class FrogNodeEvaluator extends AmphibiousNodeEvaluator {
        ...
        @Override
        public PathType m_320240_(PathfindingContext p_329957_, int p_331836_, int p_331056_, int p_330649_) {
            this.belowPos.set(p_331836_, p_331056_ - 1, p_330649_);
            BlockState blockstate = p_329957_.m_320852_(this.belowPos);
            return blockstate.is(BlockTags.FROG_PREFER_JUMP_TO) ? PathType.OPEN : super.m_320240_(p_329957_, p_331836_, p_331056_, p_330649_);
        }
    }
