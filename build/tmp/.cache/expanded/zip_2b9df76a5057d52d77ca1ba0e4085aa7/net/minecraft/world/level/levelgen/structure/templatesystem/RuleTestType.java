...
public interface RuleTestType<P extends RuleTest> {
    ...
    static <P extends RuleTest> RuleTestType<P> register(String pName, MapCodec<P> p_330324_) {
        return Registry.register(BuiltInRegistries.RULE_TEST, pName, () -> p_330324_);
    }
}