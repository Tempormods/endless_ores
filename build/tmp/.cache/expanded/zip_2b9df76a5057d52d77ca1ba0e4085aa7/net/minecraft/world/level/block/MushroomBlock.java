...
public class MushroomBlock extends BushBlock implements BonemealableBlock {
    public static final MapCodec<MushroomBlock> f_303169_ = RecordCodecBuilder.mapCodec(
        p_309886_ -> p_309886_.group(ResourceKey.codec(Registries.CONFIGURED_FEATURE).fieldOf("feature").forGetter(p_310622_ -> p_310622_.feature), m_305607_())
    ...
    @Override
    public MapCodec<MushroomBlock> m_304657_() {
        return f_303169_;
    }
