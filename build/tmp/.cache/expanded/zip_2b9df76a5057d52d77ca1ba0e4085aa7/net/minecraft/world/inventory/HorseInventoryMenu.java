...
public class HorseInventoryMenu extends AbstractContainerMenu {
    ...
    private final Container f_314456_;
    private final AbstractHorse horse;
    private static final int f_314190_ = 1;
    private static final int f_316240_ = 2;
    ...
    public HorseInventoryMenu(int pContainerId, Inventory pPlayerInventory, Container pContainer, final AbstractHorse pHorse) {
        ...
        this.f_314456_ = pHorse.m_322868_();
        this.horse = pHorse;
        int i = 3;
        ...
        this.addSlot(new Slot(this.f_314456_, 0, 8, 36) {
            /**
             * Check if the stack is allowed to be placed in this slot, used for armor slots as well as furnace fuel.
             */
            @Override
            public boolean mayPlace(ItemStack p_39690_) {
                return pHorse.m_30833_(p_39690_);
            }
    ...
    public boolean stillValid(Player pPlayer) {
        return !this.horse.hasInventoryChanged(this.horseContainer)
            ...
            && this.f_314456_.stillValid(pPlayer)
            && this.horse.isAlive()
            && pPlayer.m_321636_(this.horse, 4.0);
    }
