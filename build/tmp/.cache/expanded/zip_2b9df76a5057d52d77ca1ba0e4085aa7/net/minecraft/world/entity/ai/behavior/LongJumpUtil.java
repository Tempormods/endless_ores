...
public final class LongJumpUtil {
    public static Optional<Vec3> m_305962_(Mob p_312589_, Vec3 p_311721_, float p_310433_, int p_310545_, boolean p_310611_) {
            ...
            if (d12 > (double)p_310433_) {
                ...
                if (p_310611_) {
                    ...
                    for (int j = 0; j < i - 1; j++) {
                        ...
                        if (vec34 != null && !m_305158_(p_312589_, entitydimensions, vec34, vec35)) {
                            return Optional.empty();
                        }
    ...
    private static boolean m_305158_(Mob p_310914_, EntityDimensions p_310152_, Vec3 p_313099_, Vec3 p_311144_) {
