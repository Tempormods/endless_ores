...
public class StructureCheck {
    ...
    public StructureCheckResult checkStart(ChunkPos pChunkPos, Structure pStructure, StructurePlacement p_327807_, boolean pSkipKnownStructures) {
        ...
        if (object2intmap != null) {
            ...
            } else if (!p_327807_.m_318660_(pChunkPos.x, pChunkPos.z, this.seed)) {
