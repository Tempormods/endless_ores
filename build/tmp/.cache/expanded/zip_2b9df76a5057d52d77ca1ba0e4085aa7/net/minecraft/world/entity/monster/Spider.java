...
public class Spider extends Monster {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, Armadillo.class, 6.0F, 1.0, 1.2, p_328323_ -> !((Armadillo)p_328323_).m_323155_()));
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_334759_) {
        ...
        p_334759_.m_318949_(DATA_FLAGS_ID, (byte)0);
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData) {
        ...
        if (randomsource.nextInt(100) == 0) {
            ...
            if (skeleton != null) {
                ...
                skeleton.finalizeSpawn(pLevel, pDifficulty, pReason, null);
    ...
    @Override
    public Vec3 m_320507_(Entity p_333349_) {
        return p_333349_.getBbWidth() <= this.getBbWidth() ? new Vec3(0.0, 0.3125 * (double)this.getScale(), 0.0) : super.m_320507_(p_333349_);
    }
