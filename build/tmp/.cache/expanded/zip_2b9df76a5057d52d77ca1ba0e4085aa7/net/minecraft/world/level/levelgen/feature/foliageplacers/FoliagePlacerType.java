...
public class FoliagePlacerType<P extends FoliagePlacer> {
    ...
    private static <P extends FoliagePlacer> FoliagePlacerType<P> register(String pKey, MapCodec<P> p_332653_) {
        return Registry.register(BuiltInRegistries.FOLIAGE_PLACER_TYPE, pKey, new FoliagePlacerType<>(p_332653_));
    }
