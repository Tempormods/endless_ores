...
public class Axolotl extends Animal implements LerpingModel, VariantHolder<Axolotl.Variant>, Bucketable {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_333789_) {
        ...
        p_333789_.m_318949_(DATA_VARIANT, 0);
        p_333789_.m_318949_(DATA_PLAYING_DEAD, false);
        p_333789_.m_318949_(FROM_BUCKET, false);
    }
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_316264_);
    }
    ...
    public void saveToBucketTag(ItemStack pStack) {
        ...
        CustomData.m_322978_(DataComponents.f_315524_, pStack, p_331240_ -> {
