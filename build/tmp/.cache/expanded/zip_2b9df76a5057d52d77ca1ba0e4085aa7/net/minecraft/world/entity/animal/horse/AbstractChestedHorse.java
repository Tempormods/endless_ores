...
public abstract class AbstractChestedHorse extends AbstractHorse {
    ...
    private final EntityDimensions f_316737_;

    protected AbstractChestedHorse(EntityType<? extends AbstractChestedHorse> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.canGallop = false;
        this.f_316737_ = pEntityType.getDimensions()
            .m_323271_(EntityAttachments.m_321590_().m_322342_(EntityAttachment.PASSENGER, 0.0F, pEntityType.getHeight() - 0.15625F, 0.0F))
            .scale(0.5F);
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_335877_) {
        ...
        p_335877_.m_318949_(DATA_ID_CHEST, false);
    }
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_334387_) {
        return this.isBaby() ? this.f_316737_ : super.m_31586_(p_334387_);
    }
        ...
        if (this.hasChest()) {
            ...
            for (int i = 1; i < this.inventory.getContainerSize(); i++) {
                ...
                if (!itemstack.isEmpty()) {
                    ...
                    listtag.add(itemstack.m_321167_(this.m_321891_(), compoundtag));
                }
            }
        ...
        if (this.hasChest()) {
            ...
            for (int i = 0; i < listtag.size(); i++) {
                ...
                if (j < this.inventory.getContainerSize() - 1) {
                    this.inventory.setItem(j + 1, ItemStack.m_323951_(this.m_321891_(), compoundtag).orElse(ItemStack.EMPTY));
                }
            }
        }
    ...
    private void equipChest(Player pPlayer, ItemStack pChestStack) {
        ...
        pChestStack.m_321439_(1, pPlayer);
        this.createInventory();
    }
