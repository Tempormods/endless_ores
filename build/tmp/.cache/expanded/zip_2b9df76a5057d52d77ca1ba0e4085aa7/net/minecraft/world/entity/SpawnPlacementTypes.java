...
public interface SpawnPlacementTypes {
    SpawnPlacementType f_315673_ = (p_332715_, p_333529_, p_334870_) -> true;
    SpawnPlacementType f_317066_ = (p_328130_, p_329627_, p_331627_) -> {
    ...
    SpawnPlacementType f_315430_ = (p_333080_, p_328155_, p_335440_) -> p_335440_ != null && p_333080_.getWorldBorder().isWithinBounds(p_328155_)
            ? p_333080_.getFluidState(p_328155_).is(FluidTags.LAVA)
            : false;
    SpawnPlacementType f_314433_ = new SpawnPlacementType() {
        @Override
        public boolean m_322997_(LevelReader p_328923_, BlockPos p_332749_, @Nullable EntityType<?> p_334188_) {
            if (p_334188_ != null && p_328923_.getWorldBorder().isWithinBounds(p_332749_)) {
                ...
                return !blockstate.isValidSpawn(p_328923_, blockpos1, this, p_334188_)
                    ? false
                    : this.m_322716_(p_328923_, p_332749_, p_334188_) && this.m_322716_(p_328923_, blockpos, p_334188_);
            } else {
                return false;
            }
        }

        private boolean m_322716_(LevelReader p_331376_, BlockPos p_333023_, EntityType<?> p_334970_) {
        ...
        @Override
        public BlockPos m_321419_(LevelReader p_333745_, BlockPos p_335214_) {
