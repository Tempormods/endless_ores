...
public interface PlacementModifierType<P extends PlacementModifier> {
    ...
    private static <P extends PlacementModifier> PlacementModifierType<P> register(String pName, MapCodec<P> p_333192_) {
        return Registry.register(BuiltInRegistries.PLACEMENT_MODIFIER_TYPE, pName, () -> p_333192_);
    }
}