...
public class RootedDirtBlock extends Block implements BonemealableBlock {
    public static final MapCodec<RootedDirtBlock> f_302956_ = m_306223_(RootedDirtBlock::new);

    @Override
    public MapCodec<RootedDirtBlock> m_304657_() {
        return f_302956_;
    }
    ...
    @Override
    public BlockPos m_319154_(BlockPos p_335934_) {
