...
public class Slime extends Mob implements Enemy {
    ...
    public static final int f_315302_ = 4;
    ...
    protected Vec3 m_293035_(Entity pEntity, EntityDimensions pDimensions, float pScale) {
        return new Vec3(0.0, (double)pDimensions.height() - 0.015625 * (double)this.getSize() * (double)pScale, 0.0);
    }
    ...
    public static boolean checkSlimeSpawnRules(EntityType<Slime> pSlime, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
        if (MobSpawnType.m_307588_(pSpawnType)) {
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_336379_) {
        return super.m_31586_(p_336379_).scale((float)this.getSize());
    }
