...
public class EnchantmentMenu extends AbstractContainerMenu {
        ...
        if (pInventory == this.enchantSlots) {
            ...
            if (!itemstack.isEmpty() && itemstack.isEnchantable()) {
                this.access.execute((p_327074_, p_327075_) -> {
                    ...
                    for (BlockPos blockpos : EnchantingTableBlock.f_314970_) {
                        if (EnchantingTableBlock.m_323194_(p_327074_, p_327075_, blockpos)) {
                            j++;
    ...
    public boolean clickMenuButton(Player pPlayer, int pId) {
        if (pId >= 0 && pId < this.costs.length) {
            ...
            int i = pId + 1;
            if ((itemstack1.isEmpty() || itemstack1.getCount() < i) && !pPlayer.m_322042_()) {
                return false;
                ...
                this.access.execute((p_327081_, p_327082_) -> {
                    ...
                    if (!list.isEmpty()) {
                        ...
                        if (itemstack.is(Items.BOOK)) {
                            itemstack2 = itemstack.m_319323_(Items.ENCHANTED_BOOK, 1);
    ...
    private List<EnchantmentInstance> getEnchantmentList(FeatureFlagSet p_330227_, ItemStack pStack, int pEnchantSlot, int pLevel) {
        this.random.setSeed((long)(this.enchantmentSeed.get() + pEnchantSlot));
        List<EnchantmentInstance> list = EnchantmentHelper.selectEnchantment(p_330227_, this.random, pStack, pLevel, false);
