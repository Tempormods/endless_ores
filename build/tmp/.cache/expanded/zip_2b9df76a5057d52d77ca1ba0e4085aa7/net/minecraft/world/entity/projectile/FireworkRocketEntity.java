...
public class FireworkRocketEntity extends Projectile implements ItemSupplier {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_332895_) {
        p_332895_.m_318949_(DATA_ID_FIREWORKS_ITEM, m_322828_());
        p_332895_.m_318949_(DATA_ATTACHED_TO_TARGET, OptionalInt.empty());
        p_332895_.m_318949_(DATA_SHOT_AT_ANGLE, false);
    }
    ...
    private boolean hasExplosion() {
        return !this.m_323884_().isEmpty();
    }

    private void dealExplosionDamage() {
        float f = 0.0F;
        List<FireworkExplosion> list = this.m_323884_();
        if (!list.isEmpty()) {
    ...
    public void handleEntityEvent(byte pId) {
        if (pId == 17 && this.level().isClientSide) {
            ...
            this.level().createFireworks(this.getX(), this.getY(), this.getZ(), vec3.x, vec3.y, vec3.z, this.m_323884_());
        }
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.put("FireworksItem", this.getItem().save(this.m_321891_()));
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (pCompound.contains("FireworksItem", 10)) {
            this.entityData
                .set(DATA_ID_FIREWORKS_ITEM, ItemStack.m_323951_(this.m_321891_(), pCompound.getCompound("FireworksItem")).orElseGet(FireworkRocketEntity::m_322828_));
        } else {
            this.entityData.set(DATA_ID_FIREWORKS_ITEM, m_322828_());
        }
    ...
    private List<FireworkExplosion> m_323884_() {
        ItemStack itemstack = this.entityData.get(DATA_ID_FIREWORKS_ITEM);
        Fireworks fireworks = itemstack.m_323252_(DataComponents.f_316632_);
        return fireworks != null ? fireworks.f_314926_() : List.of();
    }
    ...
    private static ItemStack m_322828_() {
