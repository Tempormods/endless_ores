...
public interface Spawner {
    ...
    static void m_304703_(ItemStack p_311346_, List<Component> p_309883_, String p_310819_) {
        Component component = m_305945_(p_311346_, p_310819_);
        if (component != null) {
    ...
    @Nullable
    static Component m_305945_(ItemStack p_312162_, String p_309907_) {
        CompoundTag compoundtag = p_312162_.m_322304_(DataComponents.f_316520_, CustomData.f_317060_).m_323459_();
        ResourceLocation resourcelocation = m_306229_(compoundtag, p_309907_);
    ...
    @Nullable
    private static ResourceLocation m_306229_(CompoundTag p_313110_, String p_312914_) {
