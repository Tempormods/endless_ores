...
public abstract class Raider extends PatrollingMonster {
    ...
    static final Predicate<ItemEntity> ALLOWED_ITEMS = p_327061_ -> !p_327061_.hasPickUpDelay()
            && p_327061_.isAlive()
            && ItemStack.matches(p_327061_.getItem(), Raid.getLeaderBannerInstance(p_327061_.m_321891_().lookupOrThrow(Registries.BANNER_PATTERN)));
    @Nullable
    protected Raid raid;
    private int wave;
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_333182_) {
        ...
        p_333182_.m_318949_(IS_CELEBRATING, false);
    }
    ...
    public void die(DamageSource pCause) {
        if (this.level() instanceof ServerLevel) {
            ...
            if (!this.level().enabledFeatures().contains(FeatureFlags.f_302467_)
                && this.isPatrolLeader()
                && raid == null
                ...
                if (!itemstack.isEmpty() && ItemStack.matches(itemstack, Raid.getLeaderBannerInstance(this.m_321891_().lookupOrThrow(Registries.BANNER_PATTERN))) && player != null) {
    ...
    public boolean m_324198_() {
        ItemStack itemstack = this.getItemBySlot(EquipmentSlot.HEAD);
        boolean flag = !itemstack.isEmpty() && ItemStack.matches(itemstack, Raid.getLeaderBannerInstance(this.m_321891_().lookupOrThrow(Registries.BANNER_PATTERN)));
        boolean flag1 = this.isPatrolLeader();
        return flag && flag1;
    }

    public boolean m_320449_() {
    ...
    protected void pickUpItem(ItemEntity pItemEntity) {
        ...
        if (this.hasActiveRaid() && !flag && ItemStack.matches(itemstack, Raid.getLeaderBannerInstance(this.m_321891_().lookupOrThrow(Registries.BANNER_PATTERN)))) {
            ...
            this.m_21035_(equipmentslot, itemstack);
    ...
    public class ObtainRaidLeaderBannerGoal<T extends Raider> extends Goal {
        ...
        public boolean canUse() {
            ...
            if (this.mob.hasActiveRaid()
                ...
                && !ItemStack.matches(this.mob.getItemBySlot(EquipmentSlot.HEAD), Raid.getLeaderBannerInstance(this.mob.m_321891_().lookupOrThrow(Registries.BANNER_PATTERN)))) {
    ...
    public class RaiderCelebration extends Goal {
        ...
        public void tick() {
            if (!this.mob.isSilent() && this.mob.random.nextInt(this.adjustedTickDelay(100)) == 0) {
                Raider.this.m_323137_(Raider.this.getCelebrateSound());
            }
