...
public class Pufferfish extends AbstractFish {
    ...
    private static final Predicate<LivingEntity> SCARY_MOB = p_326980_ -> {
        ...
        return !p_326980_.getType().is(EntityTypeTags.f_314707_);
    };
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_335016_) {
        ...
        p_335016_.m_318949_(PUFF_STATE, 0);
    }
        ...
        if (!this.level().isClientSide && this.isAlive() && this.isEffectiveAi()) {
            if (this.inflateCounter > 0) {
                if (this.getPuffState() == 0) {
                    this.m_323137_(SoundEvents.PUFFER_FISH_BLOW_UP);
                    this.setPuffState(1);
                ...
                if (this.deflateTimer > 60 && this.getPuffState() == 2) {
                    this.m_323137_(SoundEvents.PUFFER_FISH_BLOW_OUT);
                    this.setPuffState(1);
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_335494_) {
        return super.m_31586_(p_335494_).scale(getScale(this.getPuffState()));
    }
