...
public class AnimalMakeLove extends Behavior<Animal> {
    ...
    private final int f_316615_;
    private static final int f_317016_ = 2;
    ...
    protected void start(ServerLevel pLevel, Animal pEntity, long pGameTime) {
        ...
        BehaviorUtils.lockGazeAndWalkToEachOther(pEntity, animal, this.speedModifier, this.f_316615_);
    ...
    protected void tick(ServerLevel pLevel, Animal pOwner, long pGameTime) {
        ...
        BehaviorUtils.lockGazeAndWalkToEachOther(pOwner, animal, this.speedModifier, this.f_316615_);
