...
public interface StructureProcessorType<P extends StructureProcessor> {
    ...
    static <P extends StructureProcessor> StructureProcessorType<P> register(String pName, MapCodec<P> p_329428_) {
        return Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, pName, () -> p_329428_);
    }
}