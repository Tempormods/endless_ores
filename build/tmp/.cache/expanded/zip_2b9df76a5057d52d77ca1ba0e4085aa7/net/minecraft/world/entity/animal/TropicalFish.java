...
public class TropicalFish extends AbstractSchoolingFish implements VariantHolder<TropicalFish.Pattern> {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_330187_) {
        ...
        p_330187_.m_318949_(DATA_ID_TYPE_VARIANT, 0);
    }
    ...
    public void saveToBucketTag(ItemStack pStack) {
        ...
        CustomData.m_322978_(DataComponents.f_315524_, pStack, p_328762_ -> p_328762_.putInt("BucketVariantTag", this.getPackedVariant()));
    }
    ...
    public static record Variant(TropicalFish.Pattern pattern, DyeColor baseColor, DyeColor patternColor) {
        public static final Codec<TropicalFish.Variant> f_315998_ = Codec.INT.xmap(TropicalFish.Variant::new, TropicalFish.Variant::getPackedId);
