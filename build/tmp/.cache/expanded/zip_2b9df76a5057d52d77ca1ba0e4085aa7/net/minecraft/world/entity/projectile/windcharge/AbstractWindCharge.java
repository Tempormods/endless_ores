...
public abstract class AbstractWindCharge extends AbstractHurtingProjectile implements ItemSupplier {
    public static final AbstractWindCharge.WindChargeDamageCalculator f_316764_ = new AbstractWindCharge.WindChargeDamageCalculator();
    ...
    protected void onHitEntity(EntityHitResult p_328561_) {
        ...
        if (!this.level().isClientSide) {
            ...
            Entity entity = p_328561_.getEntity().m_321613_(p_328561_.getLocation()).orElse(p_328561_.getEntity());
            if (livingentity != null) {
                livingentity.setLastHurtMob(entity);
            }

            entity.hurt(this.damageSources().m_324994_(this, livingentity), 1.0F);
            this.m_320462_();
        }
    }
    ...
    protected abstract void m_320462_();
    ...
    public static class WindChargeDamageCalculator extends ExplosionDamageCalculator {
        @Override
        public boolean m_304921_(Explosion p_329716_, Entity p_327996_) {
            return false;
        }
        ...
        public Optional<Float> getBlockExplosionResistance(Explosion p_335115_, BlockGetter p_329011_, BlockPos p_330601_, BlockState p_331417_, FluidState p_330040_) {
            return p_331417_.is(BlockTags.f_314652_) ? Optional.of(3600000.0F) : Optional.empty();
        }
    }
}