...
public class JigsawPlacement {
    ...
    public static Optional<Structure.GenerationStub> addPieces(
        ...
        StructureTemplatePool structuretemplatepool = pStartPool.unwrapKey()
            .flatMap(p_309329_ -> registry.getOptional(p_312146_.m_307301_((ResourceKey<StructureTemplatePool>)p_309329_)))
    ...
    private static void addPieces(
        ...
        jigsawplacement$placer.tryPlacingChildren(p_227219_, new MutableObject<>(p_227221_), 0, pUseExpansionHack, pLevel, pRandomState, p_312553_);
    ...
    public static boolean generateJigsaw(
        ...
        Optional<Structure.GenerationStub> optional = addPieces(
            structure$generationcontext, pStartPool, Optional.of(pStartJigsawName), pMaxDepth, pPos, false, Optional.empty(), 128, PoolAliasLookup.f_303598_
        );
    ...
    static final class Placer {
        ...
        void tryPlacingChildren(
            ...
            for (StructureTemplate.StructureBlockInfo structuretemplate$structureblockinfo : structurepoolelement.getShuffledJigsawBlocks(
                ...
                int k = -1;
                ResourceKey<StructureTemplatePool> resourcekey = m_306140_(structuretemplate$structureblockinfo, p_311045_);
                                            ...
                                            .mapToInt(
                                                p_255598_ -> {
                                                    if (!boundingbox1.isInside(p_255598_.pos().relative(JigsawBlock.getFrontFacing(p_255598_.state())))) {
                                                        ...
                                                        ResourceKey<StructureTemplatePool> resourcekey1 = m_306140_(p_255598_, p_311045_);
                                        ...
                                        if (JigsawBlock.canAttach(structuretemplate$structureblockinfo, structuretemplate$structureblockinfo1)) {
                                            ...
                                            if (!Shapes.joinIsNotEmpty(
                                                ...
                                                if (pDepth + 1 <= this.maxDepth) {
                                                    ...
                                                    this.placing.m_307049_(jigsawplacement$piecestate, l);
                                                }
                                                continue label134;
                                            }
                                        }
        ...
        private static ResourceKey<StructureTemplatePool> m_306140_(StructureTemplate.StructureBlockInfo p_309775_, PoolAliasLookup p_310642_) {
            ...
            return p_310642_.m_307301_(resourcekey);
        }
    }
}