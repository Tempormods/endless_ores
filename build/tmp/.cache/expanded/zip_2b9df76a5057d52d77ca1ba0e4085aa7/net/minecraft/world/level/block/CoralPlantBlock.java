...
public class CoralPlantBlock extends BaseCoralPlantTypeBlock {
    public static final MapCodec<CoralPlantBlock> f_303435_ = RecordCodecBuilder.mapCodec(
        p_312298_ -> p_312298_.group(CoralBlock.f_303441_.forGetter(p_312756_ -> p_312756_.deadBlock), m_305607_()).apply(p_312298_, CoralPlantBlock::new)
    );
    ...
    @Override
    public MapCodec<CoralPlantBlock> m_304657_() {
        return f_303435_;
    }
