...
public class SignBlockEntity extends BlockEntity {
    ...
    @Override
    protected void saveAdditional(CompoundTag pTag, HolderLookup.Provider p_331864_) {
        super.saveAdditional(pTag, p_331864_);
        DynamicOps<Tag> dynamicops = p_331864_.m_318927_(NbtOps.INSTANCE);
    ...
    @Override
    protected void m_318667_(CompoundTag p_329420_, HolderLookup.Provider p_336389_) {
        super.m_318667_(p_329420_, p_336389_);
        DynamicOps<Tag> dynamicops = p_336389_.m_318927_(NbtOps.INSTANCE);
    ...
    public CompoundTag getUpdateTag(HolderLookup.Provider p_333348_) {
        return this.m_320696_(p_333348_);
    }
    ...
    public boolean playerIsTooFarAwayToEdit(UUID pUuid) {
        ...
        return player == null || !player.m_319363_(this.getBlockPos(), 4.0);
    }
