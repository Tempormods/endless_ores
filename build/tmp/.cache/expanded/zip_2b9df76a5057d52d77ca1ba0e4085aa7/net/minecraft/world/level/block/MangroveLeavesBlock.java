...
public class MangroveLeavesBlock extends LeavesBlock implements BonemealableBlock {
    public static final MapCodec<MangroveLeavesBlock> f_302498_ = m_306223_(MangroveLeavesBlock::new);

    @Override
    public MapCodec<MangroveLeavesBlock> m_304657_() {
        return f_302498_;
    }
    ...
    @Override
    public BlockPos m_319154_(BlockPos p_336154_) {
