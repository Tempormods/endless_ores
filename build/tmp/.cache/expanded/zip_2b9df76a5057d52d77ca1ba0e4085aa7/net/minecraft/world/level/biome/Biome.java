...
public final class Biome {
    ...
    public static enum Precipitation implements StringRepresentable {
        ...
        public static final Codec<Biome.Precipitation> f_303531_ = StringRepresentable.fromEnum(Biome.Precipitation::values);
        private final String f_303638_;

        private Precipitation(final String p_311702_) {
            this.f_303638_ = p_311702_;
        }

        @Override
        public String getSerializedName() {
            return this.f_303638_;
        }
    }
