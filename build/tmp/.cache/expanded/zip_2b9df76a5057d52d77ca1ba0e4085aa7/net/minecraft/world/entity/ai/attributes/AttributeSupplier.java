...
public class AttributeSupplier {
    ...
    private AttributeInstance getAttributeInstance(Holder<Attribute> p_335900_) {
        ...
        if (attributeinstance == null) {
            throw new IllegalArgumentException("Can't find attribute " + p_335900_.m_323990_());
        } else {
    ...
    public double getModifierValue(Holder<Attribute> p_333807_, UUID pId) {
        AttributeModifier attributemodifier = this.getAttributeInstance(p_333807_).getModifier(pId);
        if (attributemodifier == null) {
            throw new IllegalArgumentException("Can't find modifier " + pId + " on attribute " + p_333807_.m_323990_());
        } else {
    ...
    @Nullable
    public AttributeInstance createInstance(Consumer<AttributeInstance> pOnChangedCallback, Holder<Attribute> p_333997_) {
        AttributeInstance attributeinstance = this.instances.get(p_333997_);
        if (attributeinstance == null) {
            return null;
        } else {
            AttributeInstance attributeinstance1 = new AttributeInstance(p_333997_, pOnChangedCallback);
    ...
    public boolean hasModifier(Holder<Attribute> p_335566_, UUID pId) {
    ...
    public static class Builder {
        ...
        private AttributeInstance create(Holder<Attribute> p_334904_) {
            AttributeInstance attributeinstance = new AttributeInstance(p_334904_, p_326800_ -> {
                if (this.instanceFrozen) {
                    throw new UnsupportedOperationException("Tried to change value for default attribute instance: " + p_334904_.m_323990_());
                }
            });
        ...
        public AttributeSupplier.Builder add(Holder<Attribute> p_329131_, double pValue) {
