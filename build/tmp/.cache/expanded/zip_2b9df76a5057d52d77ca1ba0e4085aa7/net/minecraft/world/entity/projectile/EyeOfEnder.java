...
public class EyeOfEnder extends Entity implements ItemSupplier {
    ...
    public void setItem(ItemStack pStack) {
        if (pStack.isEmpty()) {
            this.getEntityData().set(DATA_ITEM_STACK, this.m_322109_());
        } else {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_333578_) {
        p_333578_.m_318949_(DATA_ITEM_STACK, this.m_322109_());
    }
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        if (pCompound.contains("Item", 10)) {
            this.setItem(ItemStack.m_323951_(this.m_321891_(), pCompound.getCompound("Item")).orElse(this.m_322109_()));
        } else {
            this.setItem(this.m_322109_());
        }
    }

    private ItemStack m_322109_() {
