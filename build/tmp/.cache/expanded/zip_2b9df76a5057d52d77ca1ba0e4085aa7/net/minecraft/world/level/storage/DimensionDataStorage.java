...
public class DimensionDataStorage {
    ...
    private final HolderLookup.Provider f_316381_;
    private final File dataFolder;

    public DimensionDataStorage(File pDataFolder, DataFixer pFixerUpper, HolderLookup.Provider p_336063_) {
        this.fixerUpper = pFixerUpper;
        this.dataFolder = pDataFolder;
        this.f_316381_ = p_336063_;
    }
    ...
    @Nullable
    private <T extends SavedData> T readSavedData(BiFunction<CompoundTag, HolderLookup.Provider, T> p_335409_, DataFixTypes pDataFixType, String pName) {
        try {
            ...
            if (file1.exists()) {
                ...
                return p_335409_.apply(compoundtag.getCompound("data"), this.f_316381_);
            }
    ...
    public void save() {
        this.cache.forEach((p_327534_, p_327535_) -> {
            if (p_327535_ != null) {
                p_327535_.save(this.getDataFile(p_327534_), this.f_316381_);
            }
        });
    }
}
