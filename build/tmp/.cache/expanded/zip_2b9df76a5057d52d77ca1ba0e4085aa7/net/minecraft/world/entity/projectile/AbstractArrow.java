...
public abstract class AbstractArrow extends Projectile {
    ...
    private ItemStack f_303749_ = this.m_321416_();
    ...
    protected AbstractArrow(EntityType<? extends AbstractArrow> pEntityType, Level pLevel, ItemStack p_312639_) {
        this(pEntityType, pLevel);
        this.f_303749_ = p_312639_.copy();
        this.setCustomName(p_312639_.m_323252_(DataComponents.f_316016_));
        Unit unit = p_312639_.m_319322_(DataComponents.f_314381_);
        if (unit != null) {
    ...
    protected AbstractArrow(
        EntityType<? extends AbstractArrow> pEntityType, double pX, double pY, double pZ, Level pLevel, ItemStack p_310436_
    ) {
        this(pEntityType, pLevel, p_310436_);
        this.setPos(pX, pY, pZ);
    }

    protected AbstractArrow(EntityType<? extends AbstractArrow> pEntityType, LivingEntity p_312718_, Level pLevel, ItemStack p_309639_) {
        this(pEntityType, p_312718_.getX(), p_312718_.getEyeY() - 0.1F, p_312718_.getZ(), pLevel, p_309639_);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_334076_) {
        p_334076_.m_318949_(ID_FLAGS, (byte)0);
        p_334076_.m_318949_(PIERCE_LEVEL, (byte)0);
    }
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        if (entity.hurt(damagesource, (float)i)) {
            ...
            this.m_318938_(ProjectileDeflection.f_314640_, entity, this.getOwner(), false);
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.put("item", this.f_303749_.save(this.m_321891_()));
    }
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (pCompound.contains("item", 10)) {
            this.m_320726_(ItemStack.m_323951_(this.m_321891_(), pCompound.getCompound("item")).orElse(this.m_321416_()));
        } else {
            this.m_320726_(this.m_321416_());
        }
    }
    ...
    protected boolean tryPickup(Player pPlayer) {
        return switch (this.pickup) {
            ...
            case CREATIVE_ONLY -> pPlayer.m_322042_();
        };
    }

    protected ItemStack getPickupItem() {
        return this.f_303749_.copy();
    }

    protected abstract ItemStack m_321416_();
    ...
    public ItemStack m_307069_() {
        return this.f_303749_;
    }
    ...
    public boolean isAttackable() {
        return this.getType().is(EntityTypeTags.f_314896_);
    }
    ...
    protected void m_320726_(ItemStack p_329565_) {
        if (!p_329565_.isEmpty()) {
            this.f_303749_ = p_329565_;
        } else {
            this.f_303749_ = this.m_321416_();
        }
    }
    ...
    public void setEnchantmentEffectsFromEntity(LivingEntity pShooter, float pVelocity) {
        int i = EnchantmentHelper.getEnchantmentLevel(Enchantments.f_314636_, pShooter);
        int j = EnchantmentHelper.getEnchantmentLevel(Enchantments.f_316860_, pShooter);
        ...
        if (EnchantmentHelper.getEnchantmentLevel(Enchantments.f_316779_, pShooter) > 0) {
            this.m_322706_(100);
        }
    }
    ...
    public SlotAccess getSlot(int p_330583_) {
        return p_330583_ == 0 ? SlotAccess.m_320701_(this::m_307069_, this::m_320726_) : super.getSlot(p_330583_);
    }
