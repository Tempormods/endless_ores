...
public class Slide extends Behavior<Breeze> {
    ...
    protected void start(ServerLevel p_312079_, Breeze p_310251_, long p_310596_) {
        ...
        if (livingentity != null) {
            boolean flag = p_310251_.m_307736_(livingentity.position());
            Vec3 vec3 = null;
            if (flag) {
                Vec3 vec31 = DefaultRandomPos.getPosAway(p_310251_, 5, 5, livingentity.position());
                if (vec31 != null
                    && BreezeUtil.m_320427_(p_310251_, vec31)
            ...
            if (vec3 == null) {
                vec3 = p_310251_.getRandom().nextBoolean() ? BreezeUtil.m_318815_(livingentity, p_310251_.getRandom()) : m_305912_(p_310251_, livingentity);
            }
    ...
    private static Vec3 m_305912_(Breeze p_310635_, LivingEntity p_312574_) {
