...
public abstract class Projectile extends Entity implements TraceableEntity {
    ...
    public Vec3 m_321027_(double p_335302_, double p_334829_, double p_334312_, float p_331363_, float p_330173_) {
    ...
    public void shoot(double pX, double pY, double pZ, float pVelocity, float pInaccuracy) {
        Vec3 vec3 = this.m_321027_(pX, pY, pZ, pVelocity, pInaccuracy);
    ...
    protected ProjectileDeflection m_320847_(HitResult p_329816_) {
        if (p_329816_.getType() == HitResult.Type.ENTITY) {
            EntityHitResult entityhitresult = (EntityHitResult)p_329816_;
            ProjectileDeflection projectiledeflection = entityhitresult.getEntity().m_321219_(this);
            if (projectiledeflection != ProjectileDeflection.f_316951_) {
                this.m_318938_(projectiledeflection, entityhitresult.getEntity(), this.getOwner(), false);
                return projectiledeflection;
            }
        }

        this.onHit(p_329816_);
        return ProjectileDeflection.f_316951_;
    }

    public void m_318938_(ProjectileDeflection p_328550_, @Nullable Entity p_330074_, @Nullable Entity p_333528_, boolean p_328333_) {
        if (!this.level().isClientSide) {
            p_328550_.m_322705_(this, p_330074_, this.random);
            this.setOwner(p_333528_);
            this.m_318614_(p_330074_, p_328333_);
        }
    }

    protected void m_318614_(@Nullable Entity p_327965_, boolean p_335911_) {
    }
    ...
    protected void onHit(HitResult pResult) {
        ...
        if (hitresult$type == HitResult.Type.ENTITY) {
            ...
            if (entity.getType().is(EntityTypeTags.f_314896_) && entity instanceof Projectile projectile) {
                projectile.m_318938_(ProjectileDeflection.f_314043_, this.getOwner(), this.getOwner(), true);
            }
            ...
            this.level().m_322719_(GameEvent.PROJECTILE_LAND, blockpos, GameEvent.Context.of(this, this.level().getBlockState(blockpos)));
        }
    }
    ...
    public boolean m_305640_(Level p_313184_) {
        return this.getType().is(EntityTypeTags.IMPACT_PROJECTILES) && p_313184_.getGameRules().getBoolean(GameRules.f_302210_);
    }
