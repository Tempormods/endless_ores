...
public class CaveSpider extends Spider {
    ...
    @Override
    public Vec3 m_320507_(Entity p_329499_) {
        return p_329499_.getBbWidth() <= this.getBbWidth() ? new Vec3(0.0, 0.21875 * (double)this.getScale(), 0.0) : super.m_320507_(p_329499_);
    }
}