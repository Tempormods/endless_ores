...
public class Panda extends Animal {
    ...
    private static final EntityDimensions f_316579_ = EntityType.PANDA
        .getDimensions()
        .scale(0.5F)
        .m_323271_(EntityAttachments.m_321590_().m_322342_(EntityAttachment.PASSENGER, 0.0F, 0.40625F, 0.0F));
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_336304_) {
        ...
        p_336304_.m_318949_(UNHAPPY_COUNTER, 0);
        p_336304_.m_318949_(SNEEZE_COUNTER, 0);
        p_336304_.m_318949_(MAIN_GENE_ID, (byte)0);
        p_336304_.m_318949_(HIDDEN_GENE_ID, (byte)0);
        p_336304_.m_318949_(DATA_ID_FLAGS, (byte)0);
        p_336304_.m_318949_(EAT_COUNTER, 0);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.0, p_326978_ -> p_326978_.is(ItemTags.f_316653_), false));
    ...
    private void afterSneeze() {
        ...
        if (!level.isClientSide() && level.getGameRules().getBoolean(GameRules.RULE_DOMOBLOOT)) {
            ...
            LootTable loottable = serverlevel.getServer().m_323018_().m_321428_(BuiltInLootTables.f_315803_);
    ...
    public InteractionResult mobInteract(Player pPlayer, InteractionHand pHand) {
        ...
        if (this.isScared()) {
            ...
            if (this.isBaby()) {
                ...
                if (!itemstack1.isEmpty() && !pPlayer.m_322042_()) {
                    this.spawnAtLocation(itemstack1);
                }

                this.m_21035_(EquipmentSlot.MAINHAND, new ItemStack(itemstack.getItem(), 1));
                this.usePlayerItem(pPlayer, pHand, itemstack);
            }
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_316653_);
    }
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_330547_) {
        return this.isBaby() ? f_316579_ : super.m_31586_(p_330547_);
    }
    ...
    class PandaSitGoal extends Goal {
        ...
        public void stop() {
            ...
            if (!itemstack.isEmpty()) {
                ...
                Panda.this.m_21035_(EquipmentSlot.MAINHAND, ItemStack.EMPTY);
