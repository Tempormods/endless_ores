...
public class Dolphin extends WaterAnimal {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_330794_) {
        ...
        p_330794_.m_318949_(TREASURE_POS, BlockPos.ZERO);
        p_330794_.m_318949_(GOT_FISH, false);
        p_330794_.m_318949_(MOISTNESS_LEVEL, 2400);
    }
    ...
    class PlayWithItemsGoal extends Goal {
        ...
        public void stop() {
            ...
            if (!itemstack.isEmpty()) {
                this.drop(itemstack);
                Dolphin.this.m_21035_(EquipmentSlot.MAINHAND, ItemStack.EMPTY);
