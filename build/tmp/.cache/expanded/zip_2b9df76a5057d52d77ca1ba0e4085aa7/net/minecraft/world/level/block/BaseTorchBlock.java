...
public abstract class BaseTorchBlock extends Block {
    protected static final int f_303789_ = 2;
    protected static final VoxelShape f_303109_ = Block.box(6.0, 0.0, 6.0, 10.0, 10.0, 10.0);
    ...
    @Override
    protected abstract MapCodec<? extends BaseTorchBlock> m_304657_();
