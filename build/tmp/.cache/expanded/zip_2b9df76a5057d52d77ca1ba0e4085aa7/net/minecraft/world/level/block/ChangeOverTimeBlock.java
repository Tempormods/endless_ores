...
public interface ChangeOverTimeBlock<T extends Enum<T>> {
    ...
    default void m_306166_(BlockState p_311790_, ServerLevel p_309416_, BlockPos p_310092_, RandomSource p_310572_) {
        float f = 0.05688889F;
        if (p_310572_.nextFloat() < 0.05688889F) {
            this.m_305709_(p_311790_, p_309416_, p_310092_, p_310572_).ifPresent(p_153039_ -> p_309416_.setBlockAndUpdate(p_310092_, p_153039_));
        }
    }

    T getAge();

    default Optional<BlockState> m_305709_(BlockState p_311503_, ServerLevel p_311331_, BlockPos p_309459_, RandomSource p_312041_) {
