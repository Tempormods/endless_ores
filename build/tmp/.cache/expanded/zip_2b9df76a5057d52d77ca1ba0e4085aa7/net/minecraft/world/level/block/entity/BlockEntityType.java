...
public class BlockEntityType<T extends BlockEntity> {
    ...
    public static final BlockEntityType<CrafterBlockEntity> f_302698_ = register(
        "crafter", BlockEntityType.Builder.of(CrafterBlockEntity::new, Blocks.f_303044_)
    );
    public static final BlockEntityType<TrialSpawnerBlockEntity> f_303206_ = register(
        "trial_spawner", BlockEntityType.Builder.of(TrialSpawnerBlockEntity::new, Blocks.f_302964_)
    );
    public static final BlockEntityType<VaultBlockEntity> f_316672_ = register(
        "vault", BlockEntityType.Builder.of(VaultBlockEntity::new, Blocks.f_316985_)
    );
