...
public final class BelowZeroRetrogen {
    ...
    private static final Codec<ChunkStatus> NON_EMPTY_CHUNK_STATUS = BuiltInRegistries.CHUNK_STATUS
        .byNameCodec()
        .comapFlatMap(
            p_327451_ -> p_327451_ == ChunkStatus.f_314297_
    ...
    public static BelowZeroRetrogen read(CompoundTag pTag) {
        ChunkStatus chunkstatus = ChunkStatus.m_322436_(pTag.getString("target_status"));
        return chunkstatus == ChunkStatus.f_314297_
            ? null
