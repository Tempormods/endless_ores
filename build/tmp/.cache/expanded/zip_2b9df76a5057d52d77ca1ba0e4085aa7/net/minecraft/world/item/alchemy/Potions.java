...
public class Potions {
    ...
    public static final Holder<Potion> f_313979_ = register(
        "wind_charged", new Potion("wind_charged", new MobEffectInstance(MobEffects.f_316711_, 3600)).m_319158_(FeatureFlags.f_302467_)
    );
    public static final Holder<Potion> f_314032_ = register(
        "weaving", new Potion("weaving", new MobEffectInstance(MobEffects.f_315811_, 3600)).m_319158_(FeatureFlags.f_302467_)
    );
    public static final Holder<Potion> f_316406_ = register(
        "oozing", new Potion("oozing", new MobEffectInstance(MobEffects.f_314285_, 3600)).m_319158_(FeatureFlags.f_302467_)
    );
    public static final Holder<Potion> f_315215_ = register(
        "infested", new Potion("infested", new MobEffectInstance(MobEffects.f_316729_, 3600)).m_319158_(FeatureFlags.f_302467_)
    );

    private static Holder<Potion> register(String pKey, Potion pPotion) {
        return Registry.registerForHolder(BuiltInRegistries.POTION, new ResourceLocation(pKey), pPotion);
    }

    public static Holder<Potion> m_324006_(Registry<Potion> p_334005_) {
        return WATER;
    }
}