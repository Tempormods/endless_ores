...
public interface StructurePlacementType<SP extends StructurePlacement> {
    ...
    private static <SP extends StructurePlacement> StructurePlacementType<SP> register(String pName, MapCodec<SP> p_334756_) {
        return Registry.register(BuiltInRegistries.STRUCTURE_PLACEMENT, pName, () -> p_334756_);
    }
}