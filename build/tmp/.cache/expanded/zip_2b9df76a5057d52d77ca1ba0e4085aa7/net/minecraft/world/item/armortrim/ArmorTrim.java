...
public class ArmorTrim implements TooltipProvider {
    public static final Codec<ArmorTrim> CODEC = RecordCodecBuilder.create(
        p_327186_ -> p_327186_.group(
                    ...
                    Codec.BOOL.optionalFieldOf("show_in_tooltip", Boolean.valueOf(true)).forGetter(p_327187_ -> p_327187_.f_315497_)
                )
                .apply(p_327186_, ArmorTrim::new)
    );
    public static final StreamCodec<RegistryFriendlyByteBuf, ArmorTrim> f_317134_ = StreamCodec.m_321516_(
        TrimMaterial.f_314439_,
        ArmorTrim::material,
        TrimPattern.f_313913_,
        ArmorTrim::pattern,
        ByteBufCodecs.f_315514_,
        p_327185_ -> p_327185_.f_315497_,
        ArmorTrim::new
    );
    ...
    private final boolean f_315497_;
    ...
    public boolean equals(Object pOther) {
        return !(pOther instanceof ArmorTrim armortrim)
            ? false
            : this.f_315497_ == armortrim.f_315497_ && this.pattern.equals(armortrim.pattern) && this.material.equals(armortrim.material);
    }
    ...
    public int hashCode() {
        ...
        return 31 * i + (this.f_315497_ ? 1 : 0);
    }

    @Override
    public void m_319025_(Item.TooltipContext p_334801_, Consumer<Component> p_334147_, TooltipFlag p_329892_) {
        if (this.f_315497_) {
    ...
    public ArmorTrim m_323960_(boolean p_332005_) {
