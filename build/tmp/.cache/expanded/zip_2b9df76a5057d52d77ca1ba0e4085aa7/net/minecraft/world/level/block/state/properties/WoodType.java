...
public record WoodType(String name, BlockSetType setType, SoundType soundType, SoundType hangingSignSoundType, SoundEvent fenceGateClose, SoundEvent fenceGateOpen) {
    private static final Map<String, WoodType> f_303289_ = new Object2ObjectArrayMap<>();
    public static final Codec<WoodType> f_303492_ = Codec.stringResolver(WoodType::name, f_303289_::get);
    ...
    public static WoodType register(WoodType pWoodType) {
        f_303289_.put(pWoodType.name(), pWoodType);
        return pWoodType;
    }

    public static Stream<WoodType> values() {
        return f_303289_.values().stream();
    }
}