...
public class RootPlacerType<P extends RootPlacer> {
    ...
    private static <P extends RootPlacer> RootPlacerType<P> register(String pName, MapCodec<P> p_329098_) {
        return Registry.register(BuiltInRegistries.ROOT_PLACER_TYPE, pName, new RootPlacerType<>(p_329098_));
    }
