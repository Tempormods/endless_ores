...
public class Camel extends AbstractHorse implements PlayerRideableJumping, Saddleable {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return createBaseHorseAttributes()
            ...
            .add(Attributes.f_316806_, 1.5);
    }

    @Override
    protected void defineSynchedData(SynchedEntityData.Builder p_333728_) {
        super.defineSynchedData(p_333728_);
        p_333728_.m_318949_(DASH, false);
        p_333728_.m_318949_(LAST_POSE_CHANGE_TICK, 0L);
    }
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_329548_) {
        return p_329548_ == Pose.SITTING ? SITTING_DIMENSIONS.scale(this.m_320705_()) : super.m_31586_(p_329548_);
    }
    ...
    public void handleStartJump(int pJumpPower) {
        this.m_323137_(SoundEvents.CAMEL_DASH);
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_315451_);
    }
    ...
    protected Vec3 m_293035_(Entity pEntity, EntityDimensions pDimensions, float pScale) {
        ...
        return new Vec3(0.0, (double)f1, (double)(f * pScale)).yRot(-this.getYRot() * (float) (Math.PI / 180.0));
    }
    ...
    public void sitDown() {
        if (!this.isCamelSitting()) {
            this.m_323137_(SoundEvents.CAMEL_SIT);
            this.setPose(Pose.SITTING);
            this.gameEvent(GameEvent.ENTITY_ACTION);
    ...
    public void standUp() {
        if (this.isCamelSitting()) {
            this.m_323137_(SoundEvents.CAMEL_STAND);
