...
public interface PosRuleTestType<P extends PosRuleTest> {
    ...
    static <P extends PosRuleTest> PosRuleTestType<P> register(String pName, MapCodec<P> p_333241_) {
        return Registry.register(BuiltInRegistries.POS_RULE_TEST, pName, () -> p_333241_);
    }
}