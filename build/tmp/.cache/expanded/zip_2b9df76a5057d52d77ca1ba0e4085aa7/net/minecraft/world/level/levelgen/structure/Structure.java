...
public abstract class Structure {
    ...
    public static <S extends Structure> MapCodec<S> simpleCodec(Function<Structure.StructureSettings, S> pBuilder) {
        return RecordCodecBuilder.mapCodec(p_226611_ -> p_226611_.group(settingsCodec(p_226611_)).apply(p_226611_, pBuilder));
    }
    ...
    public static int m_322611_(Structure.GenerationContext p_334739_, int p_329786_, int p_332089_, int p_333818_, int p_333198_) {
