...
public abstract class LootPoolEntryContainer implements ComposableEntryContainer {
    ...
    protected LootPoolEntryContainer(List<LootItemCondition> pConditions) {
        ...
        this.compositeCondition = Util.m_322468_(pConditions);
    }

    protected static <T extends LootPoolEntryContainer> P1<Mu<T>, List<LootItemCondition>> commonFields(Instance<T> pInstance) {
        return pInstance.group(LootItemConditions.f_317075_.listOf().optionalFieldOf("conditions", List.of()).forGetter(p_297410_ -> p_297410_.conditions));
    }
