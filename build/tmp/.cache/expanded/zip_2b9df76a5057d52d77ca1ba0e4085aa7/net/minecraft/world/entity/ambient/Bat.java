...
public class Bat extends AmbientCreature {
    public static final float f_302275_ = 0.5F;
    ...
    public final AnimationState f_302314_ = new AnimationState();
    public final AnimationState f_303573_ = new AnimationState();
    @Nullable
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_332675_) {
        ...
        p_332675_.m_318949_(DATA_ID_FLAGS, (byte)0);
    }
    ...
    private void m_307759_() {
        if (this.isResting()) {
            this.f_302314_.stop();
            this.f_303573_.startIfStopped(this.tickCount);
        } else {
            this.f_303573_.stop();
            this.f_302314_.startIfStopped(this.tickCount);
        }
    }
}