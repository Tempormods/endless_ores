...
public class MemoryModuleType<U> {
    ...
    public static final MemoryModuleType<Boolean> f_315790_ = register("danger_detected_recently", Codec.BOOL);
    ...
    public static final MemoryModuleType<Unit> f_303679_ = register("breeze_jump_cooldown", Codec.unit(Unit.INSTANCE));
    public static final MemoryModuleType<Unit> f_302834_ = register("breeze_shoot", Codec.unit(Unit.INSTANCE));
    public static final MemoryModuleType<Unit> f_303467_ = register("breeze_shoot_charging", Codec.unit(Unit.INSTANCE));
    public static final MemoryModuleType<Unit> f_302770_ = register("breeze_shoot_recover", Codec.unit(Unit.INSTANCE));
    public static final MemoryModuleType<Unit> f_302656_ = register("breeze_shoot_cooldown", Codec.unit(Unit.INSTANCE));
    public static final MemoryModuleType<Unit> f_302823_ = register("breeze_jump_inhaling", Codec.unit(Unit.INSTANCE));
    public static final MemoryModuleType<BlockPos> f_303370_ = register("breeze_jump_target", BlockPos.CODEC);
    public static final MemoryModuleType<Unit> f_315858_ = register("breeze_leaving_water", Codec.unit(Unit.INSTANCE));
