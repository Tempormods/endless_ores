...
public class TransparentBlock extends HalfTransparentBlock {
    public static final MapCodec<TransparentBlock> f_302611_ = m_306223_(TransparentBlock::new);
    ...
    @Override
    protected MapCodec<? extends TransparentBlock> m_304657_() {
        return f_302611_;
    }
    ...
    @Override
    protected boolean m_49099_(BlockState p_312717_, BlockGetter p_312877_, BlockPos p_312899_) {
        return true;
    }
}