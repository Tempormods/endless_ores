...
public class DecoratedPotPatterns {
    ...
    private static final String f_313998_ = "flow_pottery_pattern";
    private static final String FRIEND_NAME = "friend_pottery_pattern";
    private static final String f_314610_ = "guster_pottery_pattern";
    ...
    private static final String f_314185_ = "scrape_pottery_pattern";
    ...
    private static final ResourceKey<String> f_314241_ = create("flow_pottery_pattern");
    private static final ResourceKey<String> FRIEND = create("friend_pottery_pattern");
    private static final ResourceKey<String> f_316920_ = create("guster_pottery_pattern");
    ...
    private static final ResourceKey<String> f_315884_ = create("scrape_pottery_pattern");
    ...
    private static final Map<Item, ResourceKey<String>> ITEM_TO_POT_TEXTURE = Map.ofEntries(
        ...
        Map.entry(Items.f_314824_, f_314241_),
        Map.entry(Items.FRIEND_POTTERY_SHERD, FRIEND),
        Map.entry(Items.f_316059_, f_316920_),
        ...
        Map.entry(Items.f_315489_, f_315884_),
    ...
    public static String bootstrap(Registry<String> pRegistry) {
        ...
        Registry.register(pRegistry, f_314241_, "flow_pottery_pattern");
        Registry.register(pRegistry, FRIEND, "friend_pottery_pattern");
        Registry.register(pRegistry, f_316920_, "guster_pottery_pattern");
        ...
        Registry.register(pRegistry, f_315884_, "scrape_pottery_pattern");
