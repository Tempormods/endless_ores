...
public class BuiltInLootTables {
    ...
    public static final ResourceKey<LootTable> EMPTY = ResourceKey.create(Registries.f_314309_, new ResourceLocation("empty"));
    ...
    public static final ResourceKey<LootTable> f_303517_ = register("chests/trial_chambers/reward");
    public static final ResourceKey<LootTable> f_315207_ = register("chests/trial_chambers/reward_common");
    public static final ResourceKey<LootTable> f_315354_ = register("chests/trial_chambers/reward_rare");
    public static final ResourceKey<LootTable> f_314271_ = register("chests/trial_chambers/reward_unique");
    public static final ResourceKey<LootTable> f_315697_ = register("chests/trial_chambers/reward_ominous");
    public static final ResourceKey<LootTable> f_315306_ = register("chests/trial_chambers/reward_ominous_common");
    public static final ResourceKey<LootTable> f_315822_ = register("chests/trial_chambers/reward_ominous_rare");
    public static final ResourceKey<LootTable> f_315133_ = register("chests/trial_chambers/reward_ominous_unique");
    public static final ResourceKey<LootTable> f_303341_ = register("chests/trial_chambers/supply");
    public static final ResourceKey<LootTable> f_302226_ = register("chests/trial_chambers/corridor");
    public static final ResourceKey<LootTable> f_302884_ = register("chests/trial_chambers/intersection");
    public static final ResourceKey<LootTable> f_302208_ = register("chests/trial_chambers/intersection_barrel");
    public static final ResourceKey<LootTable> f_303376_ = register("chests/trial_chambers/entrance");
    public static final ResourceKey<LootTable> f_302850_ = register("dispensers/trial_chambers/corridor");
    public static final ResourceKey<LootTable> f_303584_ = register("dispensers/trial_chambers/chamber");
    public static final ResourceKey<LootTable> f_303173_ = register("dispensers/trial_chambers/water");
    public static final ResourceKey<LootTable> f_302648_ = register("pots/trial_chambers/corridor");
    public static final ResourceKey<LootTable> f_315649_ = register("equipment/trial_chamber");
    public static final ResourceKey<LootTable> f_315117_ = register("equipment/trial_chamber_ranged");
    public static final ResourceKey<LootTable> f_316828_ = register("equipment/trial_chamber_melee");
    ...
    public static final ResourceKey<LootTable> f_315803_ = register("gameplay/panda_sneeze");
    public static final ResourceKey<LootTable> PIGLIN_BARTERING = register("gameplay/piglin_bartering");
    public static final ResourceKey<LootTable> f_303815_ = register("spawners/trial_chamber/key");
    public static final ResourceKey<LootTable> f_303325_ = register("spawners/trial_chamber/consumables");
    public static final ResourceKey<LootTable> f_316043_ = register("spawners/ominous/trial_chamber/key");
    public static final ResourceKey<LootTable> f_316831_ = register("spawners/ominous/trial_chamber/consumables");
    public static final ResourceKey<LootTable> f_315958_ = register("spawners/trial_chamber/items_to_drop_when_ominous");
    public static final ResourceKey<LootTable> f_315144_ = register("shearing/bogged");
    ...
    private static ResourceKey<LootTable> register(String pId) {
        return register(ResourceKey.create(Registries.f_314309_, new ResourceLocation(pId)));
    }
