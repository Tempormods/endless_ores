        ...
        if (this.isNearPlayer(pServerLevel, pPos)) {
            ...
            if (this.spawnDelay > 0) {
                ...
                for (int i = 0; i < this.spawnCount; i++) {
                    ...
                    if (pServerLevel.noCollision(optional.get().m_319702_(d0, d1, d2))) {
                        ...
                        if (spawndata.getCustomSpawnRules().isPresent()) {
                            ...
                            if (!spawndata$customspawnrules.m_320581_(blockpos, pServerLevel)) {
                                continue;
                            }
                        ...
                        int k = pServerLevel.getEntities(
                                EntityTypeTest.m_305763_(entity.getClass()),
                                new AABB(
                                        (double)pPos.getX(),
                                        (double)pPos.getY(),
                                        (double)pPos.getZ(),
