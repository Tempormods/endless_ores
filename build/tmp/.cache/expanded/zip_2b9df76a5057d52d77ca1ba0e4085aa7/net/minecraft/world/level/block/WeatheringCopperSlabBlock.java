...
public class WeatheringCopperSlabBlock extends SlabBlock implements WeatheringCopper {
    public static final MapCodec<WeatheringCopperSlabBlock> f_303481_ = RecordCodecBuilder.mapCodec(
        p_311462_ -> p_311462_.group(WeatheringCopper.WeatherState.f_302372_.fieldOf("weathering_state").forGetter(ChangeOverTimeBlock::getAge), m_305607_())
                .apply(p_311462_, WeatheringCopperSlabBlock::new)
    );
    private final WeatheringCopper.WeatherState weatherState;

    @Override
    public MapCodec<WeatheringCopperSlabBlock> m_304657_() {
        return f_303481_;
    }
