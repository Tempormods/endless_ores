...
public class FlatLevelGeneratorPresets {
    ...
    static class Bootstrap {
        ...
        private void register(
            ...
            HolderGetter<StructureSet> holdergetter = this.context.m_255434_(Registries.STRUCTURE_SET);
            HolderGetter<PlacedFeature> holdergetter1 = this.context.m_255434_(Registries.PLACED_FEATURE);
            HolderGetter<Biome> holdergetter2 = this.context.m_255434_(Registries.BIOME);
            ...
            this.context.m_321889_(pPresetKey, new FlatLevelGeneratorPreset(pDisplayItem.asItem().builtInRegistryHolder(), flatlevelgeneratorsettings));
        }
