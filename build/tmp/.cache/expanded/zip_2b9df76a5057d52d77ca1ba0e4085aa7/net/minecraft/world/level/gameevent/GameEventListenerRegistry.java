...
public interface GameEventListenerRegistry {
    ...
    boolean visitInRangeListeners(Holder<GameEvent> p_328591_, Vec3 pPos, GameEvent.Context pContext, GameEventListenerRegistry.ListenerVisitor pListenerVisitor);
