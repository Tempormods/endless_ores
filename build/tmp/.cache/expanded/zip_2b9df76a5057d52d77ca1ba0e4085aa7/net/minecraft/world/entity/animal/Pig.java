...
public class Pig extends Animal implements ItemSteerable, Saddleable {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.2, p_332514_ -> p_332514_.is(ItemTags.f_314144_), false));
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_335143_) {
        ...
        p_335143_.m_318949_(DATA_SADDLE_ID, false);
        p_335143_.m_318949_(DATA_BOOST_TIME, 0);
    }
    ...
    public void thunderHit(ServerLevel pLevel, LightningBolt pLightning) {
        if (pLevel.getDifficulty() != Difficulty.PEACEFUL && net.minecraftforge.event.ForgeEventFactory.canLivingConvert(this, EntityType.ZOMBIFIED_PIGLIN, (timer) -> {})) {
            ...
            if (zombifiedpiglin != null) {
                zombifiedpiglin.m_21035_(EquipmentSlot.MAINHAND, new ItemStack(Items.GOLDEN_SWORD));
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_314144_);
    }
