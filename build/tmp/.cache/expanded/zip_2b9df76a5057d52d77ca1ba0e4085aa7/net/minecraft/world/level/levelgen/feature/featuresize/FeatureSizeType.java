...
public class FeatureSizeType<P extends FeatureSize> {
    ...
    private static <P extends FeatureSize> FeatureSizeType<P> register(String pName, MapCodec<P> p_335596_) {
        return Registry.register(BuiltInRegistries.FEATURE_SIZE_TYPE, pName, new FeatureSizeType<>(p_335596_));
    }
