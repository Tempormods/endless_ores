...
public class SensorType<U extends Sensor<?>> {
    ...
    public static final SensorType<MobSensor<Armadillo>> f_315808_ = register(
        "armadillo_scare_detected", () -> new MobSensor<>(5, Armadillo::m_318898_, Armadillo::m_323949_, MemoryModuleType.f_315790_, 80)
    );
    ...
    public static final SensorType<TemptingSensor> f_316993_ = register("armadillo_temptations", () -> new TemptingSensor(ArmadilloAi.m_323902_()));
    ...
    public static final SensorType<BreezeAttackEntitySensor> f_302610_ = register("breeze_attack_entity_sensor", BreezeAttackEntitySensor::new);
