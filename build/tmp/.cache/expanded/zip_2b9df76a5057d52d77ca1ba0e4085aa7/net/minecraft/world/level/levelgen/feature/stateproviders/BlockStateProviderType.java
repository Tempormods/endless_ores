...
public class BlockStateProviderType<P extends BlockStateProvider> {
    ...
    private static <P extends BlockStateProvider> BlockStateProviderType<P> register(String pName, MapCodec<P> p_334907_) {
        return Registry.register(BuiltInRegistries.BLOCKSTATE_PROVIDER_TYPE, pName, new BlockStateProviderType<>(p_334907_));
    }
