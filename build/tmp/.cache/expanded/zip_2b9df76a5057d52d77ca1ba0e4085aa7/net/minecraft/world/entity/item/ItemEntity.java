...
public class ItemEntity extends Entity implements TraceableEntity {
    ...
    private static final float f_315581_ = 0.1F;
    public static final float f_316032_ = 0.2125F;
    ...
    public Entity getOwner() {
        if (this.f_302454_ != null && !this.f_302454_.isRemoved()) {
            return this.f_302454_;
        } else if (this.thrower != null && this.level() instanceof ServerLevel serverlevel) {
            this.f_302454_ = serverlevel.getEntity(this.thrower);
            return this.f_302454_;
        } else {
            return null;
        }
    ...
    public void restoreFrom(Entity p_309647_) {
        ...
        if (p_309647_ instanceof ItemEntity itementity) {
            this.f_302454_ = itementity.f_302454_;
        }
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_332164_) {
        p_332164_.m_318949_(DATA_ITEM, ItemStack.EMPTY);
    }
    ...
    public static boolean areMergable(ItemStack pDestinationStack, ItemStack pOriginStack) {
        return pOriginStack.getCount() + pDestinationStack.getCount() > pOriginStack.getMaxStackSize() ? false : ItemStack.m_322370_(pDestinationStack, pOriginStack);
    }
    ...
    public boolean fireImmune() {
        return this.getItem().m_319951_(DataComponents.f_315720_) || super.fireImmune();
    }
    ...
    public boolean hurt(DamageSource pSource, float pAmount) {
        if (this.isInvulnerableTo(pSource)) {
            ...
            return false;
        } else if (!this.getItem().m_325012_(pSource)) {
            return false;
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (pCompound.contains("Item", 10)) {
            ...
            this.setItem(ItemStack.m_323951_(this.m_321891_(), compoundtag).orElse(ItemStack.EMPTY));
        } else {
    ...
    public SlotAccess getSlot(int p_329686_) {
        return p_329686_ == 0 ? SlotAccess.m_320701_(this::getItem, this::setItem) : super.getSlot(p_329686_);
    }
}
