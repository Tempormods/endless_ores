...
public class LootContext {
    ...
    LootContext(LootParams pParams, RandomSource pRandom, HolderGetter.Provider p_330439_) {
        this(pParams, pRandom, p_330439_, null);
    }

    LootContext(LootParams pParams, RandomSource pRandom, HolderGetter.Provider p_330439_, ResourceLocation queriedLootTableId) {
        this.params = pParams;
        this.random = pRandom;
    ...
    public static class Builder {
        ...
        public LootContext create(Optional<ResourceLocation> pSequence) {
            ...
            return new LootContext(this.params, randomsource, minecraftserver.m_323018_().m_319537_(), queriedLootTableId);
        }
    }
