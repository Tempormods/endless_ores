...
public interface StructureType<S extends Structure> {
    ...
    private static <S extends Structure> StructureType<S> register(String pName, MapCodec<S> p_332361_) {
        return Registry.register(BuiltInRegistries.STRUCTURE_TYPE, pName, () -> p_332361_);
    }
}