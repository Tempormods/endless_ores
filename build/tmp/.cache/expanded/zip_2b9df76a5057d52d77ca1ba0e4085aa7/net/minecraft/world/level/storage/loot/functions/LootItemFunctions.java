...
public class LootItemFunctions {
    ...
    public static final Codec<LootItemFunction> f_314213_ = Codec.lazyInitialized(() -> Codec.withAlternative(TYPED_CODEC, SequenceFunction.INLINE_CODEC));
    public static final Codec<Holder<LootItemFunction>> CODEC = RegistryFileCodec.create(Registries.f_316898_, f_314213_);
    public static final LootItemFunctionType<SetItemCountFunction> SET_COUNT = register("set_count", SetItemCountFunction.CODEC);
    public static final LootItemFunctionType<SetItemFunction> f_314595_ = register("set_item", SetItemFunction.f_316876_);
    ...
    public static final LootItemFunctionType<SetCustomDataFunction> f_316637_ = register("set_custom_data", SetCustomDataFunction.f_314300_);
    public static final LootItemFunctionType<SetComponentsFunction> f_316980_ = register("set_components", SetComponentsFunction.f_315423_);
    ...
    public static final LootItemFunctionType<ModifyContainerContents> f_314745_ = register("modify_contents", ModifyContainerContents.f_315705_);
    public static final LootItemFunctionType<FilteredFunction> f_316507_ = register("filtered", FilteredFunction.f_314216_);
    ...
    public static final LootItemFunctionType<CopyCustomDataFunction> f_315380_ = register("copy_custom_data", CopyCustomDataFunction.f_314264_);
    ...
    public static final LootItemFunctionType<CopyComponentsFunction> f_315087_ = register("copy_components", CopyComponentsFunction.f_315830_);
    public static final LootItemFunctionType<SetFireworksFunction> f_315674_ = register("set_fireworks", SetFireworksFunction.f_316516_);
    public static final LootItemFunctionType<SetFireworkExplosionFunction> f_314869_ = register(
        "set_firework_explosion", SetFireworkExplosionFunction.f_316365_
    );
    public static final LootItemFunctionType<SetBookCoverFunction> f_315027_ = register("set_book_cover", SetBookCoverFunction.f_314861_);
    public static final LootItemFunctionType<SetWrittenBookPagesFunction> f_316039_ = register("set_written_book_pages", SetWrittenBookPagesFunction.f_315235_);
    public static final LootItemFunctionType<SetWritableBookPagesFunction> f_315246_ = register(
        "set_writable_book_pages", SetWritableBookPagesFunction.f_314814_
    );
    public static final LootItemFunctionType<ToggleTooltips> f_316954_ = register("toggle_tooltips", ToggleTooltips.f_315888_);
    public static final LootItemFunctionType<SetOminousBottleAmplifierFunction> f_316756_ = register(
        "set_ominous_bottle_amplifier", SetOminousBottleAmplifierFunction.f_315471_
    );
    public static final LootItemFunctionType<SetCustomModelDataFunction> f_316565_ = register("set_custom_model_data", SetCustomModelDataFunction.f_315713_);

    private static <T extends LootItemFunction> LootItemFunctionType<T> register(String pId, MapCodec<T> p_329222_) {
        return Registry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, new ResourceLocation(pId), new LootItemFunctionType<>(p_329222_));
    }
