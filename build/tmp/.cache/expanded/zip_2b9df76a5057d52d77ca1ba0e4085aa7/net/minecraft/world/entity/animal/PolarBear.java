...
public class PolarBear extends Animal implements NeutralMob {
    ...
    protected void playWarningSound() {
        if (this.warningSoundTicks <= 0) {
            this.m_323137_(SoundEvents.POLAR_BEAR_WARNING);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_335689_) {
        ...
        p_335689_.m_318949_(DATA_STANDING_ID, false);
    }
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_327808_) {
        if (this.clientSideStandAnimation > 0.0F) {
            float f = this.clientSideStandAnimation / 6.0F;
            float f1 = 1.0F + f;
            return super.m_31586_(p_327808_).scale(1.0F, f1);
        } else {
            return super.m_31586_(p_327808_);
        }
    }
