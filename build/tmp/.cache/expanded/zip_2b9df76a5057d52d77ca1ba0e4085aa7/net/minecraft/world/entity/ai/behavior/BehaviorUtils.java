...
public class BehaviorUtils {
    ...
    public static void lockGazeAndWalkToEachOther(LivingEntity pFirstEntity, LivingEntity pSecondEntity, float pSpeed, int p_332499_) {
        lookAtEachOther(pFirstEntity, pSecondEntity);
        setWalkAndLookTargetMemoriesToEachOther(pFirstEntity, pSecondEntity, pSpeed, p_332499_);
    }
    ...
    private static void setWalkAndLookTargetMemoriesToEachOther(LivingEntity pFirstEntity, LivingEntity pSecondEntity, float pSpeed, int p_332586_) {
        setWalkAndLookTargetMemories(pFirstEntity, pSecondEntity, pSpeed, p_332586_);
        setWalkAndLookTargetMemories(pSecondEntity, pFirstEntity, pSpeed, p_332586_);
    }
