...
public record SpawnData(CompoundTag entityToSpawn, Optional<SpawnData.CustomSpawnRules> customSpawnRules, Optional<EquipmentTable> f_315543_) {
    ...
    public static final Codec<SpawnData> CODEC = RecordCodecBuilder.create(
        p_327238_ -> p_327238_.group(
                    ...
                    EquipmentTable.f_313947_.optionalFieldOf("equipment").forGetter(p_327239_ -> p_327239_.f_315543_)
                )
    ...
    public SpawnData(CompoundTag entityToSpawn, Optional<SpawnData.CustomSpawnRules> customSpawnRules, Optional<EquipmentTable> f_315543_) {
    ...
    public Optional<EquipmentTable> m_318950_() {
        return this.f_315543_;
    }
    ...
    public static record CustomSpawnRules(InclusiveRange<Integer> blockLightLimit, InclusiveRange<Integer> skyLightLimit) {
        ...
        public boolean m_320581_(BlockPos p_327859_, ServerLevel p_328424_) {
