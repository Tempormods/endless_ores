...
public class DefaultAttributes {
    ...
    private static final Map<EntityType<? extends LivingEntity>, AttributeSupplier> SUPPLIERS = ImmutableMap.<EntityType<? extends LivingEntity>, AttributeSupplier>builder()
        ...
        .put(EntityType.f_316265_, Armadillo.m_324717_().build())
        .put(EntityType.ARMOR_STAND, ArmorStand.m_321608_().build())
        ...
        .put(EntityType.f_316281_, Bogged.m_321579_().build())
        ...
        .put(EntityType.DROWNED, Drowned.m_320431_().build())
        ...
        .put(EntityType.f_302782_, Breeze.m_307321_().build())
