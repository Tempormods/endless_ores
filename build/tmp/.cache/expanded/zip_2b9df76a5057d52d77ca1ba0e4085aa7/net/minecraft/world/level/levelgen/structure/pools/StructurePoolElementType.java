...
public interface StructurePoolElementType<P extends StructurePoolElement> {
    ...
    static <P extends StructurePoolElement> StructurePoolElementType<P> register(String pName, MapCodec<P> p_327687_) {
        return Registry.register(BuiltInRegistries.STRUCTURE_POOL_ELEMENT, pName, () -> p_327687_);
    }
}