...
public class Hoglin extends Animal implements Enemy, HoglinBase {
    ...
    public boolean doHurtTarget(Entity pEntity) {
        if (!(pEntity instanceof LivingEntity)) {
            ...
            this.m_323137_(SoundEvents.HOGLIN_ATTACK);
    ...
    protected void customServerAiStep() {
        ...
        if (this.isConverting()) {
            ...
            if (this.timeInOverworld > 300 && net.minecraftforge.event.ForgeEventFactory.canLivingConvert(this, EntityType.ZOGLIN, (timer) -> this.timeInOverworld = timer)) {
                this.m_323137_(SoundEvents.HOGLIN_CONVERTED_TO_ZOMBIFIED);
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_315349_);
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_331635_) {
        ...
        p_331635_.m_318949_(DATA_IMMUNE_TO_ZOMBIFICATION, false);
    }
