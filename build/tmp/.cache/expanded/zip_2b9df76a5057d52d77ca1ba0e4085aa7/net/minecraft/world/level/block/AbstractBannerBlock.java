...
public abstract class AbstractBannerBlock extends BaseEntityBlock {
    ...
    @Override
    protected abstract MapCodec<? extends AbstractBannerBlock> m_304657_();
    ...
    @Override
    public ItemStack getCloneItemStack(LevelReader p_313098_, BlockPos pPos, BlockState pState) {
        return p_313098_.getBlockEntity(pPos) instanceof BannerBlockEntity bannerblockentity
            ? bannerblockentity.getItem()
            : super.getCloneItemStack(p_313098_, pPos, pState);
    }
