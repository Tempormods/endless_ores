...
public class WetSpongeBlock extends Block {
    public static final MapCodec<WetSpongeBlock> f_302615_ = m_306223_(WetSpongeBlock::new);

    @Override
    public MapCodec<WetSpongeBlock> m_304657_() {
        return f_302615_;
    }
    ...
    protected void onPlace(BlockState pState, Level pLevel, BlockPos pPos, BlockState pOldState, boolean pIsMoving) {
        if (pLevel.dimensionType().ultraWarm()) {
            ...
            pLevel.playSound(null, pPos, SoundEvents.f_317042_, SoundSource.BLOCKS, 1.0F, (1.0F + pLevel.getRandom().nextFloat() * 0.2F) * 0.7F);
        }
    }
