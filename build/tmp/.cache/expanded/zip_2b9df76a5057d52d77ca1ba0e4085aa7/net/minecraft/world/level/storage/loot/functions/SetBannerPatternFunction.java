...
public class SetBannerPatternFunction extends LootItemConditionalFunction {
    public static final MapCodec<SetBannerPatternFunction> CODEC = RecordCodecBuilder.mapCodec(
        p_327589_ -> commonFields(p_327589_)
                .and(
                    p_327589_.group(
                        BannerPatternLayers.f_315309_.fieldOf("patterns").forGetter(p_327588_ -> p_327588_.patterns),
    ...
    protected ItemStack run(ItemStack pStack, LootContext pContext) {
        if (this.append) {
            pStack.m_324919_(
                ...
                this.patterns,
                (p_327586_, p_327587_) -> new BannerPatternLayers.Builder().m_322919_(p_327586_).m_322919_(p_327587_).m_319179_()
            );
        } else {
            pStack.m_322496_(DataComponents.f_314522_, this.patterns);
        }
    ...
    public static class Builder extends LootItemConditionalFunction.Builder<SetBannerPatternFunction.Builder> {
        ...
        public LootItemFunction build() {
            return new SetBannerPatternFunction(this.getConditions(), this.patterns.m_319179_(), this.append);
        }

        public SetBannerPatternFunction.Builder addPattern(Holder<BannerPattern> pPattern, DyeColor pColor) {
            this.patterns.m_318746_(pPattern, pColor);
            return this;
        }
    }
}