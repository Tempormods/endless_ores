...
public interface BlockPredicateType<P extends BlockPredicate> {
    ...
    private static <P extends BlockPredicate> BlockPredicateType<P> register(String pName, MapCodec<P> p_335919_) {
        return Registry.register(BuiltInRegistries.BLOCK_PREDICATE_TYPE, pName, () -> p_335919_);
    }
}