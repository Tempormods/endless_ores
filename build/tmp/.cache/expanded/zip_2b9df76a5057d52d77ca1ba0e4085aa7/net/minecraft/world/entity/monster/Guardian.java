...
public class Guardian extends Monster {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder p_332801_) {
        ...
        p_332801_.m_318949_(DATA_ID_MOVING, false);
        p_332801_.m_318949_(DATA_ID_ATTACK_TARGET, 0);
    }
    ...
    public static boolean checkGuardianSpawnRules(
        ...
        return (pRandom.nextInt(20) == 0 || !pLevel.canSeeSkyFromBelowWater(pPos))
            ...
            && (MobSpawnType.m_307588_(pSpawnType) || pLevel.getFluidState(pPos).is(FluidTags.WATER))
