...
public class Chicken extends Animal {
    private static final EntityDimensions f_316288_ = EntityType.CHICKEN.getDimensions().scale(0.5F).m_320568_(0.2975F);
    public float flap;
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.0, p_334579_ -> p_334579_.is(ItemTags.f_316289_), false));
    ...
    @Override
    public EntityDimensions m_31586_(Pose p_329747_) {
        return this.isBaby() ? f_316288_ : super.m_31586_(p_329747_);
    }
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ItemTags.f_316289_);
    }
