...
public abstract class LootItemConditionalFunction implements LootItemFunction {
    ...
    protected LootItemConditionalFunction(List<LootItemCondition> pPredicates) {
        ...
        this.compositePredicates = Util.m_322468_(pPredicates);
    }
    ...
    protected static <T extends LootItemConditionalFunction> P1<Mu<T>, List<LootItemCondition>> commonFields(Instance<T> p_298596_) {
        return p_298596_.group(LootItemConditions.f_317075_.listOf().optionalFieldOf("conditions", List.of()).forGetter(p_297561_ -> p_297561_.predicates));
    }
