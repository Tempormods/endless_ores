...
public class BrewingStandMenu extends AbstractContainerMenu {
    ...
    public BrewingStandMenu(int pContainerId, Inventory pPlayerInventory, Container pBrewingStandContainer, ContainerData pBrewingStandData) {
        ...
        PotionBrewing potionbrewing = pPlayerInventory.player.level().m_319308_();
    ...
    static class IngredientsSlot extends Slot {
        private final PotionBrewing f_313899_;

        public IngredientsSlot(PotionBrewing p_333610_, Container pContainer, int pSlot, int pX, int pY) {
            super(pContainer, pSlot, pX, pY);
            this.f_313899_ = p_333610_;
        }

        @Override
        public boolean mayPlace(ItemStack pStack) {
            return this.f_313899_.isIngredient(pStack);
        }
    }
    ...
    public static class PotionSlot extends Slot {
        ...
        public void onTake(Player pPlayer, ItemStack pStack) {
            Optional<Holder<Potion>> optional = pStack.m_322304_(DataComponents.f_314188_, PotionContents.f_313984_).f_317059_();
