...
public class GameTestServer extends MinecraftServer {
    ...
    private static final int f_303311_ = 14999992;
    private static final Services NO_SERVICES = new Services(null, ServicesKeySet.EMPTY, null, null);
    private final LocalSampleLogger f_313906_ = new LocalSampleLogger(4);
    private List<GameTestBatch> testBatches = new ArrayList<>();
    private final List<TestFunction> f_315109_;
    private final BlockPos spawnPos;
    private final Stopwatch f_315742_ = Stopwatch.createUnstarted();
    ...
    public GameTestServer(
        ...
        super(pServerThread, pStorageSource, pPackRepository, pWorldStem, Proxy.NO_PROXY, DataFixers.getDataFixer(), NO_SERVICES, LoggerChunkProgressListener::m_324668_);
        this.f_315109_ = Lists.newArrayList(pTestBatches);
    ...
    public boolean initServer() {
        ...
        this.testBatches = Lists.newArrayList(GameTestBatchFactory.m_325023_(this.f_315109_, serverlevel));
    ...
    public void tickServer(BooleanSupplier pHasTimeLeft) {
        ...
        if (this.testTracker.isDone()) {
            ...
            LOGGER.info("========= {} GAME TESTS COMPLETE IN {} ======================", this.testTracker.getTotalCount(), this.f_315742_.stop());
    ...
    @Override
    public SampleLogger m_318596_() {
        return this.f_313906_;
    }
    ...
    private void startTests(ServerLevel pServerLevel) {
        ...
        GameTestRunner gametestrunner = GameTestRunner.Builder.m_321232_(this.testBatches, pServerLevel)
            .m_322147_(new StructureGridSpawner(blockpos, 8))
            .m_322128_();
        Collection<GameTestInfo> collection = gametestrunner.m_320202_();
        ...
        this.f_315742_.reset();
        this.f_315742_.start();
        gametestrunner.m_323089_();
    }
