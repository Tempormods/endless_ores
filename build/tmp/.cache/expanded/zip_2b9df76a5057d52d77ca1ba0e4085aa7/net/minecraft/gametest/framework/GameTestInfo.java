...
public class GameTestInfo {
    ...
    private int f_302353_ = 20;
    private boolean f_303273_;
    private boolean f_303601_;
    private long tickCount;
    private boolean started;
    private final RetryOptions f_314573_;
    ...
    public GameTestInfo(TestFunction pFunction, Rotation pRotation, ServerLevel pServerLevel, RetryOptions p_328909_) {
        this.testFunction = pFunction;
        this.level = pServerLevel;
        this.f_314573_ = p_328909_;
        this.timeoutTicks = pFunction.maxTicks();
        this.rotation = pFunction.rotation().getRotated(pRotation);
    }
    ...
    public GameTestInfo m_322668_() {
        if (this.f_303273_) {
            ...
            structureblockentity.m_305508_(this.level);
    ...
    private boolean m_321951_() {
        if (this.f_303273_) {
            return true;
        } else if (this.f_302353_ > 0) {
            this.f_302353_--;
            return false;
        } else {
            this.m_322668_().startExecution(0);
            return true;
        }
    }
    ...
    public void tick(GameTestRunner p_334539_) {
        if (!this.isDone()) {
            ...
            if (this.f_303601_ || StructureUtils.getStructureBoundingBox(this.structureBlockEntity).m_306717_().allMatch(p_308533_ -> this.level.isPositionEntityTicking(p_308533_.getWorldPosition()))) {
                this.f_303601_ = true;
                if (this.m_321951_()) {
                    this.tickInternal();
                    if (this.isDone()) {
    ...
    public GameTestInfo m_306517_() {
        BlockPos blockpos = this.m_325039_();
        this.structureBlockEntity = StructureUtils.m_305479_(this, blockpos, this.getRotation(), this.level);
        ...
        StructureUtils.m_320357_(this.getStructureBounds(), this.level, !this.testFunction.f_314649_());
    ...
    public RetryOptions m_324328_() {
        return this.f_314573_;
    }

    public Stream<GameTestListener> m_324070_() {
        return this.listeners.stream();
    }

    public GameTestInfo m_325037_() {
        GameTestInfo gametestinfo = new GameTestInfo(this.testFunction, this.rotation, this.level, this.m_324328_());
        if (this.f_317131_ != null) {
            gametestinfo.m_322570_(this.f_317131_);
        }
    ...
    private BlockPos m_325039_() {
        if (this.f_317131_ == null) {
            BoundingBox boundingbox = StructureUtils.getStructureBoundingBox(this.getStructureBlockEntity());
            this.f_317131_ = new BlockPos(boundingbox.minX(), boundingbox.minY(), boundingbox.minZ());
        }

        return this.f_317131_;
    }

    public void m_322570_(BlockPos p_328918_) {
        this.f_317131_ = p_328918_;
    }
}