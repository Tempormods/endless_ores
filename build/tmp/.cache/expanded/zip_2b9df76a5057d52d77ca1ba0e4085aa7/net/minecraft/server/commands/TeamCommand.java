...
public class TeamCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> pDispatcher, CommandBuildContext p_335664_) {
    ...
    private static Component m_306339_(Collection<ScoreHolder> p_311655_) {
        return p_311655_.iterator().next().m_305099_();
    }
    ...
    private static int leaveTeam(CommandSourceStack pSource, Collection<ScoreHolder> pPlayers) {
        ...
        if (pPlayers.size() == 1) {
            pSource.sendSuccess(() -> Component.translatable("commands.team.leave.success.single", m_306339_(pPlayers)), true);
        } else {
    ...
    private static int joinTeam(CommandSourceStack pSource, PlayerTeam pTeam, Collection<ScoreHolder> pPlayers) {
        ...
        if (pPlayers.size() == 1) {
            pSource.sendSuccess(() -> Component.translatable("commands.team.join.success.single", m_306339_(pPlayers), pTeam.getFormattedDisplayName()), true);
        } else {
