...
public class Main {
    ...
    public static void main(String[] pArgs) {
        ...
        try {
            ...
            RegionFileVersion.m_324113_(dedicatedserversettings.getProperties().f_316590_);
            ...
            if (levelstoragesource$levelstorageaccess.m_306456_()) {
                ...
                try {
                    dynamic = levelstoragesource$levelstorageaccess.m_307464_();
                    levelsummary = levelstoragesource$levelstorageaccess.getSummary(dynamic);
                } catch (NbtException | ReportedNbtException | IOException ioexception1) {
                    LevelStorageSource.LevelDirectory levelstoragesource$leveldirectory = levelstoragesource$levelstorageaccess.m_306248_();
                    ...
                    try {
                        dynamic = levelstoragesource$levelstorageaccess.m_305112_();
                        levelsummary = levelstoragesource$levelstorageaccess.getSummary(dynamic);
                    ...
                    levelstoragesource$levelstorageaccess.m_305486_();
                }
            ...
            if (dynamic != null) {
                net.minecraftforge.common.ForgeHooks.readAdditionalLevelSaveData(levelstoragesource$levelstorageaccess, levelstoragesource$levelstorageaccess.m_306248_());
            }
                ...
                worldstem = Util.<WorldStem>blockUntilDone(
                        p_248086_ -> WorldLoader.load(
                                ...
                                p_308589_ -> {
                                    ...
                                    if (dynamic1 != null) {
                                        LevelDataAndDimensions leveldataanddimensions = LevelStorageSource.m_306102_(
                                            dynamic1, p_308589_.dataConfiguration(), registry, p_308589_.datapackWorldgen()
                                        );
                                        return new WorldLoader.DataLoadOutput<>(
                                            leveldataanddimensions.f_303671_(), leveldataanddimensions.f_303409_().dimensionsRegistryAccess()
                                        );
                                    } else {
            ...
            final MinecraftServer dedicatedserver = MinecraftServer.spin(
                p_296433_ -> {
                    ...
                    dedicatedserver1 = new DedicatedServer(
                        ...
                        services,
                        LoggerChunkProgressListener::m_324668_
                    );
                    }
    ...
    private static WorldLoader.InitConfig loadOrCreateConfig(
        DedicatedServerProperties pServerProperties, @Nullable Dynamic<?> p_310940_, boolean pSafeMode, PackRepository pPackRepository
    ) {
        boolean flag;
        ...
        if (p_310940_ != null) {
            ...
            flag = true;
            worlddataconfiguration = new WorldDataConfiguration(pServerProperties.initialDataPackConfiguration, FeatureFlags.DEFAULT_FLAGS);
        }
    ...
    private static void forceUpgrade(
        ...
        boolean pEraseCache,
        BooleanSupplier pUpgradeWorld,
        RegistryAccess p_332212_,
        boolean p_331291_
    ) {
        LOGGER.info("Forcing world upgrade!");
        WorldUpgrader worldupgrader = new WorldUpgrader(pLevelStorage, pDataFixer, p_332212_, pEraseCache, p_331291_);
