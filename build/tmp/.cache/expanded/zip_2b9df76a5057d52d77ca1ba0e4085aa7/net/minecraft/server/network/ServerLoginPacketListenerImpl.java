...
public class ServerLoginPacketListenerImpl implements ServerLoginPacketListener, TickablePacketListener {
    ...
    private final boolean f_316429_;

    public ServerLoginPacketListenerImpl(MinecraftServer pServer, Connection pConnection, boolean p_332648_) {
        this.server = pServer;
        this.connection = pConnection;
        this.challenge = Ints.toByteArray(RandomSource.create().nextInt());
        this.f_316429_ = p_332648_;
    }
    ...
    public void handleHello(ServerboundHelloPacket pPacket) {
        ...
        Validate.validState(StringUtil.m_319148_(pPacket.name()), "Invalid characters in username");
        ...
        if (gameprofile != null && this.requestedUsername.equalsIgnoreCase(gameprofile.getName())) {
            ...
            if (this.server.usesAuthentication() && !this.connection.isMemoryConnection()) {
                ...
                this.startClientVerification(UUIDUtil.m_307091_(this.requestedUsername));
            }
        }
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (profileresult != null) {
                        ...
                        ServerLoginPacketListenerImpl.this.startClientVerification(UUIDUtil.m_307091_(s1));
                    } else {
    ...
    public void handleCustomQueryPacket(ServerboundCustomQueryAnswerPacket pPacket) {
        ...
        this.disconnect(ServerCommonPacketListenerImpl.f_315158_);
    }
    ...
    public void handleLoginAcknowledgement(ServerboundLoginAcknowledgedPacket pPacket) {
        ...
        CommonListenerCookie commonlistenercookie = CommonListenerCookie.createInitial(Objects.requireNonNull(this.authenticatedProfile), this.f_316429_);
        ...
        this.connection.m_324855_(ConfigurationProtocols.f_315976_, serverconfigurationpacketlistenerimpl);
        serverconfigurationpacketlistenerimpl.startConfiguration();
        this.state = ServerLoginPacketListenerImpl.State.ACCEPTED;
    }

    @Override
    public void m_306579_(CrashReportCategory p_310682_) {
        p_310682_.setDetail("Login phase", () -> this.state.toString());
    }

    @Override
    public void m_320234_(ServerboundCookieResponsePacket p_333672_) {
        this.disconnect(ServerCommonPacketListenerImpl.f_315158_);
    }
