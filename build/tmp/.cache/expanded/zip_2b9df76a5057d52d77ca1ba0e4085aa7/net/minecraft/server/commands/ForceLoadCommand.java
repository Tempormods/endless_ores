...
public class ForceLoadCommand {
    ...
    private static final Dynamic2CommandExceptionType ERROR_TOO_MANY_CHUNKS = new Dynamic2CommandExceptionType(
        (p_308708_, p_308709_) -> Component.m_307043_("commands.forceload.toobig", p_308708_, p_308709_)
    );
    private static final Dynamic2CommandExceptionType ERROR_NOT_TICKING = new Dynamic2CommandExceptionType(
        (p_308720_, p_308721_) -> Component.m_307043_("commands.forceload.query.failure", p_308720_, p_308721_)
    );
    ...
    private static int queryForceLoad(CommandSourceStack pSource, ColumnPos pPos) throws CommandSyntaxException {
        ...
        if (flag) {
            pSource.sendSuccess(
                () -> Component.translatable("commands.forceload.query.success", Component.m_307221_(chunkpos), Component.m_305236_(resourcekey.location())),
                false
            );
            return 1;
        } else {
    ...
    private static int listForceLoad(CommandSourceStack pSource) {
        ...
        if (i > 0) {
            ...
            if (i == 1) {
                pSource.sendSuccess(() -> Component.translatable("commands.forceload.list.single", Component.m_305236_(resourcekey.location()), s), false);
            } else {
                pSource.sendSuccess(() -> Component.translatable("commands.forceload.list.multiple", i, Component.m_305236_(resourcekey.location()), s), false);
            }
        } else {
            pSource.sendFailure(Component.translatable("commands.forceload.added.none", Component.m_305236_(resourcekey.location())));
        }
    ...
    private static int removeAll(CommandSourceStack pSource) {
        ...
        pSource.sendSuccess(() -> Component.translatable("commands.forceload.removed.all", Component.m_305236_(resourcekey.location())), true);
        return 0;
    }
                    ...
                    if (i3 == 1) {
                        pSource.sendSuccess(
                            () -> Component.translatable(
                                    ...
                                    Component.m_307221_(chunkpos2),
                                    Component.m_305236_(resourcekey.location())
                                ),
                            true
                        );
                    } else {
                        ...
                        pSource.sendSuccess(
                            () -> Component.translatable(
                                    ...
                                    i3,
                                    Component.m_305236_(resourcekey.location()),
                                    Component.m_307221_(chunkpos3),
                                    Component.m_307221_(chunkpos1)
                                ),
                            true
                        );
                    }
