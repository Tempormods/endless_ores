...
public class StopSoundCommand {
    ...
    private static int stopSound(
        ...
        if (pCategory != null) {
            if (pSound != null) {
                pSource.sendSuccess(
                    () -> Component.translatable("commands.stopsound.success.source.sound", Component.m_305236_(pSound), pCategory.getName()), true
                );
            } else {
                pSource.sendSuccess(() -> Component.translatable("commands.stopsound.success.source.any", pCategory.getName()), true);
            }
        } else if (pSound != null) {
            pSource.sendSuccess(() -> Component.translatable("commands.stopsound.success.sourceless.sound", Component.m_305236_(pSound)), true);
        } else {
