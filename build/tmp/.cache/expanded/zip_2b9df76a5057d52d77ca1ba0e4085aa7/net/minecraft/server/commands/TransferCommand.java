...
public class TransferCommand {
    private static final SimpleCommandExceptionType f_314323_ = new SimpleCommandExceptionType(Component.translatable("commands.transfer.error.no_players"));

    public static void m_319902_(CommandDispatcher<CommandSourceStack> p_331355_) {
        p_331355_.register(
    ...
    private static int m_320446_(CommandSourceStack p_328615_, String p_328133_, int p_328113_, Collection<ServerPlayer> p_331356_) throws CommandSyntaxException {
        if (p_331356_.isEmpty()) {
            throw f_314323_.create();
        } else {
