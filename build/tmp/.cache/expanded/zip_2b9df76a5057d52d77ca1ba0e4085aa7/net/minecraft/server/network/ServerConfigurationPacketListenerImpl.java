...
public class ServerConfigurationPacketListenerImpl extends ServerCommonPacketListenerImpl implements ServerConfigurationPacketListener, TickablePacketListener {
    ...
    @Nullable
    private SynchronizeRegistriesTask f_316235_;
    ...
    public void startConfiguration() {
        ...
        List<KnownPack> list = this.server.getResourceManager().listPacks().flatMap(p_326454_ -> p_326454_.m_318586_().f_314017_().stream()).toList();
        this.f_316235_ = new SynchronizeRegistriesTask(list, layeredregistryaccess);
        this.configurationTasks.add(this.f_316235_);
    ...
    public void handleResourcePackResponse(ServerboundResourcePackPacket pPacket) {
        ...
        if (pPacket.action().m_307084_()) {
            this.finishCurrentTask(ServerResourcePackConfigurationTask.TYPE);
        }
    }

    @Override
    public void m_322556_(ServerboundSelectKnownPacks p_330488_) {
        PacketUtils.ensureRunningOnSameThread(p_330488_, this, this.server);
        if (this.f_316235_ == null) {
            throw new IllegalStateException("Unexpected response from client: received pack selection, but no negotiation ongoing");
        } else {
            this.f_316235_.m_324801_(p_330488_.f_315709_(), this::send);
            this.finishCurrentTask(SynchronizeRegistriesTask.f_316877_);
        }
    }
    ...
    public void handleConfigurationFinished(ServerboundFinishConfigurationPacket pPacket) {
        ...
        this.connection.m_319763_(GameProtocols.f_315024_.m_324476_(RegistryFriendlyByteBuf.m_324635_(this.server.registryAccess())));
