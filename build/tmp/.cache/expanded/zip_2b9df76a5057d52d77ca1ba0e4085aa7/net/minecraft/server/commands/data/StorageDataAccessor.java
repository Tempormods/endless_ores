...
public class StorageDataAccessor implements DataAccessor {
    ...
    public Component getModifiedSuccess() {
        return Component.translatable("commands.data.storage.modified", Component.m_305236_(this.id));
    }

    @Override
    public Component getPrintSuccess(Tag pNbt) {
        return Component.translatable("commands.data.storage.query", Component.m_305236_(this.id), NbtUtils.toPrettyComponent(pNbt));
    }

    @Override
    public Component getPrintSuccess(NbtPathArgument.NbtPath pPath, double pScale, int pValue) {
        return Component.translatable(
            "commands.data.storage.get", pPath.m_306879_(), Component.m_305236_(this.id), String.format(Locale.ROOT, "%.2f", pScale), pValue
        );
    }
}