...
public class ScheduleCommand {
    ...
    private static final DynamicCommandExceptionType ERROR_CANT_REMOVE = new DynamicCommandExceptionType(
        p_308808_ -> Component.m_307043_("commands.schedule.cleared.failure", p_308808_)
    );
    ...
    private static int schedule(
        ...
        if (pTime == 0) {
            ...
            pFunction.getSecond().ifLeft(p_312526_ -> {
                ...
                pSource.sendSuccess(() -> Component.translatable("commands.schedule.created.function", Component.m_305236_(resourcelocation), pTime, i), true);
            }).ifRight(p_326343_ -> {
                ...
                pSource.sendSuccess(() -> Component.translatable("commands.schedule.created.tag", Component.m_305236_(resourcelocation), pTime, i), true);
            });
