...
public class EnchantCommand {
    private static final DynamicCommandExceptionType ERROR_NOT_LIVING_ENTITY = new DynamicCommandExceptionType(
        p_308654_ -> Component.m_307043_("commands.enchant.failed.entity", p_308654_)
    );
    private static final DynamicCommandExceptionType ERROR_NO_ITEM = new DynamicCommandExceptionType(
        p_308650_ -> Component.m_307043_("commands.enchant.failed.itemless", p_308650_)
    );
    private static final DynamicCommandExceptionType ERROR_INCOMPATIBLE = new DynamicCommandExceptionType(
        p_308653_ -> Component.m_307043_("commands.enchant.failed.incompatible", p_308653_)
    );
    private static final Dynamic2CommandExceptionType ERROR_LEVEL_TOO_HIGH = new Dynamic2CommandExceptionType(
        (p_308651_, p_308652_) -> Component.m_307043_("commands.enchant.failed.level", p_308651_, p_308652_)
    );
            ...
            for (Entity entity : pTargets) {
                if (entity instanceof LivingEntity) {
                    ...
                    if (!itemstack.isEmpty()) {
                        if (enchantment.canEnchant(itemstack) && EnchantmentHelper.isEnchantmentCompatible(EnchantmentHelper.m_324152_(itemstack).m_324420_(), enchantment)) {
