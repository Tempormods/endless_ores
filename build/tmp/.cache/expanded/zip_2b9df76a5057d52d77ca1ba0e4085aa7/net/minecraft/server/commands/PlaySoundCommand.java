...
public class PlaySoundCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> pDispatcher) {
        RequiredArgumentBuilder<CommandSourceStack, ResourceLocation> requiredargumentbuilder = Commands.argument("sound", ResourceLocationArgument.id())
            ...
            .executes(
                p_326320_ -> playSound(
                        p_326320_.getSource(),
                        m_323950_(p_326320_.getSource().getPlayer()),
    ...
    private static LiteralArgumentBuilder<CommandSourceStack> source(SoundSource pCategory) {
        return Commands.literal(pCategory.getName())
            .executes(
                p_326324_ -> playSound(
                        p_326324_.getSource(),
                        m_323950_(p_326324_.getSource().getPlayer()),
    ...
    private static Collection<ServerPlayer> m_323950_(@Nullable ServerPlayer p_334744_) {
    ...
    private static int playSound(
        ...
        if (i == 0) {
            ...
            if (pTargets.size() == 1) {
                pSource.sendSuccess(
                    () -> Component.translatable("commands.playsound.success.single", Component.m_305236_(pSound), pTargets.iterator().next().getDisplayName()), true
                );
            } else {
                pSource.sendSuccess(() -> Component.translatable("commands.playsound.success.multiple", Component.m_305236_(pSound), pTargets.size()), true);
            }
