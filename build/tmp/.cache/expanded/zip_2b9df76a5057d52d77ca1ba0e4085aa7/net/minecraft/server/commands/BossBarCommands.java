...
public class BossBarCommands {
    private static final DynamicCommandExceptionType ERROR_ALREADY_EXISTS = new DynamicCommandExceptionType(
        p_308633_ -> Component.m_307043_("commands.bossbar.create.failed", p_308633_)
    );
    private static final DynamicCommandExceptionType ERROR_DOESNT_EXIST = new DynamicCommandExceptionType(
        p_308632_ -> Component.m_307043_("commands.bossbar.unknown", p_308632_)
    );
    ...
    public static void register(CommandDispatcher<CommandSourceStack> pDispatcher, CommandBuildContext p_332961_) {
