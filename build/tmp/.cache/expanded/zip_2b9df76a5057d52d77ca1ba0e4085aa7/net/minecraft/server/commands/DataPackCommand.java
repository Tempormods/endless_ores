...
public class DataPackCommand {
    private static final DynamicCommandExceptionType ERROR_UNKNOWN_PACK = new DynamicCommandExceptionType(
        p_308647_ -> Component.m_307043_("commands.datapack.unknown", p_308647_)
    );
    private static final DynamicCommandExceptionType ERROR_PACK_ALREADY_ENABLED = new DynamicCommandExceptionType(
        p_308646_ -> Component.m_307043_("commands.datapack.enable.failed", p_308646_)
    );
    private static final DynamicCommandExceptionType ERROR_PACK_ALREADY_DISABLED = new DynamicCommandExceptionType(
        p_308645_ -> Component.m_307043_("commands.datapack.disable.failed", p_308645_)
    );
    private static final DynamicCommandExceptionType f_313980_ = new DynamicCommandExceptionType(
        p_326235_ -> Component.m_307043_("commands.datapack.disable.failed.feature", p_326235_)
    );
    private static final Dynamic2CommandExceptionType ERROR_PACK_FEATURES_NOT_ENABLED = new Dynamic2CommandExceptionType(
        (p_308643_, p_308644_) -> Component.m_307043_("commands.datapack.enable.failed.no_flags", p_308643_, p_308644_)
    );
                            ...
                            Commands.argument("name", StringArgumentType.string())
                                ...
                                .executes(
                                    p_136876_ -> enablePack(
                                            ...
                                            (p_180059_, p_180060_) -> p_180060_.getDefaultPosition().insert(p_180059_, p_180060_, Pack::m_319332_, false)
                                        )
                                )
                                .then(
    ...
    private static Pack getPack(CommandContext<CommandSourceStack> pContext, String pName, boolean pEnabling) throws CommandSyntaxException {
        ...
        if (pack == null) {
            ...
            if (pEnabling && flag) {
                ...
                if (!pEnabling && !featureflagset1.m_324434_() && pack.getPackSource() == PackSource.FEATURE) {
                    throw f_313980_.create(s);
