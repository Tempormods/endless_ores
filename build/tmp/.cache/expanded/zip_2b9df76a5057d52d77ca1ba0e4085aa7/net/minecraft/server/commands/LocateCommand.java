...
public class LocateCommand {
    ...
    private static final DynamicCommandExceptionType ERROR_STRUCTURE_NOT_FOUND = new DynamicCommandExceptionType(
        p_308765_ -> Component.m_307043_("commands.locate.structure.not_found", p_308765_)
    );
    private static final DynamicCommandExceptionType ERROR_STRUCTURE_INVALID = new DynamicCommandExceptionType(
        p_308764_ -> Component.m_307043_("commands.locate.structure.invalid", p_308764_)
    );
    private static final DynamicCommandExceptionType ERROR_BIOME_NOT_FOUND = new DynamicCommandExceptionType(
        p_308763_ -> Component.m_307043_("commands.locate.biome.not_found", p_308763_)
    );
    private static final DynamicCommandExceptionType ERROR_POI_NOT_FOUND = new DynamicCommandExceptionType(
        p_308766_ -> Component.m_307043_("commands.locate.poi.not_found", p_308766_)
    );
    ...
    public static int showLocateResult(
        ...
        String s = pResult.unwrap()
            .map(p_248147_ -> pResult.asPrintable(), p_326290_ -> pResult.asPrintable() + " (" + pResultWithPosition.getSecond().m_323990_() + ")");
    ...
    public static int showLocateResult(
        ...
        String s = pResult.unwrap()
            .map(p_214498_ -> p_214498_.location().toString(), p_326287_ -> "#" + p_326287_.location() + " (" + pResultWithPosition.getSecond().m_323990_() + ")");
        return showLocateResult(pSource, pSourcePosition, pResultWithPosition, pTranslationKey, pAbsoluteY, s, pDuration);
    }
