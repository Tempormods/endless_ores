...
public class VanillaPackResources implements PackResources {
    ...
    VanillaPackResources(
        PackLocationInfo p_331390_, BuiltInMetadata pMetadata, Set<String> pNamespaces, List<Path> pRootPaths, Map<PackType, List<Path>> pPathsForType
    ) {
        this.f_314150_ = p_331390_;
