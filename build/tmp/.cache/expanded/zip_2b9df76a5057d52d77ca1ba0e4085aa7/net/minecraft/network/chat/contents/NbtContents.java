...
public class NbtContents implements ComponentContents {
    ...
    public static final MapCodec<NbtContents> f_302971_ = RecordCodecBuilder.mapCodec(
        p_326081_ -> p_326081_.group(
                    ...
                    ComponentSerialization.f_303288_.lenientOptionalFieldOf("separator").forGetter(NbtContents::getSeparator),
                    DataSource.f_303844_.forGetter(NbtContents::getDataSource)
                )
                .apply(p_326081_, NbtContents::new)
    );
    public static final ComponentContents.Type<NbtContents> f_303372_ = new ComponentContents.Type<>(f_302971_, "nbt");
