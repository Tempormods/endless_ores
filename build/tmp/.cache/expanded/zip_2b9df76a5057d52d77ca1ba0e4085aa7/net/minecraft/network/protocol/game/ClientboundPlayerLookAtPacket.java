...
public class ClientboundPlayerLookAtPacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundPlayerLookAtPacket> f_315482_ = Packet.m_319422_(
        ClientboundPlayerLookAtPacket::m_132794_, ClientboundPlayerLookAtPacket::new
    );
    ...
    private void m_132794_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ClientboundPlayerLookAtPacket> write() {
        return GamePacketTypes.f_314591_;
    }
