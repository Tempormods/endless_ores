...
public class ClientboundStopSoundPacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundStopSoundPacket> f_314855_ = Packet.m_319422_(
        ClientboundStopSoundPacket::m_133477_, ClientboundStopSoundPacket::new
    );
    ...
    private void m_133477_(FriendlyByteBuf pBuffer) {
        if (this.source != null) {
            if (this.name != null) {
                pBuffer.writeByte(3);
    ...
    @Override
    public PacketType<ClientboundStopSoundPacket> write() {
        return GamePacketTypes.f_316904_;
    }
