...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundCommandsPacket> f_316838_ = Packet.m_319422_(
        ClientboundCommandsPacket::m_131885_, ClientboundCommandsPacket::new
    );
    ...
    private void m_131885_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ClientboundCommandsPacket> write() {
        return GamePacketTypes.f_315127_;
    }
