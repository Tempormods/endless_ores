...
public class TranslatableContents implements ComponentContents {
    ...
    private static final Codec<Object> f_303238_ = ExtraCodecs.f_302296_.validate(TranslatableContents::m_307068_);
    private static final Codec<Object> f_302806_ = Codec.either(f_303238_, ComponentSerialization.f_303288_)
        .xmap(
            p_309461_ -> p_309461_.map(p_311360_ -> p_311360_, p_311088_ -> Objects.requireNonNullElse(p_311088_.m_306448_(), p_311088_)),
            p_309556_ -> p_309556_ instanceof Component component ? Either.right(component) : Either.left(p_309556_)
        );
    public static final MapCodec<TranslatableContents> f_302832_ = RecordCodecBuilder.mapCodec(
        p_326087_ -> p_326087_.group(
                    ...
                    f_302806_.listOf().optionalFieldOf("with").forGetter(p_309865_ -> m_307058_(p_309865_.args))
                )
                .apply(p_326087_, TranslatableContents::m_307802_)
    );
    public static final ComponentContents.Type<TranslatableContents> f_303657_ = new ComponentContents.Type<>(f_302832_, "translatable");
    ...
    private static DataResult<Object> m_307068_(@Nullable Object p_310291_) {
        return !m_306839_(p_310291_) ? DataResult.error(() -> "This value needs to be parsed as component") : DataResult.success(p_310291_);
    }

    public static boolean m_306839_(@Nullable Object p_313191_) {
        return p_313191_ instanceof Number || p_313191_ instanceof Boolean || p_313191_ instanceof String;
    }

    private static Optional<List<Object>> m_307058_(Object[] p_310705_) {
        return p_310705_.length == 0 ? Optional.empty() : Optional.of(Arrays.asList(p_310705_));
    }

    private static Object[] m_306736_(Optional<List<Object>> p_309492_) {
        return p_309492_.<Object[]>map(p_309407_ -> p_309407_.isEmpty() ? NO_ARGS : p_309407_.toArray()).orElse(NO_ARGS);
    }

    private static TranslatableContents m_307802_(String p_311603_, Optional<String> p_311479_, Optional<List<Object>> p_312087_) {
        return new TranslatableContents(p_311603_, p_311479_.orElse(null), m_306736_(p_312087_));
    }
