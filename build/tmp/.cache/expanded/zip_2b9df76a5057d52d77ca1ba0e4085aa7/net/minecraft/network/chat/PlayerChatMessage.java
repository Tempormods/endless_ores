...
public record PlayerChatMessage(
    ...
    public static final MapCodec<PlayerChatMessage> MAP_CODEC = RecordCodecBuilder.mapCodec(
        p_308567_ -> p_308567_.group(
                    ...
                    ComponentSerialization.f_303288_.optionalFieldOf("unsigned_content").forGetter(p_253458_ -> Optional.ofNullable(p_253458_.unsignedContent)),
    ...
    public PlayerChatMessage m_307107_() {
