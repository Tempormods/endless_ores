...
public class ServerboundInteractPacket implements Packet<ServerGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ServerboundInteractPacket> f_316172_ = Packet.m_319422_(
        ServerboundInteractPacket::m_134057_, ServerboundInteractPacket::new
    );
    ...
    private void m_134057_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ServerboundInteractPacket> write() {
        return GamePacketTypes.f_317158_;
    }
