...
public final class TextColor {
    ...
    public static DataResult<TextColor> parseColor(String pHexString) {
        if (pHexString.startsWith("#")) {
            try {
                ...
                return i >= 0 && i <= 16777215
                    ...
                    : DataResult.error(() -> "Color value out of range: " + pHexString);
            } catch (NumberFormatException numberformatexception) {
                return DataResult.error(() -> "Invalid color value: " + pHexString);
            }
        } else {
            TextColor textcolor = NAMED_COLORS.get(pHexString);
            return textcolor == null ? DataResult.error(() -> "Invalid color name: " + pHexString) : DataResult.success(textcolor, Lifecycle.stable());
        }
    }
}