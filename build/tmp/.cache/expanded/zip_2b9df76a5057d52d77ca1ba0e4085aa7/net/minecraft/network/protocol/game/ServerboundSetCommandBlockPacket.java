...
public class ServerboundSetCommandBlockPacket implements Packet<ServerGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ServerboundSetCommandBlockPacket> f_315336_ = Packet.m_319422_(
        ServerboundSetCommandBlockPacket::m_134522_, ServerboundSetCommandBlockPacket::new
    );
    ...
    private void m_134522_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ServerboundSetCommandBlockPacket> write() {
        return GamePacketTypes.f_316399_;
    }
