...
public class ClickEvent {
    public static final Codec<ClickEvent> f_303138_ = RecordCodecBuilder.create(
        p_311166_ -> p_311166_.group(
                    ClickEvent.Action.f_303637_.forGetter(p_313238_ -> p_313238_.action),
    ...
    public static enum Action implements StringRepresentable {
        ...
        public static final MapCodec<ClickEvent.Action> f_303760_ = StringRepresentable.fromEnum(ClickEvent.Action::values).fieldOf("action");
        public static final MapCodec<ClickEvent.Action> f_303637_ = f_303760_.validate(ClickEvent.Action::m_306018_);
        ...
        public static DataResult<ClickEvent.Action> m_306018_(ClickEvent.Action p_311653_) {
