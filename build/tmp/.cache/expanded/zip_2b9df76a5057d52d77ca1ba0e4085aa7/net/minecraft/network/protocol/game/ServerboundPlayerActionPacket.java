...
public class ServerboundPlayerActionPacket implements Packet<ServerGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ServerboundPlayerActionPacket> f_315134_ = Packet.m_319422_(
        ServerboundPlayerActionPacket::m_134282_, ServerboundPlayerActionPacket::new
    );
    ...
    private void m_134282_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ServerboundPlayerActionPacket> write() {
        return GamePacketTypes.f_314753_;
    }
