...
public interface ProtocolSwapHandler {
    static void m_319640_(ChannelHandlerContext p_327743_, Packet<?> p_336039_) {
        if (p_336039_.m_319635_()) {
    ...
    static void m_323470_(ChannelHandlerContext p_330082_, Packet<?> p_328185_) {
        if (p_328185_.m_319635_()) {
