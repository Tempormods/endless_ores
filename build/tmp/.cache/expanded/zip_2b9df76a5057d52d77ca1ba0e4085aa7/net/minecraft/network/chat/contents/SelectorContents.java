...
public class SelectorContents implements ComponentContents {
    ...
    public static final MapCodec<SelectorContents> f_302753_ = RecordCodecBuilder.mapCodec(
        p_326086_ -> p_326086_.group(
                    Codec.STRING.fieldOf("selector").forGetter(SelectorContents::getPattern),
                    ComponentSerialization.f_303288_.optionalFieldOf("separator").forGetter(SelectorContents::getSeparator)
                )
                .apply(p_326086_, SelectorContents::new)
    );
    public static final ComponentContents.Type<SelectorContents> f_302445_ = new ComponentContents.Type<>(f_302753_, "selector");
