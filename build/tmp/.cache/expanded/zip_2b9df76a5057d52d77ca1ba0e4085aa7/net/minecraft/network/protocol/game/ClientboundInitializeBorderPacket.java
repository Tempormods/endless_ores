...
public class ClientboundInitializeBorderPacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundInitializeBorderPacket> f_314827_ = Packet.m_319422_(
        ClientboundInitializeBorderPacket::m_178880_, ClientboundInitializeBorderPacket::new
    );
    ...
    private void m_178880_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ClientboundInitializeBorderPacket> write() {
        return GamePacketTypes.f_314453_;
    }
