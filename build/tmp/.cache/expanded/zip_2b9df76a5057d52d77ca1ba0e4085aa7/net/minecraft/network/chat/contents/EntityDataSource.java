...
public record EntityDataSource(String selectorPattern, @Nullable EntitySelector compiledSelector) implements DataSource {
    public static final MapCodec<EntityDataSource> f_302622_ = RecordCodecBuilder.mapCodec(
    ...
    public static final DataSource.Type<EntityDataSource> f_303369_ = new DataSource.Type<>(f_302622_, "entity");
