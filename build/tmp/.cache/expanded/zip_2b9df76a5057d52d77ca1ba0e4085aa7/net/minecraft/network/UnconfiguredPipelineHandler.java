...
public class UnconfiguredPipelineHandler {
    public static <T extends PacketListener> UnconfiguredPipelineHandler.InboundConfigurationTask m_318869_(ProtocolInfo<T> p_335707_) {
        return m_321878_(new PacketDecoder<>(p_335707_));
    }

    private static UnconfiguredPipelineHandler.InboundConfigurationTask m_321878_(ChannelInboundHandler p_333903_) {
        return p_331657_ -> {
    ...
    public static <T extends PacketListener> UnconfiguredPipelineHandler.OutboundConfigurationTask m_320645_(ProtocolInfo<T> p_332375_) {
        return m_324241_(new PacketEncoder<>(p_332375_));
    }

    private static UnconfiguredPipelineHandler.OutboundConfigurationTask m_324241_(ChannelOutboundHandler p_327845_) {
    ...
    public static class Inbound extends ChannelDuplexHandler {
        ...
        public void write(ChannelHandlerContext p_335998_, Object p_335040_, ChannelPromise p_328870_) throws Exception {
            if (p_335040_ instanceof UnconfiguredPipelineHandler.InboundConfigurationTask unconfiguredpipelinehandler$inboundconfigurationtask) {
                try {
                    unconfiguredpipelinehandler$inboundconfigurationtask.m_321722_(p_335998_);
                } finally {
    ...
    public interface InboundConfigurationTask {
        void m_321722_(ChannelHandlerContext p_333167_);

        default UnconfiguredPipelineHandler.InboundConfigurationTask m_323054_(UnconfiguredPipelineHandler.InboundConfigurationTask p_332325_) {
            return p_334974_ -> {
                this.m_321722_(p_334974_);
                p_332325_.m_321722_(p_334974_);
            };
        }
    }
        ...
        public void write(ChannelHandlerContext p_331750_, Object p_329073_, ChannelPromise p_329104_) throws Exception {
            if (p_329073_ instanceof Packet) {
                ...
                if (p_329073_ instanceof UnconfiguredPipelineHandler.OutboundConfigurationTask unconfiguredpipelinehandler$outboundconfigurationtask) {
                    try {
                        unconfiguredpipelinehandler$outboundconfigurationtask.m_322180_(p_331750_);
                    } finally {
                        ReferenceCountUtil.release(p_329073_);
                    }
    ...
    public interface OutboundConfigurationTask {
        void m_322180_(ChannelHandlerContext p_330432_);

        default UnconfiguredPipelineHandler.OutboundConfigurationTask m_322612_(UnconfiguredPipelineHandler.OutboundConfigurationTask p_334721_) {
            return p_334875_ -> {
                this.m_322180_(p_334875_);
                p_334721_.m_322180_(p_334875_);
            };
        }
    }
}