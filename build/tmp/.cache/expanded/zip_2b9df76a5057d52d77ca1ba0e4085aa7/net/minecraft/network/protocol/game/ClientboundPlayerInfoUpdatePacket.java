...
public class ClientboundPlayerInfoUpdatePacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<RegistryFriendlyByteBuf, ClientboundPlayerInfoUpdatePacket> f_315507_ = Packet.m_319422_(
        ClientboundPlayerInfoUpdatePacket::m_245834_, ClientboundPlayerInfoUpdatePacket::new
    );
    ...
    private void m_245834_(RegistryFriendlyByteBuf p_332405_) {
    ...
    @Override
    public PacketType<ClientboundPlayerInfoUpdatePacket> write() {
        return GamePacketTypes.f_315640_;
    }
    ...
    public static enum Action {
        ADD_PLAYER((p_326115_, p_326116_) -> {
            ...
            gameprofile.getProperties().putAll(ByteBufCodecs.f_315576_.m_318688_(p_326116_));
            ...
            ByteBufCodecs.f_315576_.m_318638_(p_326113_, gameprofile.getProperties());
        }),
        INITIALIZE_CHAT(
            (p_326119_, p_326120_) -> p_326119_.chatSession = p_326120_.readNullable(RemoteChatSession.Data::read),
            (p_326121_, p_326122_) -> p_326121_.m_321806_(p_326122_.chatSession, RemoteChatSession.Data::write)
        ),
        UPDATE_GAME_MODE(
        ...
        UPDATE_DISPLAY_NAME(
            (p_326103_, p_326104_) -> p_326103_.displayName = FriendlyByteBuf.m_323524_(p_326104_, ComponentSerialization.f_316335_),
            (p_326111_, p_326112_) -> FriendlyByteBuf.writeNullable(p_326111_, p_326112_.displayName(), ComponentSerialization.f_316335_)
        );
        ...
        public interface Reader {
            void read(ClientboundPlayerInfoUpdatePacket.EntryBuilder pEntryBuilder, RegistryFriendlyByteBuf p_332411_);
        }

        public interface Writer {
            void write(RegistryFriendlyByteBuf p_330677_, ClientboundPlayerInfoUpdatePacket.Entry pEntry);
        }
    }
