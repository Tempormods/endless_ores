...
public class KeybindContents implements ComponentContents {
    public static final MapCodec<KeybindContents> f_303682_ = RecordCodecBuilder.mapCodec(
    ...
    public static final ComponentContents.Type<KeybindContents> f_302328_ = new ComponentContents.Type<>(f_303682_, "keybind");
