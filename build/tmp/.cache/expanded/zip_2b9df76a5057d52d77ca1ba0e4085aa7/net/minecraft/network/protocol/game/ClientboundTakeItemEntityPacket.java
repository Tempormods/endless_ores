...
public class ClientboundTakeItemEntityPacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundTakeItemEntityPacket> f_315827_ = Packet.m_319422_(
        ClientboundTakeItemEntityPacket::m_133525_, ClientboundTakeItemEntityPacket::new
    );
    ...
    private void m_133525_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ClientboundTakeItemEntityPacket> write() {
        return GamePacketTypes.f_316052_;
    }
