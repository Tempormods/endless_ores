...
public record CommonPlayerSpawnInfo(
    ...
    private static final StreamCodec<RegistryFriendlyByteBuf, Holder<DimensionType>> f_314070_ = ByteBufCodecs.m_322636_(Registries.DIMENSION_TYPE);

    public CommonPlayerSpawnInfo(RegistryFriendlyByteBuf p_331063_) {
        this(
            f_314070_.m_318688_(p_331063_),
    ...
    public void write(RegistryFriendlyByteBuf p_335866_) {
        f_314070_.m_318638_(p_335866_, this.dimensionType);
