...
public class ClientboundSetBorderLerpSizePacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundSetBorderLerpSizePacket> f_315852_ = Packet.m_319422_(
        ClientboundSetBorderLerpSizePacket::m_179232_, ClientboundSetBorderLerpSizePacket::new
    );
    ...
    private void m_179232_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ClientboundSetBorderLerpSizePacket> write() {
        return GamePacketTypes.f_314619_;
    }
