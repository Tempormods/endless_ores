...
public class ClientboundTeleportEntityPacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundTeleportEntityPacket> f_315967_ = Packet.m_319422_(
        ClientboundTeleportEntityPacket::m_133546_, ClientboundTeleportEntityPacket::new
    );
    ...
    private ClientboundTeleportEntityPacket(FriendlyByteBuf pBuffer) {
    ...
    private void m_133546_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ClientboundTeleportEntityPacket> write() {
        return GamePacketTypes.f_316799_;
    }
