...
public class ClientboundAddEntityPacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<RegistryFriendlyByteBuf, ClientboundAddEntityPacket> f_317084_ = Packet.m_319422_(
        ClientboundAddEntityPacket::m_131497_, ClientboundAddEntityPacket::new
    );
    ...
    private ClientboundAddEntityPacket(RegistryFriendlyByteBuf p_327810_) {
        ...
        this.type = ByteBufCodecs.m_320159_(Registries.ENTITY_TYPE).m_318688_(p_327810_);
    ...
    private void m_131497_(RegistryFriendlyByteBuf p_332393_) {
        p_332393_.writeVarInt(this.id);
        p_332393_.writeUUID(this.uuid);
        ByteBufCodecs.m_320159_(Registries.ENTITY_TYPE).m_318638_(p_332393_, this.type);
    ...
    @Override
    public PacketType<ClientboundAddEntityPacket> write() {
        return GamePacketTypes.f_316505_;
    }
