...
public class ServerboundPlayerCommandPacket implements Packet<ServerGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ServerboundPlayerCommandPacket> f_315749_ = Packet.m_319422_(
        ServerboundPlayerCommandPacket::m_134318_, ServerboundPlayerCommandPacket::new
    );
    ...
    private void m_134318_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ServerboundPlayerCommandPacket> write() {
        return GamePacketTypes.f_316884_;
    }
