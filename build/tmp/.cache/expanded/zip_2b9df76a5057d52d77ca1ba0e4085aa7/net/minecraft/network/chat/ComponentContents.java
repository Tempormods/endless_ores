...
public interface ComponentContents {
    ...
    ComponentContents.Type<?> m_304650_();

    public static record Type<T extends ComponentContents>(MapCodec<T> f_302903_, String f_303833_) implements StringRepresentable {
        @Override
        public String getSerializedName() {
            return this.f_303833_;
        }
    }
}