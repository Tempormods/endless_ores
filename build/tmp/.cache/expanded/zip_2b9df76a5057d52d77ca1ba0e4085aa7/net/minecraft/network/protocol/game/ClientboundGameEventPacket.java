...
public class ClientboundGameEventPacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundGameEventPacket> f_315994_ = Packet.m_319422_(
        ClientboundGameEventPacket::m_132179_, ClientboundGameEventPacket::new
    );
    ...
    public static final ClientboundGameEventPacket.Type f_302744_ = new ClientboundGameEventPacket.Type(13);
    ...
    private void m_132179_(FriendlyByteBuf pBuffer) {
        pBuffer.writeByte(this.event.id);
        pBuffer.writeFloat(this.param);
    }

    @Override
    public PacketType<ClientboundGameEventPacket> write() {
        return GamePacketTypes.f_315774_;
    }
