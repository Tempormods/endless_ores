...
public class ServerboundSetStructureBlockPacket implements Packet<ServerGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ServerboundSetStructureBlockPacket> f_313925_ = Packet.m_319422_(
        ServerboundSetStructureBlockPacket::m_134630_, ServerboundSetStructureBlockPacket::new
    );
    ...
    private void m_134630_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ServerboundSetStructureBlockPacket> write() {
        return GamePacketTypes.f_316388_;
    }
