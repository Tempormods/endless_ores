...
public class ClientboundSectionBlocksUpdatePacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundSectionBlocksUpdatePacket> f_315562_ = Packet.m_319422_(
        ClientboundSectionBlocksUpdatePacket::m_133001_, ClientboundSectionBlocksUpdatePacket::new
    );
    ...
    private void m_133001_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ClientboundSectionBlocksUpdatePacket> write() {
        return GamePacketTypes.f_315721_;
    }
