...
public class ServerboundPlayerAbilitiesPacket implements Packet<ServerGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ServerboundPlayerAbilitiesPacket> f_314572_ = Packet.m_319422_(
        ServerboundPlayerAbilitiesPacket::m_134265_, ServerboundPlayerAbilitiesPacket::new
    );
    ...
    private void m_134265_(FriendlyByteBuf pBuffer) {
        byte b0 = 0;
        if (this.isFlying) {
            b0 = (byte)(b0 | 2);
        }
    ...
    @Override
    public PacketType<ServerboundPlayerAbilitiesPacket> write() {
        return GamePacketTypes.f_314402_;
    }
