...
public class Style {
    ...
    private static <T> Style m_304787_(Style p_310345_, @Nullable T p_309931_, @Nullable T p_310845_) {
    ...
    public static class Serializer {
        public static final MapCodec<Style> f_303391_ = RecordCodecBuilder.mapCodec(
            p_312892_ -> p_312892_.group(
                        ...
                        ClickEvent.f_303138_.optionalFieldOf("clickEvent").forGetter(p_312594_ -> Optional.ofNullable(p_312594_.clickEvent)),
                        HoverEvent.f_303270_.optionalFieldOf("hoverEvent").forGetter(p_311111_ -> Optional.ofNullable(p_311111_.hoverEvent)),
        ...
        public static final Codec<Style> f_302851_ = f_303391_.codec();
        public static final StreamCodec<RegistryFriendlyByteBuf, Style> f_314849_ = ByteBufCodecs.m_322295_(f_302851_);
    }
}