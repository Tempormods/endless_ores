...
public class ClientboundLightUpdatePacketData {
    private static final StreamCodec<ByteBuf, byte[]> f_314175_ = ByteBufCodecs.m_323478_(2048);
    ...
    public ClientboundLightUpdatePacketData(FriendlyByteBuf pBuffer, int pX, int pZ) {
        ...
        this.skyUpdates = pBuffer.readList(f_314175_);
        this.blockUpdates = pBuffer.readList(f_314175_);
    }
    ...
    public void write(FriendlyByteBuf pBuffer) {
        ...
        pBuffer.writeCollection(this.skyUpdates, f_314175_);
        pBuffer.writeCollection(this.blockUpdates, f_314175_);
    }
