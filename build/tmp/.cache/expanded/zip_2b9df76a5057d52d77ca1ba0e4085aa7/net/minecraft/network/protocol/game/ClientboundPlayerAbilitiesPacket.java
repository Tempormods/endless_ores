...
public class ClientboundPlayerAbilitiesPacket implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ClientboundPlayerAbilitiesPacket> f_315591_ = Packet.m_319422_(
        ClientboundPlayerAbilitiesPacket::m_132675_, ClientboundPlayerAbilitiesPacket::new
    );
    ...
    private void m_132675_(FriendlyByteBuf pBuffer) {
        byte b0 = 0;
    ...
    @Override
    public PacketType<ClientboundPlayerAbilitiesPacket> write() {
        return GamePacketTypes.f_316146_;
    }
