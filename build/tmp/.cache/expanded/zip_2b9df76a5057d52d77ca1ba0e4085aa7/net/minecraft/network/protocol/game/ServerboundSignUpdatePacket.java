...
public class ServerboundSignUpdatePacket implements Packet<ServerGamePacketListener> {
    public static final StreamCodec<FriendlyByteBuf, ServerboundSignUpdatePacket> f_315081_ = Packet.m_319422_(
        ServerboundSignUpdatePacket::m_134661_, ServerboundSignUpdatePacket::new
    );
    ...
    private void m_134661_(FriendlyByteBuf pBuffer) {
    ...
    @Override
    public PacketType<ServerboundSignUpdatePacket> write() {
        return GamePacketTypes.f_315193_;
    }
