...
public class TagParser {
    ...
    public static final Dynamic2CommandExceptionType ERROR_INSERT_MIXED_LIST = new Dynamic2CommandExceptionType(
        (p_308559_, p_308560_) -> Component.m_307043_("argument.nbt.list.mixed", p_308559_, p_308560_)
    );
    public static final Dynamic2CommandExceptionType ERROR_INSERT_MIXED_ARRAY = new Dynamic2CommandExceptionType(
        (p_308556_, p_308557_) -> Component.m_307043_("argument.nbt.array.mixed", p_308556_, p_308557_)
    );
    public static final DynamicCommandExceptionType ERROR_INVALID_ARRAY = new DynamicCommandExceptionType(
        p_308558_ -> Component.m_307043_("argument.nbt.array.invalid", p_308558_)
    );
    ...
    public static final Codec<CompoundTag> f_316526_ = Codec.withAlternative(AS_CODEC, CompoundTag.CODEC);
