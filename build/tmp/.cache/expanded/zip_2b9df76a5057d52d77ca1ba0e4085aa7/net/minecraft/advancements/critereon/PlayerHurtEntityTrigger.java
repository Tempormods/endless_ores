...
public class PlayerHurtEntityTrigger extends SimpleCriterionTrigger<PlayerHurtEntityTrigger.TriggerInstance> {
    @Override
    public Codec<PlayerHurtEntityTrigger.TriggerInstance> createInstance() {
        return PlayerHurtEntityTrigger.TriggerInstance.f_303849_;
    }
    ...
    public static record TriggerInstance(
        Optional<ContextAwarePredicate> f_302644_, Optional<DamagePredicate> damage, Optional<ContextAwarePredicate> entity
    ) implements SimpleCriterionTrigger.SimpleInstance {
        public static final Codec<PlayerHurtEntityTrigger.TriggerInstance> f_303849_ = RecordCodecBuilder.create(
            p_325238_ -> p_325238_.group(
                        EntityPredicate.f_303210_.optionalFieldOf("player").forGetter(PlayerHurtEntityTrigger.TriggerInstance::playerPredicate),
                        DamagePredicate.f_303816_.optionalFieldOf("damage").forGetter(PlayerHurtEntityTrigger.TriggerInstance::damage),
                        EntityPredicate.f_303210_.optionalFieldOf("entity").forGetter(PlayerHurtEntityTrigger.TriggerInstance::entity)
                    )
        ...
        @Override
        public void serializeToJson(CriterionValidator p_311209_) {
            SimpleCriterionTrigger.SimpleInstance.super.serializeToJson(p_311209_);
            p_311209_.m_307484_(this.entity, ".entity");
        }

        @Override
        public Optional<ContextAwarePredicate> playerPredicate() {
            return this.f_302644_;
        }
    }
}