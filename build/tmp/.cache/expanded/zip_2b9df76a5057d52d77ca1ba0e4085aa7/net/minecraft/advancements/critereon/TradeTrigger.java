...
public class TradeTrigger extends SimpleCriterionTrigger<TradeTrigger.TriggerInstance> {
    @Override
    public Codec<TradeTrigger.TriggerInstance> createInstance() {
        return TradeTrigger.TriggerInstance.f_302548_;
    }
    ...
    public static record TriggerInstance(Optional<ContextAwarePredicate> f_302976_, Optional<ContextAwarePredicate> villager, Optional<ItemPredicate> item)
        implements SimpleCriterionTrigger.SimpleInstance {
        public static final Codec<TradeTrigger.TriggerInstance> f_302548_ = RecordCodecBuilder.create(
            p_325256_ -> p_325256_.group(
                        EntityPredicate.f_303210_.optionalFieldOf("player").forGetter(TradeTrigger.TriggerInstance::playerPredicate),
                        EntityPredicate.f_303210_.optionalFieldOf("villager").forGetter(TradeTrigger.TriggerInstance::villager),
        ...
        @Override
        public void serializeToJson(CriterionValidator p_309853_) {
            SimpleCriterionTrigger.SimpleInstance.super.serializeToJson(p_309853_);
            p_309853_.m_307484_(this.villager, ".villager");
        }

        @Override
        public Optional<ContextAwarePredicate> playerPredicate() {
            return this.f_302976_;
        }
    }
}