...
public class ItemDurabilityTrigger extends SimpleCriterionTrigger<ItemDurabilityTrigger.TriggerInstance> {
    @Override
    public Codec<ItemDurabilityTrigger.TriggerInstance> createInstance() {
        return ItemDurabilityTrigger.TriggerInstance.f_303090_;
    }
    ...
    public static record TriggerInstance(
        Optional<ContextAwarePredicate> f_302356_, Optional<ItemPredicate> item, MinMaxBounds.Ints durability, MinMaxBounds.Ints delta
    ) implements SimpleCriterionTrigger.SimpleInstance {
        public static final Codec<ItemDurabilityTrigger.TriggerInstance> f_303090_ = RecordCodecBuilder.create(
            p_325220_ -> p_325220_.group(
                        EntityPredicate.f_303210_.optionalFieldOf("player").forGetter(ItemDurabilityTrigger.TriggerInstance::playerPredicate),
