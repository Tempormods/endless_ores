...
public record AdvancementRequirements(List<List<String>> requirements) {
    public static final Codec<AdvancementRequirements> f_302300_ = Codec.STRING
        .listOf()
        .listOf()
    ...
    private static boolean anyMatch(List<String> p_309914_, Predicate<String> pPredicate) {
    ...
    public DataResult<AdvancementRequirements> m_305436_(Set<String> p_311051_) {
