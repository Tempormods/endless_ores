...
public class PlayerTrigger extends SimpleCriterionTrigger<PlayerTrigger.TriggerInstance> {
    @Override
    public Codec<PlayerTrigger.TriggerInstance> createInstance() {
        return PlayerTrigger.TriggerInstance.f_303537_;
    }
    ...
    public static record TriggerInstance(Optional<ContextAwarePredicate> f_303129_) implements SimpleCriterionTrigger.SimpleInstance {
        public static final Codec<PlayerTrigger.TriggerInstance> f_303537_ = RecordCodecBuilder.create(
            p_325242_ -> p_325242_.group(EntityPredicate.f_303210_.optionalFieldOf("player").forGetter(PlayerTrigger.TriggerInstance::playerPredicate))
