...
public class CriteriaTriggers {
    public static final Codec<CriterionTrigger<?>> f_302311_ = BuiltInRegistries.f_302882_.byNameCodec();
    ...
    public static final PlayerTrigger f_315944_ = register("voluntary_exile", new PlayerTrigger());
    ...
    public static final DefaultBlockInteractionTrigger f_315578_ = register("default_block_use", new DefaultBlockInteractionTrigger());
    public static final AnyBlockInteractionTrigger f_314545_ = register("any_block_use", new AnyBlockInteractionTrigger());
    ...
    public static final RecipeCraftedTrigger f_315310_ = register("crafter_recipe_crafted", new RecipeCraftedTrigger());
    public static final FallAfterExplosionTrigger f_314306_ = register("fall_after_explosion", new FallAfterExplosionTrigger());

    public static <T extends CriterionTrigger<?>> T register(String pName, T pTrigger) {
        return Registry.register(BuiltInRegistries.f_302882_, pName, pTrigger);
    }

    public static CriterionTrigger<?> m_305022_(Registry<CriterionTrigger<?>> p_310592_) {
        return IMPOSSIBLE;
    }
}