...
public class BredAnimalsTrigger extends SimpleCriterionTrigger<BredAnimalsTrigger.TriggerInstance> {
    @Override
    public Codec<BredAnimalsTrigger.TriggerInstance> createInstance() {
        return BredAnimalsTrigger.TriggerInstance.f_302894_;
    }
    ...
    public static record TriggerInstance(
        Optional<ContextAwarePredicate> f_302638_,
        Optional<ContextAwarePredicate> parent,
        Optional<ContextAwarePredicate> partner,
        Optional<ContextAwarePredicate> child
    ) implements SimpleCriterionTrigger.SimpleInstance {
        public static final Codec<BredAnimalsTrigger.TriggerInstance> f_302894_ = RecordCodecBuilder.create(
            p_325192_ -> p_325192_.group(
                        EntityPredicate.f_303210_.optionalFieldOf("player").forGetter(BredAnimalsTrigger.TriggerInstance::playerPredicate),
                        EntityPredicate.f_303210_.optionalFieldOf("parent").forGetter(BredAnimalsTrigger.TriggerInstance::parent),
                        EntityPredicate.f_303210_.optionalFieldOf("partner").forGetter(BredAnimalsTrigger.TriggerInstance::partner),
                        EntityPredicate.f_303210_.optionalFieldOf("child").forGetter(BredAnimalsTrigger.TriggerInstance::child)
                    )
        ...
        @Override
        public void serializeToJson(CriterionValidator p_312724_) {
            SimpleCriterionTrigger.SimpleInstance.super.serializeToJson(p_312724_);
            p_312724_.m_307484_(this.parent, ".parent");
            p_312724_.m_307484_(this.partner, ".partner");
            p_312724_.m_307484_(this.child, ".child");
        }

        @Override
        public Optional<ContextAwarePredicate> playerPredicate() {
            return this.f_302638_;
        }
    }
}