...
public record AdvancementRewards(int experience, List<ResourceKey<LootTable>> loot, List<ResourceLocation> recipes, Optional<CacheableFunction> function) {
    public static final Codec<AdvancementRewards> f_303002_ = RecordCodecBuilder.create(
        p_325186_ -> p_325186_.group(
                    Codec.INT.optionalFieldOf("experience", Integer.valueOf(0)).forGetter(AdvancementRewards::experience),
                    ResourceKey.codec(Registries.f_314309_).listOf().optionalFieldOf("loot", List.of()).forGetter(AdvancementRewards::loot),
                    ResourceLocation.CODEC.listOf().optionalFieldOf("recipes", List.of()).forGetter(AdvancementRewards::recipes),
                    CacheableFunction.f_303873_.optionalFieldOf("function").forGetter(AdvancementRewards::function)
                )
    ...
    public void grant(ServerPlayer pPlayer) {
        ...
        for (ResourceKey<LootTable> resourcekey : this.loot) {
            for (ItemStack itemstack : pPlayer.server.m_323018_().m_321428_(resourcekey).getRandomItems(lootparams)) {
        ...
        this.function
            .flatMap(p_308107_ -> p_308107_.m_306832_(minecraftserver.getFunctions()))
            .ifPresent(
