...
public class KilledTrigger extends SimpleCriterionTrigger<KilledTrigger.TriggerInstance> {
    @Override
    public Codec<KilledTrigger.TriggerInstance> createInstance() {
        return KilledTrigger.TriggerInstance.f_303861_;
    }
    ...
    public static record TriggerInstance(
        Optional<ContextAwarePredicate> f_303428_, Optional<ContextAwarePredicate> entityPredicate, Optional<DamageSourcePredicate> killingBlow
    ) implements SimpleCriterionTrigger.SimpleInstance {
        public static final Codec<KilledTrigger.TriggerInstance> f_303861_ = RecordCodecBuilder.create(
            p_325224_ -> p_325224_.group(
                        EntityPredicate.f_303210_.optionalFieldOf("player").forGetter(KilledTrigger.TriggerInstance::playerPredicate),
                        EntityPredicate.f_303210_.optionalFieldOf("entity").forGetter(KilledTrigger.TriggerInstance::entityPredicate),
        ...
        @Override
        public void serializeToJson(CriterionValidator p_311240_) {
            SimpleCriterionTrigger.SimpleInstance.super.serializeToJson(p_311240_);
            p_311240_.m_307484_(this.entityPredicate, ".entity");
        }

        @Override
        public Optional<ContextAwarePredicate> playerPredicate() {
            return this.f_303428_;
        }
    }
}