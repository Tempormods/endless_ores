...
public interface JvmProfiler {
    ...
    void onPacketReceived(ConnectionProtocol pProtocol, PacketType<?> p_334193_, SocketAddress pRemoteAddress, int pPacketId);

    void onPacketSent(ConnectionProtocol pProtocol, PacketType<?> p_328486_, SocketAddress pRemoteAddress, int pPacketId);

    void m_321210_(RegionStorageInfo p_330485_, ChunkPos p_331201_, RegionFileVersion p_333173_, int p_330872_);

    void m_319778_(RegionStorageInfo p_330562_, ChunkPos p_334903_, RegionFileVersion p_331257_, int p_327730_);
    ...
    public static class NoOpProfiler implements JvmProfiler {
        ...
        @Override
        public void m_321210_(RegionStorageInfo p_328378_, ChunkPos p_330600_, RegionFileVersion p_329437_, int p_328234_) {
        }

        @Override
        public void m_319778_(RegionStorageInfo p_335465_, ChunkPos p_330839_, RegionFileVersion p_333005_, int p_328862_) {
        }
