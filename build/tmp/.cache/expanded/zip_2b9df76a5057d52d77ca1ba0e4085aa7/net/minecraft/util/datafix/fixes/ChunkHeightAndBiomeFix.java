...
public class ChunkHeightAndBiomeFix extends DataFix {
                    ...
                    p_184884_ -> {
                        ...
                        p_184884_ = p_184884_.updateTyped(
                            ...
                            p_184936_ -> {
                                ...
                                return Util.m_305473_(type3, dynamic.createList(list.stream()));
                            }
                        );
    ...
    private static Dynamic<?>[] getBiomeContainers(Dynamic<?> pDynamic, boolean pOverworld, int p_184909_, MutableBoolean p_184910_) {
        ...
        int[] aint = pDynamic.get("Biomes").asIntStreamOpt().result().map(IntStream::toArray).orElse(null);
        if (aint != null && aint.length == 1536) {
            p_184910_.setValue(true);

            for (int l = 0; l < 24; l++) {
                int i1 = l;
                dynamic[l] = makeBiomeContainer(pDynamic, p_184967_ -> getOldBiome(aint, i1 * 64 + p_184967_));
            }
