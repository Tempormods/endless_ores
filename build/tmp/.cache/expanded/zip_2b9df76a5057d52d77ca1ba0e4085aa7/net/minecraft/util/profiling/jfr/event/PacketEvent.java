...
public abstract class PacketEvent extends Event {
    ...
    public PacketEvent(String pProtocolId, String p_335198_, String p_329249_, SocketAddress pRemoteAddress, int pPacketId) {
        ...
        this.bytes = pPacketId;
    }

    public static final class Fields {
        public static final String REMOTE_ADDRESS = "remoteAddress";
        public static final String PROTOCOL_ID = "protocolId";
        public static final String f_315933_ = "packetDirection";
