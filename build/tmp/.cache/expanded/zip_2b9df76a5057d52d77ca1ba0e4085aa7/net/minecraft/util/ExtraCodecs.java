...
public class ExtraCodecs {
    public static final Codec<JsonElement> JSON = m_306780_(JsonOps.INSTANCE);
    public static final Codec<Object> f_302296_ = m_306780_(JavaOps.INSTANCE);
    ...
    public static final Codec<Vector4f> f_314547_ = Codec.FLOAT
        .listOf()
        .comapFlatMap(
    ...
    public static final Codec<Integer> f_315502_ = Codec.withAlternative(
        Codec.INT, f_314547_, p_326515_ -> FastColor.ARGB32.m_323842_(p_326515_.w(), p_326515_.x(), p_326515_.y(), p_326515_.z())
    );
    public static final Codec<Integer> f_316863_ = Codec.BYTE
        .flatComapMap(
            UnsignedBytes::toInt,
    ...
    public static final Codec<String> f_316749_ = Codec.string(0, 16)
        .validate(
            p_326493_ -> StringUtil.m_319148_(p_326493_)
    ...
    private static final MapCodec<GameProfile> GAME_PROFILE_WITHOUT_PROPERTIES = RecordCodecBuilder.mapCodec(
        p_326508_ -> p_326508_.group(UUIDUtil.AUTHLIB_CODEC.fieldOf("id").forGetter(GameProfile::getId), f_316749_.fieldOf("name").forGetter(GameProfile::getName))
    ...
    public static <T> Codec<T> m_306780_(DynamicOps<T> p_310943_) {
    ...
    public static <E> MapCodec<E> m_307667_(final MapCodec<E> p_311419_, final MapCodec<E> p_312369_) {
    ...
    public static <E> Codec<E> m_322767_(Codec<E> p_331277_, Function<E, Lifecycle> p_331041_) {
    ...
    public static <K, V> Codec<Map<K, V>> m_324898_(Codec<Map<K, V>> p_331930_, int p_328430_) {
    ...
    @Deprecated
    public static <K, V> MapCodec<V> m_306181_(
    ...
    public static <A> Codec<Optional<A>> m_319082_(final Codec<A> p_329455_) {
        return new Codec<Optional<A>>() {
            ...
            private static <T> boolean m_324575_(DynamicOps<T> p_336166_, T p_333395_) {
