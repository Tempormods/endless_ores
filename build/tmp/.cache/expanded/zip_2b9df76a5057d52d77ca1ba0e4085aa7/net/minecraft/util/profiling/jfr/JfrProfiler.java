...
public class JfrProfiler implements JvmProfiler {
    ...
    public static final String f_314267_ = "Storage";
    ...
    @Override
    public void onPacketReceived(ConnectionProtocol pProtocol, PacketType<?> p_335626_, SocketAddress pRemoteAddress, int pPacketId) {
        if (PacketReceivedEvent.TYPE.isEnabled()) {
            new PacketReceivedEvent(pProtocol.id(), p_335626_.f_314819_().m_321669_(), p_335626_.f_314851_().toString(), pRemoteAddress, pPacketId).commit();
        }

        if (NetworkSummaryEvent.TYPE.isEnabled()) {
            this.networkStatFor(pRemoteAddress).trackReceivedPacket(pPacketId);
        }
    }

    @Override
    public void onPacketSent(ConnectionProtocol pProtocol, PacketType<?> p_334491_, SocketAddress pRemoteAddress, int pPacketId) {
        if (PacketSentEvent.TYPE.isEnabled()) {
            new PacketSentEvent(pProtocol.id(), p_334491_.f_314819_().m_321669_(), p_334491_.f_314851_().toString(), pRemoteAddress, pPacketId).commit();
        }

        if (NetworkSummaryEvent.TYPE.isEnabled()) {
            this.networkStatFor(pRemoteAddress).trackSentPacket(pPacketId);
        }
    }
    ...
    @Override
    public void m_321210_(RegionStorageInfo p_332602_, ChunkPos p_331074_, RegionFileVersion p_332565_, int p_334299_) {
    ...
    @Override
    public void m_319778_(RegionStorageInfo p_334895_, ChunkPos p_330898_, RegionFileVersion p_334334_, int p_334429_) {
