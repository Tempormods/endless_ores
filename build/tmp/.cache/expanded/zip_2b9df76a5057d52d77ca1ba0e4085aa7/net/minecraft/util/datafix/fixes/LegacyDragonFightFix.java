...
public class LegacyDragonFightFix extends DataFix {
    ...
    private static <T> Dynamic<T> m_319977_(Dynamic<T> p_328149_) {
        return p_328149_.update("ExitPortalLocation", ExtraDataFixUtils::m_320786_);
    }
        ...
        return this.fixTypeEverywhereTyped(
            "LegacyDragonFightFix", this.getInputSchema().getType(References.LEVEL), p_289787_ -> p_289787_.update(DSL.remainderFinder(), p_326607_ -> {
                    ...
                    if (optionaldynamic.result().isPresent()) {
                        ...
                        return p_326607_.set("DragonFight", m_319977_(dynamic));
                    }
                })
        );
    }
