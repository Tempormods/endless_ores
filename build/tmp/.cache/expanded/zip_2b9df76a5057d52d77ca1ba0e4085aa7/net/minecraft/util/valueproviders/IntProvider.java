...
public abstract class IntProvider {
    ...
    public static Codec<IntProvider> codec(int pMinInclusive, int pMaxInclusive) {
        return m_322738_(pMinInclusive, pMaxInclusive, CODEC);
    }

    public static <T extends IntProvider> Codec<T> m_322738_(int p_330202_, int p_327757_, Codec<T> p_336105_) {
        return p_336105_.validate(p_326740_ -> m_324944_(p_330202_, p_327757_, p_326740_));
    }

    private static <T extends IntProvider> DataResult<T> m_324944_(int p_331801_, int p_334933_, T p_329862_) {
