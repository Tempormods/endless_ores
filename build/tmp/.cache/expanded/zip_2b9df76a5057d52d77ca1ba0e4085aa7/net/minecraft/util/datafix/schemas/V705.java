...
public class V705 extends NamespacedSchema {
    static final Map<String, String> f_314208_ = ImmutableMap.<String, String>builder()
    ...
    protected static final HookFunction ADD_NAMES = new HookFunction() {
        ...
        public <T> T apply(DynamicOps<T> p_18167_, T p_18168_) {
            return V99.addNames(new Dynamic<>(p_18167_, p_18168_), V704.ITEM_TO_BLOCKENTITY, V705.f_314208_);
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema pSchema) {
        ...
        pSchema.register(map, "minecraft:area_effect_cloud", p_326713_ -> DSL.optionalFields("Particle", References.f_315042_.in(pSchema)));
        ...
        pSchema.register(
            ...
            p_326711_ -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.f_315894_.in(pSchema))), V100.equipment(pSchema))
        );
