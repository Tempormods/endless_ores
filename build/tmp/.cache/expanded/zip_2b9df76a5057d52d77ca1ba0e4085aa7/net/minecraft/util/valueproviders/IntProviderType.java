...
public interface IntProviderType<P extends IntProvider> {
    ...
    static <P extends IntProvider> IntProviderType<P> register(String pName, MapCodec<P> p_331982_) {
        return Registry.register(BuiltInRegistries.INT_PROVIDER_TYPE, pName, () -> p_331982_);
    }
}