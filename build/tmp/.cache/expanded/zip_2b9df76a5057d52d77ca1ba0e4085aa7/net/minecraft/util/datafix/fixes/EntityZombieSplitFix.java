...
public class EntityZombieSplitFix extends EntityRenameFix {
    private final Supplier<Type<?>> f_317057_ = Suppliers.memoize(() -> this.getOutputSchema().getChoiceType(References.ENTITY, "ZombieVillager"));
    ...
    protected Pair<String, Typed<?>> fix(String p_331870_, Typed<?> p_331918_) {
        if (!p_331870_.equals("Zombie")) {
            ...
            switch (i) {
                ...
                case 5:
                    s = "ZombieVillager";
                    typed = this.m_323721_(p_331918_, i - 1);
                    break;
                case 6:
                    s = "Husk";
                    typed = p_331918_;
    ...
    private Typed<?> m_323721_(Typed<?> p_336232_, int p_336308_) {
        return Util.m_306942_(p_336232_, this.f_317057_.get(), p_329329_ -> p_329329_.set("Profession", p_329329_.createInt(p_336308_)));
    }
}