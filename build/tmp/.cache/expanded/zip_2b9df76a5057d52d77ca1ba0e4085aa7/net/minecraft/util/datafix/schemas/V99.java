...
public class V99 extends Schema {
    ...
    public static final Map<String, String> f_317062_ = Map.of("minecraft:armor_stand", "ArmorStand", "minecraft:painting", "Painting");
    protected static final HookFunction ADD_NAMES = new HookFunction() {
        @Override
        public <T> T apply(DynamicOps<T> p_18312_, T p_18313_) {
            return V99.addNames(new Dynamic<>(p_18312_, p_18313_), V99.ITEM_TO_BLOCKENTITY, V99.f_317062_);
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema pSchema) {
        ...
        pSchema.register(
            ...
            p_326717_ -> DSL.optionalFields(
                    ...
                    DSL.list(References.ITEM_STACK.in(pSchema)),
                    "Offers",
                    DSL.optionalFields("Recipes", DSL.list(References.f_315894_.in(pSchema))),
                    equipment(pSchema)
                )
        );
        pSchema.registerSimple(map, "EnderCrystal");
        pSchema.register(map, "AreaEffectCloud", p_326715_ -> DSL.optionalFields("Particle", References.f_315042_.in(pSchema)));
    ...
    public void registerTypes(Schema pSchema, Map<String, Supplier<TypeTemplate>> p_18308_, Map<String, Supplier<TypeTemplate>> p_18309_) {
        ...
        pSchema.registerType(
            ...
            () -> DSL.optionalFields("components", References.f_316623_.in(pSchema), DSL.taggedChoiceLazy("id", DSL.string(), p_18309_))
        );
        ...
        pSchema.registerType(true, References.f_316623_, DSL::remainder);
        pSchema.registerType(
            true,
            References.f_315894_,
            () -> DSL.optionalFields(
                    "buy", References.ITEM_STACK.in(pSchema), "buyB", References.ITEM_STACK.in(pSchema), "sell", References.ITEM_STACK.in(pSchema)
                )
        );
        pSchema.registerType(true, References.f_315042_, () -> DSL.constType(DSL.string()));
    }

    protected static <T> T addNames(Dynamic<T> pDynamic, Map<String, String> pRenamer, Map<String, String> p_334570_) {
        return pDynamic.update("tag", p_145917_ -> p_145917_.update("BlockEntityTag", p_145912_ -> {
                ...
                String s = NamespacedSchema.ensureNamespaced(pDynamic.get("id").asString(""));
                String s1 = p_334570_.get(s);
                return s1 != null ? p_326723_.set("id", pDynamic.createString(s1)) : p_326723_;
            })).getValue();
    }
}