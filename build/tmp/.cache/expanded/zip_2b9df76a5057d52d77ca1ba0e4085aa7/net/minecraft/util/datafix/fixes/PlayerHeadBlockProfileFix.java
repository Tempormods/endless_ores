...
public class PlayerHeadBlockProfileFix extends NamedEntityFix {
    ...
    protected Typed<?> fix(Typed<?> p_332910_) {
        return p_332910_.update(DSL.remainderFinder(), this::m_320218_);
    }

    private <T> Dynamic<T> m_320218_(Dynamic<T> p_332985_) {
        ...
        if (optional2.isEmpty()) {
            ...
            return p_332985_.set("profile", ItemStackComponentizationFix.m_322595_(optional2.get()));
        }
    }
}