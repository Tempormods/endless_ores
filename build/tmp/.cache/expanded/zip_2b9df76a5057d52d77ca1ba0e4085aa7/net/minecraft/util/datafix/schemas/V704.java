...
public class V704 extends Schema {
    ...
    protected static final HookFunction ADD_NAMES = new HookFunction() {
        ...
        public <T> T apply(DynamicOps<T> p_18070_, T p_18071_) {
            return V99.addNames(new Dynamic<>(p_18070_, p_18071_), V704.ITEM_TO_BLOCKENTITY, V99.f_317062_);
        }
    };
    ...
    public void registerTypes(Schema pSchema, Map<String, Supplier<TypeTemplate>> pEntityTypes, Map<String, Supplier<TypeTemplate>> pBlockEntityTypes) {
        ...
        pSchema.registerType(
            ...
            () -> DSL.optionalFields("components", References.f_316623_.in(pSchema), DSL.taggedChoiceLazy("id", NamespacedSchema.namespacedString(), pBlockEntityTypes))
        );
        pSchema.registerType(
            true,
