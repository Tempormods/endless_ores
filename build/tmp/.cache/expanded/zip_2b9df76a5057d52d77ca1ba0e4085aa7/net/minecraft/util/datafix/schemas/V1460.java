...
public class V1460 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema pSchema) {
        ...
        pSchema.register(map, "minecraft:area_effect_cloud", p_326692_ -> DSL.optionalFields("Particle", References.f_315042_.in(pSchema)));
        ...
        pSchema.register(
            ...
            p_326695_ -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.f_315894_.in(pSchema))), V100.equipment(pSchema))
        );
        return map;
    }
    ...
    public void registerTypes(Schema pSchema, Map<String, Supplier<TypeTemplate>> pEntityTypes, Map<String, Supplier<TypeTemplate>> pBlockEntityTypes) {
        ...
        pSchema.registerType(
            ...
            () -> DSL.optionalFields("components", References.f_316623_.in(pSchema), DSL.taggedChoiceLazy("id", namespacedString(), pBlockEntityTypes))
        );
        pSchema.registerType(
        ...
        pSchema.registerType(false, References.f_314331_, DSL::remainder);
