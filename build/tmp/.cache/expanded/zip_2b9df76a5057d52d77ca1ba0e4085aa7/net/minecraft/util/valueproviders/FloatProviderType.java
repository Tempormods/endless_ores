...
public interface FloatProviderType<P extends FloatProvider> {
    ...
    static <P extends FloatProvider> FloatProviderType<P> register(String pName, MapCodec<P> p_331093_) {
        return Registry.register(BuiltInRegistries.FLOAT_PROVIDER_TYPE, pName, () -> p_331093_);
    }
}