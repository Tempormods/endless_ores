...
public class ChestedHorsesInventoryZeroIndexingFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(
            this.m_324367_(opticfinder, type, "minecraft:llama"),
            this.m_324367_(opticfinder, type, "minecraft:trader_llama"),
            this.m_324367_(opticfinder, type, "minecraft:mule"),
            this.m_324367_(opticfinder, type, "minecraft:donkey")
        );
    }

    private TypeRewriteRule m_324367_(
