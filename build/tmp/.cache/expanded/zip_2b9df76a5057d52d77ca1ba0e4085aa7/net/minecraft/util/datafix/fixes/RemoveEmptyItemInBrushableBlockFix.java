...
public class RemoveEmptyItemInBrushableBlockFix extends NamedEntityWriteReadFix {
    ...
    @Override
    protected <T> Dynamic<T> m_305448_(Dynamic<T> p_330310_) {
        Optional<Dynamic<T>> optional = p_330310_.get("item").result();
        return optional.isPresent() && m_320121_(optional.get()) ? p_330310_.remove("item") : p_330310_;
    }

    private static boolean m_320121_(Dynamic<?> p_328874_) {
