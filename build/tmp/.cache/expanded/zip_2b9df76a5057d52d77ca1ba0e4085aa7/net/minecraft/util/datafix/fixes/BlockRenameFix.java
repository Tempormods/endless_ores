...
public abstract class BlockRenameFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        if (!Objects.equals(type, type1)) {
            ...
            TypeRewriteRule typerewriterule1 = this.fixTypeEverywhereTyped(
                ...
                p_14913_ -> p_14913_.update(DSL.remainderFinder(), this::m_322025_)
            );
            TypeRewriteRule typerewriterule2 = this.fixTypeEverywhereTyped(
                this.name + " for flat_block_state",
                this.getInputSchema().getType(References.f_314331_),
                p_326554_ -> p_326554_.update(
                        DSL.remainderFinder(),
                        p_326555_ -> DataFixUtils.orElse(p_326555_.asString().result().map(this::m_323193_).map(p_326555_::createString), p_326555_)
                    )
            );
    ...
    private Dynamic<?> m_322025_(Dynamic<?> p_330740_) {
        Optional<String> optional = p_330740_.get("Name").asString().result();
        return optional.isPresent() ? p_330740_.set("Name", p_330740_.createString(this.fixBlock(optional.get()))) : p_330740_;
    }

    private String m_323193_(String p_332510_) {
    ...
    public static DataFix create(Schema pOutputSchema, String pName, final Function<String, String> pRenamer) {
        return new BlockRenameFix(pOutputSchema, pName) {
            @Override
            protected String fixBlock(String p_333306_) {
