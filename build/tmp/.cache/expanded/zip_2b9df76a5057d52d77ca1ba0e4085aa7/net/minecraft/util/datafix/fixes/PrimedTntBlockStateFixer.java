...
public class PrimedTntBlockStateFixer extends NamedEntityWriteReadFix {
    ...
    private static <T> Dynamic<T> m_305132_(Dynamic<T> p_313041_) {
    ...
    private static <T> Dynamic<T> m_307989_(Dynamic<T> p_309485_) {
    ...
    @Override
    protected <T> Dynamic<T> m_305448_(Dynamic<T> p_310859_) {
        return m_305132_(m_307989_(p_310859_));
    }
}