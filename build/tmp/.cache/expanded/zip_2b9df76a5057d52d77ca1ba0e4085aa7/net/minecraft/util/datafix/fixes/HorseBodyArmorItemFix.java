...
public class HorseBodyArmorItemFix extends NamedEntityWriteReadFix {
    private final String f_316620_;
    private final boolean f_314671_;
    ...
    public HorseBodyArmorItemFix(Schema p_328584_, String p_334943_, String p_330348_, boolean p_334013_) {
        ...
        this.f_316620_ = p_330348_;
        this.f_314671_ = p_334013_;
    }

    @Override
    protected <T> Dynamic<T> m_305448_(Dynamic<T> p_331303_) {
        Optional<? extends Dynamic<?>> optional = p_331303_.get(this.f_316620_).result();
        if (optional.isPresent()) {
            Dynamic<?> dynamic = (Dynamic<?>)optional.get();
            Dynamic<T> dynamic1 = p_331303_.remove(this.f_316620_);
            if (this.f_314671_) {
