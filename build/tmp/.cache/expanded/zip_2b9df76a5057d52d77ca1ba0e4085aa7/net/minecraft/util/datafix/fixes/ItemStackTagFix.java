...
public abstract class ItemStackTagFix extends DataFix {
    ...
    public final TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(this.name, type, m_321420_(type, this.idFilter, this::fixItemStackTag));
    }

    public static UnaryOperator<Typed<?>> m_321420_(Type<?> p_336291_, Predicate<String> p_331834_, UnaryOperator<Dynamic<?>> p_332019_) {
