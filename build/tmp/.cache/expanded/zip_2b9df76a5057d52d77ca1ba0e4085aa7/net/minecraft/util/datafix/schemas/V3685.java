...
public class V3685 extends NamespacedSchema {
    ...
    protected static TypeTemplate m_305940_(Schema p_309540_) {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_312739_) {
        ...
        p_312739_.register(map, "minecraft:trident", () -> m_305940_(p_312739_));
        p_312739_.register(map, "minecraft:spectral_arrow", () -> m_305940_(p_312739_));
        p_312739_.register(map, "minecraft:arrow", () -> m_305940_(p_312739_));
        return map;
    }
}