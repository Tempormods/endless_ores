...
public class BeehiveFieldRenameFix extends DataFix {
    ...
    private Dynamic<?> m_324257_(Dynamic<?> p_334771_) {
        return p_334771_.remove("Bees");
    }

    private Dynamic<?> m_319717_(Dynamic<?> p_335732_) {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            type2,
            type3,
            p_336050_ -> ExtraDataFixUtils.m_321966_(
                    type3,
                    p_336050_.updateTyped(
                        opticfinder,
                        p_334762_ -> p_334762_.update(DSL.remainderFinder(), this::m_324257_)
                                .updateTyped(
                                    opticfinder1,
                                    p_334908_ -> p_334908_.updateTyped(opticfinder2, p_331823_ -> p_331823_.update(DSL.remainderFinder(), this::m_319717_))
                                )
                    )
                )
        );
