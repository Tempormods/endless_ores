...
public class JfrResultJsonSerializer {
    ...
    private static void m_324799_(PacketIdentification p_335435_, JsonObject p_331788_) {
        p_331788_.addProperty("protocolId", p_335435_.f_315442_());
        p_331788_.addProperty("packetId", p_335435_.f_314890_());
    }

    private static void m_321286_(ChunkIdentification p_332094_, JsonObject p_330415_) {
        p_330415_.addProperty("level", p_332094_.f_314010_());
        p_330415_.addProperty("dimension", p_332094_.f_313971_());
        p_330415_.addProperty("x", p_332094_.f_316438_());
        p_330415_.addProperty("z", p_332094_.f_316635_());
    }
    ...
    private JsonElement fileIO(JfrStatsResult pResult) {
        ...
        jsonobject.add("chunksRead", this.m_321291_(pResult.f_316428_(), JfrResultJsonSerializer::m_321286_));
        jsonobject.add("chunksWritten", this.m_321291_(pResult.f_314724_(), JfrResultJsonSerializer::m_321286_));
        return jsonobject;
    }
    ...
    private JsonElement network(JfrStatsResult pResult) {
        JsonObject jsonobject = new JsonObject();
        jsonobject.add("sent", this.m_321291_(pResult.sentPacketsSummary(), JfrResultJsonSerializer::m_324799_));
        jsonobject.add("received", this.m_321291_(pResult.receivedPacketsSummary(), JfrResultJsonSerializer::m_324799_));
        return jsonobject;
    }

    private <T> JsonElement m_321291_(IoSummary<T> p_333759_, BiConsumer<T, JsonObject> p_328845_) {
        JsonObject jsonobject = new JsonObject();
        jsonobject.addProperty("totalBytes", p_333759_.m_324825_());
        jsonobject.addProperty("count", p_333759_.m_319079_());
        jsonobject.addProperty("bytesPerSecond", p_333759_.m_323182_());
        jsonobject.addProperty("countPerSecond", p_333759_.m_321055_());
        JsonArray jsonarray = new JsonArray();
        jsonobject.add("topContributors", jsonarray);
        p_333759_.m_324176_().forEach(p_326733_ -> {
            JsonObject jsonobject1 = new JsonObject();
            jsonarray.add(jsonobject1);
            T t = p_326733_.getFirst();
            IoSummary.CountAndSize iosummary$countandsize = p_326733_.getSecond();
            p_328845_.accept(t, jsonobject1);
            jsonobject1.addProperty("totalBytes", iosummary$countandsize.f_316214_());
            jsonobject1.addProperty("count", iosummary$countandsize.f_314527_());
            jsonobject1.addProperty("averageSize", iosummary$countandsize.m_324761_());
        });
        return jsonobject;
    }
