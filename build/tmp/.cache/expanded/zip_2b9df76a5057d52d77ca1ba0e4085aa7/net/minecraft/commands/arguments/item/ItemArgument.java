...
public class ItemArgument implements ArgumentType<ItemInput> {
    ...
    private final ItemParser f_315481_;

    public ItemArgument(CommandBuildContext pContext) {
        this.f_315481_ = new ItemParser(pContext);
    }
    ...
    public ItemInput parse(StringReader pReader) throws CommandSyntaxException {
        ItemParser.ItemResult itemparser$itemresult = this.f_315481_.parse(pReader);
        return new ItemInput(itemparser$itemresult.item(), itemparser$itemresult.f_314839_());
    }
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> pContext, SuggestionsBuilder pBuilder) {
        return this.f_315481_.fillSuggestions(pBuilder);
    }
