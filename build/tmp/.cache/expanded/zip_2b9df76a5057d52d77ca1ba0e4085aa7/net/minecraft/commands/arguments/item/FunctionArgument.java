...
public class FunctionArgument implements ArgumentType<FunctionArgument.Result> {
    ...
    private static final DynamicCommandExceptionType ERROR_UNKNOWN_TAG = new DynamicCommandExceptionType(
        p_308403_ -> Component.m_307043_("arguments.function.tag.unknown", p_308403_)
    );
    private static final DynamicCommandExceptionType ERROR_UNKNOWN_FUNCTION = new DynamicCommandExceptionType(
        p_308402_ -> Component.m_307043_("arguments.function.unknown", p_308402_)
    );
    ...
    public FunctionArgument.Result parse(StringReader pReader) throws CommandSyntaxException {
        if (pReader.canRead() && pReader.peek() == '#') {
            ...
            return new FunctionArgument.Result() {
                ...
                @Override
                public Pair<ResourceLocation, Collection<CommandFunction<CommandSourceStack>>> m_305224_(CommandContext<CommandSourceStack> p_310998_) throws CommandSyntaxException {
            ...
            return new FunctionArgument.Result() {
                ...
                @Override
                public Pair<ResourceLocation, Collection<CommandFunction<CommandSourceStack>>> m_305224_(CommandContext<CommandSourceStack> p_310823_) throws CommandSyntaxException {
    ...
    public static Pair<ResourceLocation, Collection<CommandFunction<CommandSourceStack>>> m_306861_(
        CommandContext<CommandSourceStack> p_312555_, String p_311726_
    ) throws CommandSyntaxException {
        return p_312555_.getArgument(p_311726_, FunctionArgument.Result.class).m_305224_(p_312555_);
    }
    ...
    public interface Result {
        ...
        Pair<ResourceLocation, Collection<CommandFunction<CommandSourceStack>>> m_305224_(CommandContext<CommandSourceStack> p_313207_) throws CommandSyntaxException;
    }
}