...
public class NbtPathArgument implements ArgumentType<NbtPathArgument.NbtPath> {
    ...
    public static final DynamicCommandExceptionType ERROR_NOTHING_FOUND = new DynamicCommandExceptionType(
        p_308351_ -> Component.m_307043_("arguments.nbtpath.nothing_found", p_308351_)
    );
    static final DynamicCommandExceptionType ERROR_EXPECTED_LIST = new DynamicCommandExceptionType(
        p_308352_ -> Component.m_307043_("commands.data.modify.expected_list", p_308352_)
    );
    static final DynamicCommandExceptionType ERROR_INVALID_INDEX = new DynamicCommandExceptionType(
        p_308350_ -> Component.m_307043_("commands.data.modify.invalid_index", p_308350_)
    );
    ...
    public static class NbtPath {
        ...
        public static final Codec<NbtPathArgument.NbtPath> f_314983_ = Codec.STRING.comapFlatMap(p_325592_ -> {
            try {
        ...
        }, NbtPathArgument.NbtPath::m_306879_);

        public static NbtPathArgument.NbtPath m_324408_(String p_333565_) throws CommandSyntaxException {
