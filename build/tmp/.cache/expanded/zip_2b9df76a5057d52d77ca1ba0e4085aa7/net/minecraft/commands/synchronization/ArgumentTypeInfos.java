...
public class ArgumentTypeInfos {
    ...
    public static ArgumentTypeInfo<?, ?> bootstrap(Registry<ArgumentTypeInfo<?, ?>> pRegistry) {
        ...
        register(pRegistry, "style", StyleArgument.class, SingletonArgumentInfo.contextAware(StyleArgument::m_305778_));
        ...
        register(pRegistry, "item_slots", SlotsArgument.class, SingletonArgumentInfo.contextFree(SlotsArgument::m_324401_));
        ...
        register(pRegistry, "loot_table", ResourceOrIdArgument.LootTableArgument.class, SingletonArgumentInfo.contextAware(ResourceOrIdArgument::m_324396_));
        register(
            pRegistry, "loot_predicate", ResourceOrIdArgument.LootPredicateArgument.class, SingletonArgumentInfo.contextAware(ResourceOrIdArgument::m_324190_)
        );
        register(pRegistry, "loot_modifier", ResourceOrIdArgument.LootModifierArgument.class, SingletonArgumentInfo.contextAware(ResourceOrIdArgument::m_321589_));
