...
public interface CommandFunction<T> {
    ...
    InstantiatedFunction<T> m_304684_(@Nullable CompoundTag p_312196_, CommandDispatcher<T> p_309930_) throws FunctionInstantiationException;

    private static boolean m_305830_(CharSequence p_310145_) {
        int i = p_310145_.length();
        return i > 0 && p_310145_.charAt(i - 1) == '\\';
    }

    static <T extends ExecutionCommandSource<T>> CommandFunction<T> m_304762_(
        ...
        for (int i = 0; i < p_310814_.size(); i++) {
            ...
            if (m_305830_(s)) {
                ...
                do {
                    ...
                    m_319153_(stringbuilder);
                } while (m_305830_(stringbuilder));
            ...
            if (stringreader.canRead() && stringreader.peek() != '#') {
                ...
                if (stringreader.peek() == '$') {
                    functionbuilder.m_307020_(s1.substring(1), j, p_312231_);
                } else {
                    try {
                        functionbuilder.m_305257_(m_305325_(p_310963_, p_312231_, stringreader));
        ...
        return functionbuilder.m_306609_(p_312869_);
    }

    static void m_319153_(CharSequence p_332928_) {
    ...
    static <T extends ExecutionCommandSource<T>> UnboundEntryAction<T> m_305325_(CommandDispatcher<T> p_310812_, T p_312436_, StringReader p_310713_) throws CommandSyntaxException {
        ParseResults<T> parseresults = p_310812_.parse(p_310713_, p_312436_);
        Commands.m_307768_(parseresults);
