...
public class Commands {
    private static final ThreadLocal<ExecutionContext<CommandSourceStack>> f_303274_ = new ThreadLocal<>();
    ...
    public Commands(Commands.CommandSelection pSelection, CommandBuildContext pContext) {
        ...
        TickCommand.m_305933_(this.dispatcher);
        ...
        if (net.minecraftforge.gametest.ForgeGameTestHooks.isGametestEnabled()) {
            ...
            ServerPackCommand.m_305387_(this.dispatcher);
        ...
        if (pSelection.includeDedicated) {
            ...
            TransferCommand.m_319902_(this.dispatcher);
        ...
        this.dispatcher.setConsumer(ExecutionCommandSource.m_304809_());
    }
    ...
    public void performCommand(ParseResults<CommandSourceStack> pParseResults, String pCommand) {
        ...
        try {
            ...
            ContextChain<CommandSourceStack> contextchain = m_304974_(event.getParseResults(), pCommand, commandsourcestack);
            if (contextchain != null) {
                m_306801_(
                    commandsourcestack,
                    p_308343_ -> ExecutionContext.m_307315_(p_308343_, pCommand, contextchain, commandsourcestack, CommandResultCallback.f_302577_)
                );
            }
    ...
    @Nullable
    private static ContextChain<CommandSourceStack> m_304974_(ParseResults<CommandSourceStack> p_311671_, String p_312044_, CommandSourceStack p_310074_) {
        try {
            m_307768_(p_311671_);
    ...
    public static void m_306801_(CommandSourceStack p_312477_, Consumer<ExecutionContext<CommandSourceStack>> p_313031_) {
        MinecraftServer minecraftserver = p_312477_.getServer();
        ExecutionContext<CommandSourceStack> executioncontext = f_303274_.get();
    ...
    public static <S> void m_307768_(ParseResults<S> p_311833_) throws CommandSyntaxException {
    ...
    public static CommandBuildContext createValidationContext(final HolderLookup.Provider pProvider) {
        return new CommandBuildContext() {
            ...
            public Stream<ResourceKey<? extends Registry<?>>> m_305097_() {
                return pProvider.m_305097_();
            }

            @Override
            public <T> Optional<HolderLookup.RegistryLookup<T>> lookup(ResourceKey<? extends Registry<? extends T>> p_334781_) {
                return pProvider.lookup(p_334781_).map(this::m_324443_);
            }

            private <T> HolderLookup.RegistryLookup.Delegate<T> m_324443_(final HolderLookup.RegistryLookup<T> p_328045_) {
                return new HolderLookup.RegistryLookup.Delegate<T>() {
                    ...
                    @Override
                    public Optional<HolderSet.Named<T>> m_255050_(TagKey<T> p_255936_) {
                        return Optional.of(this.getOrThrow(p_255936_));
                    }

                    @Override
                    public HolderSet.Named<T> getOrThrow(TagKey<T> p_255953_) {
                        Optional<HolderSet.Named<T>> optional = this.parent().m_255050_(p_255953_);
