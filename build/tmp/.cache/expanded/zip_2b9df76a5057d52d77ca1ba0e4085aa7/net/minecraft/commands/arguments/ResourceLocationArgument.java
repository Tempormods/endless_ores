...
public class ResourceLocationArgument implements ArgumentType<ResourceLocation> {
    ...
    private static final DynamicCommandExceptionType ERROR_UNKNOWN_ADVANCEMENT = new DynamicCommandExceptionType(
        p_308368_ -> Component.m_307043_("advancement.advancementNotFound", p_308368_)
    );
    private static final DynamicCommandExceptionType ERROR_UNKNOWN_RECIPE = new DynamicCommandExceptionType(p_308370_ -> Component.m_307043_("recipe.notFound", p_308370_));
